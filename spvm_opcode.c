...
const char* const SPVM_OPCODE_C_ID_NAMES[] = {
  ...
  "PUSH_EVAL",
  "POP_EVAL",
  "GET_PACKAGE_VAR_ACCESS_BYTE",
  "GET_PACKAGE_VAR_ACCESS_SHORT",
  "GET_PACKAGE_VAR_ACCESS_INT",
  "GET_PACKAGE_VAR_ACCESS_LONG",
  "GET_PACKAGE_VAR_ACCESS_FLOAT",
  "GET_PACKAGE_VAR_ACCESS_DOUBLE",
  "GET_PACKAGE_VAR_ACCESS_OBJECT",
  "SET_PACKAGE_VAR_ACCESS_BYTE",
  "SET_PACKAGE_VAR_ACCESS_SHORT",
  "SET_PACKAGE_VAR_ACCESS_INT",
  "SET_PACKAGE_VAR_ACCESS_LONG",
  "SET_PACKAGE_VAR_ACCESS_FLOAT",
  "SET_PACKAGE_VAR_ACCESS_DOUBLE",
  "SET_PACKAGE_VAR_ACCESS_OBJECT",
  "SET_PACKAGE_VAR_ACCESS_UNDEF",
  "GET_CONSTANT_BYTE",
  "GET_CONSTANT_SHORT",
  "GET_CONSTANT_INT",
  "GET_CONSTANT_LONG",
