...
enum {
  ...
  SPVM_BYTECODE_C_CODE_REG_REMINDAR_BYTE,
  SPVM_BYTECODE_C_CODE_REG_REMINDAR_SHORT,
  SPVM_BYTECODE_C_CODE_REG_REMINDAR_INT,
  SPVM_BYTECODE_C_CODE_REG_REMINDAR_LONG,
  SPVM_BYTECODE_C_CODE_REG_REMINDAR_FLOAT,
  SPVM_BYTECODE_C_CODE_REG_REMINDAR_DOUBLE,
