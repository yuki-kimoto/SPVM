...
enum {
  ...
  SPVM_BYTECODE_C_CODE_REG_CALL_VOID_SUB,
  SPVM_BYTECODE_C_CODE_REG_CALL_OBJECT_SUB,
  SPVM_BYTECODE_C_CODE_REG_INC_REF_COUNT,
  SPVM_BYTECODE_C_CODE_REG_DEC_REF_COUNT,
};
