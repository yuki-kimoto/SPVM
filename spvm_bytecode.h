...
enum {
  ...
  SPVM_BYTECODE_C_CODE_CAT_STRING_STRING,
  SPVM_BYTECODE_C_CODE_CAT_STRING_BYTE,
  SPVM_BYTECODE_C_CODE_CAT_STRING_SHORT,
  SPVM_BYTECODE_C_CODE_CAT_STRING_INT,
  SPVM_BYTECODE_C_CODE_CAT_STRING_LONG,
  SPVM_BYTECODE_C_CODE_CAT_STRING_FLOAT,
  SPVM_BYTECODE_C_CODE_CAT_STRING_DOUBLE,
};
