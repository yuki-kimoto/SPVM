...
enum {
  ...
  SPVM_BYTECODE_C_CODE_CONSTANT_SHORT_0, // Not used now
  SPVM_BYTECODE_C_CODE_CONSTANT_SHORT_1, // Not used now
  ...
  SPVM_BYTECODE_C_CODE_GET_PACKAGE_VAR_BYTE,
  SPVM_BYTECODE_C_CODE_GET_PACKAGE_VAR_SHORT,
  SPVM_BYTECODE_C_CODE_GET_PACKAGE_VAR_INT,
  SPVM_BYTECODE_C_CODE_GET_PACKAGE_VAR_LONG,
  SPVM_BYTECODE_C_CODE_GET_PACKAGE_VAR_FLOAT,
  SPVM_BYTECODE_C_CODE_GET_PACKAGE_VAR_DOUBLE,
  SPVM_BYTECODE_C_CODE_GET_PACKAGE_VAR_OBJECT,
  SPVM_BYTECODE_C_CODE_SET_PACKAGE_VAR_BYTE,
  SPVM_BYTECODE_C_CODE_SET_PACKAGE_VAR_SHORT,
  SPVM_BYTECODE_C_CODE_SET_PACKAGE_VAR_INT,
  SPVM_BYTECODE_C_CODE_SET_PACKAGE_VAR_LONG,
  SPVM_BYTECODE_C_CODE_SET_PACKAGE_VAR_FLOAT,
  SPVM_BYTECODE_C_CODE_SET_PACKAGE_VAR_DOUBLE,
  SPVM_BYTECODE_C_CODE_SET_PACKAGE_VAR_OBJECT,
};
