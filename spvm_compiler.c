...
SPVM_COMPILER* SPVM_COMPILER_new() {
  ...
  compiler->jit_package_names = SPVM_COMPILER_ALLOCATOR_alloc_list(compiler, 0);
  compiler->jit_package_name_symtable = SPVM_COMPILER_ALLOCATOR_alloc_hash(compiler, 0);
