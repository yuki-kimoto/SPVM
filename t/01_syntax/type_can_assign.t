...
# The dist type is the interface type
{
  # The source type is the interface type
  {
    ...
    }
    {
      ...
      compile_not_ok($source, q|The "to_string" class must implement the "MyInterface" method. This is defined as a required interface method in the "Stringable" interface.|);
    }
  }
}
...
# Dist type is interface array type
{
  # Source type is interface array type
  {
    ...
    }
    {
      ...
      compile_not_ok($source, , q|The "clone" class must implement the "Stringable" method. This is defined as a required interface method in the "Cloneable" interface.|);
    }
    {
      my $source = [
  ...
  # Source type is class array type
  {
    ...
    }
    {
      ...
      compile_not_ok($source, , q|The "clone" class must implement the "Int" method. This is defined as a required interface method in the "Cloneable" interface.|);
    }
  }
