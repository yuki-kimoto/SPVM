...
# precompile method
{
  # Check precompile class file
  {
    ...
    my ($precompile_class_file) = glob("$build_dir/work/lib/*/*/SPVM/TestCase/Operator/MethodCall.precompile.$Config{dlext}");
    ok(defined $precompile_class_file && -f $precompile_class_file);
  }
