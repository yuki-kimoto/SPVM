...
# to_elems
{
  # to_elems
  {
    # to_elems - byte[]
    {
      my $spvm_values = SPVM::api->new_byte_array([1, $BYTE_MAX, $BYTE_MIN]);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [1, $BYTE_MAX, $BYTE_MIN]);
    }
    # to_elems - short[]
    {
      my $spvm_values = SPVM::api->new_short_array([1, $SHORT_MAX, $SHORT_MIN]);
      my $values = $spvm_values->to_elems;
    ...
    # to_elems - int[]
    {
      my $spvm_values = SPVM::api->new_int_array([1, $INT_MAX, $INT_MIN]);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [1, $INT_MAX, $INT_MIN]);
    }
    # to_elems - long[]
    {
      my $spvm_values = SPVM::api->new_long_array([1, $LONG_MAX, $LONG_MIN]);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [1, $LONG_MAX, $LONG_MIN]);
    }
    # to_elems - float[]
    {
      my $spvm_values = SPVM::api->new_float_array([0.5, $FLT_MAX, $FLT_MIN]);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [0.5, $FLT_MAX, $FLT_MIN]);
    }
    # to_elems - double[]
    {
      my $spvm_values = SPVM::api->new_double_array([0.5, $DBL_MAX, $DBL_MIN]);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [0.5, $DBL_MAX, $DBL_MIN]);
    }
    # to_elems - string[]
    {
      my $spvm_values = SPVM::api->new_string_array(["あ", "い"]);
      my $values = $spvm_values->to_elems;
...
# Create SPVM numeric array with the length
{
  ...
  {
    {
      my $spvm_values = SPVM::api->new_byte_array_len(3);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [0, 0, 0]);
    }
    {
      my $spvm_values = SPVM::api->new_byte_array_len(0);
      my $values = $spvm_values->to_elems;
      is_deeply($values, []);
    }
    {
      eval {
        my $spvm_values = SPVM::api->new_byte_array_len(-1);
      };
      ok($@);
    }
  }
  ...
  {
    {
      my $spvm_values = SPVM::api->new_short_array_len(3);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [0, 0, 0]);
    }
    {
      my $spvm_values = SPVM::api->new_short_array_len(0);
      my $values = $spvm_values->to_elems;
      is_deeply($values, []);
    }
    {
      eval {
        my $spvm_values = SPVM::api->new_short_array_len(-1);
      };
      ok($@);
    }
  }
  ...
  {
    {
      my $spvm_values = SPVM::api->new_int_array_len(3);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [0, 0, 0]);
    }
    {
      my $spvm_values = SPVM::api->new_int_array_len(0);
      my $values = $spvm_values->to_elems;
      is_deeply($values, []);
    }
    {
      eval {
        my $spvm_values = SPVM::api->new_int_array_len(-1);
      };
      ok($@);
    }
  }
  ...
  {
    {
      my $spvm_values = SPVM::api->new_long_array_len(3);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [0, 0, 0]);
    }
    {
      my $spvm_values = SPVM::api->new_long_array_len(0);
      my $values = $spvm_values->to_elems;
      is_deeply($values, []);
    }
    {
      eval {
        my $spvm_values = SPVM::api->new_long_array_len(-1);
      };
      ok($@);
    }
  }
  ...
  {
    {
      my $spvm_values = SPVM::api->new_float_array_len(3);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [0, 0, 0]);
    }
    {
      my $spvm_values = SPVM::api->new_float_array_len(0);
      my $values = $spvm_values->to_elems;
      is_deeply($values, []);
    }
    {
      eval {
        my $spvm_values = SPVM::api->new_float_array_len(-1);
      };
      ok($@);
    }
  }
  ...
  {
    {
      my $spvm_values = SPVM::api->new_double_array_len(3);
      my $values = $spvm_values->to_elems;
      is_deeply($values, [0, 0, 0]);
    }
    {
      my $spvm_values = SPVM::api->new_double_array_len(0);
      my $values = $spvm_values->to_elems;
      is_deeply($values, []);
    }
    {
      eval {
        my $spvm_values = SPVM::api->new_double_array_len(-1);
      };
      ok($@);
    }
  }
...
# Convert a Perl binary data to a SPVM array
{
  # new_byte_array_from_bin
  {
    ...
    }
    {
      ...
      my $spvm_values = SPVM::api->new_byte_array_from_bin($binary);
    ...
    {
      my $spvm_values = SPVM::api->new_byte_array_from_bin(encode('UTF-8', "あ"));
  ...
  # new_short_array_from_bin
  {
    ...
    my $spvm_values = SPVM::api->new_short_array_from_bin($binary);
  ...
  # new_int_array_from_bin
  {
    ...
    my $spvm_values = SPVM::api->new_int_array_from_bin($binary);
  ...
  # new_long_array_from_bin
  {
    ...
    my $spvm_values = SPVM::api->new_long_array_from_bin($binary);
  ...
  # new_float_array_from_bin
  {
    ...
    my $spvm_values = SPVM::api->new_float_array_from_bin($binary);
  ...
  # new_double_array_from_bin
  {
    ...
    my $spvm_values = SPVM::api->new_double_array_from_bin($binary);
...
# new_string_from_bin
{
  ...
  {
    my $spvm_string = SPVM::api->new_string_from_bin("abc");
  ...
  {
    my $spvm_string = SPVM::api->new_string_from_bin("");
    is($spvm_string->to_string, "");
  }

  # new_string_from_bin - undef
  {
    eval { SPVM::api->new_string_from_bin(undef) };
    like($@, qr/The binary must be defined/);
  }

  # new_string_from_bin - reference
  {
    eval { SPVM::api->new_string_from_bin([]) };
...
# new_mulnum_array_from_bin
{
  # new_mulnum_array_from_bin - byte
  {
    ...
    my $spvm_values = SPVM::api->new_mulnum_array_from_bin("TestCase::Point_3b[]", $binary);
  ...
  # new_mulnum_array_from_bin - short
  {
    ...
    my $spvm_values = SPVM::api->new_mulnum_array_from_bin("TestCase::Point_3s[]", $binary);
  ...
  # new_mulnum_array_from_bin - int
  {
    ...
    my $spvm_values = SPVM::api->new_mulnum_array_from_bin("TestCase::Point_3i[]", $binary);
  ...
  # new_mulnum_array_from_bin - long
  {
    ...
    my $spvm_values = SPVM::api->new_mulnum_array_from_bin("TestCase::Point_3l[]", $binary);
  ...
  # new_mulnum_array_from_bin - float
  {
    ...
    my $spvm_values = SPVM::api->new_mulnum_array_from_bin("TestCase::Point_3f[]", $binary);
  ...
  # new_mulnum_array_from_bin - double
  {
    ...
    my $spvm_values = SPVM::api->new_mulnum_array_from_bin("TestCase::Point_3d[]", $binary);
  ...
  # new_mulnum_array_from_bin - double
  {
    ...
    eval {
      SPVM::api->new_mulnum_array_from_bin("TestCase::Point_3d[]", $binary);
    };
    ok($@);
  }
}
...
# ref SPVM array
{
  my $nums = SPVM::api->new_float_array([1, 2, 3]);
...
# exception
{
  ...
  {
    SPVM::api->set_exception(SPVM::api->new_string("あいう"));
    my $exception = SPVM::api->get_exception;
    is($exception, "あいう");
  }
...
# SPVM new_object_array
{
  ...
  # element object array
  {
    ...
    $object2->set_x_int(2);
    my $spvm_oarray = SPVM::api->new_object_array("TestCase[]", [$object1, $object2]);
  ...
  # element byte array
  {
    my $object1 = SPVM::api->new_byte_array([1, 2, 3]);
    my $object2 = SPVM::api->new_byte_array([4, 5, 6]);
    my $oarray = SPVM::api->new_object_array("byte[][]", [$object1, $object2]);
  ...
  # element short array
  {
    my $object1 = SPVM::api->new_short_array([1, 2, 3]);
    my $object2 = SPVM::api->new_short_array([4, 5, 6]);
    my $oarray = SPVM::api->new_object_array("short[][]", [$object1, $object2]);
  ...
  # element int array
  {
    my $object1 = SPVM::api->new_int_array([1, 2, 3]);
    my $object2 = SPVM::api->new_int_array([4, 5, 6]);
    my $oarray = SPVM::api->new_object_array("int[][]", [$object1, $object2]);
  ...
  # element long array
  {
    my $object1 = SPVM::api->new_long_array([1, 2, 3]);
    my $object2 = SPVM::api->new_long_array([4, 5, 6]);
    my $oarray = SPVM::api->new_object_array("long[][]", [$object1, $object2]);
  ...
  # element float array
  {
    my $object1 = SPVM::api->new_float_array([1, 2, 3]);
    my $object2 = SPVM::api->new_float_array([4, 5, 6]);
    my $oarray = SPVM::api->new_object_array("float[][]", [$object1, $object2]);
  ...
  {
    my $object1 = SPVM::api->new_double_array([1, 2, 3]);
    my $object2 = SPVM::api->new_double_array([4, 5, 6]);
    my $oarray = SPVM::api->new_object_array("double[][]", [$object1, $object2]);
...
# new_string
{
  ...
  {
    my $spvm_string = SPVM::api->new_string("あいう");
  ...
  # new_string - Number
  {
    my $spvm_string = SPVM::api->new_string(23);
    is($spvm_string->to_string, 23);
  }

  # new_string - Empty
  {
    my $spvm_string = SPVM::api->new_string("");
    is($spvm_string->to_string, "");
  }

  # new_string - undef
  {
    eval { SPVM::api->new_string(undef) };
    like($@, qr/The string must be defined/);
  }

  # new_string - reference
  {
    eval { SPVM::api->new_string([]) };
...
# new array unsigned
{
  ...
  {
    my $spvm_values = SPVM::api->new_byte_array_unsigned([0, $UBYTE_MAX]);
    my $bin = $spvm_values->to_bin;
    is_deeply([unpack 'C*', $bin], [0, $UBYTE_MAX]);
  }
  # new_short_array_unsigned
  {
    my $spvm_values = SPVM::api->new_short_array_unsigned([0, $USHORT_MAX]);
    my $bin = $spvm_values->to_bin;
    is_deeply([unpack 'S*', $bin], [0, $USHORT_MAX]);
  }
  # new_int_array_unsigned
  {
    my $spvm_values = SPVM::api->new_int_array_unsigned([0, $UINT_MAX]);
    my $bin = $spvm_values->to_bin;
    is_deeply([unpack 'L*', $bin], [0, $UINT_MAX]);
  }
  # new_long_array_unsigned
  {
    my $spvm_values = SPVM::api->new_long_array_unsigned([0, $ULONG_MAX]);
    my $bin = $spvm_values->to_bin;
...
# to_bin
{
  ...
  {
    {
      my $spvm_values = SPVM::api->new_byte_array([]);
      my $binary = $spvm_values->to_bin;
      is($binary, "");
    }
    {
      my $spvm_values = SPVM::api->new_short_array([]);
      my $binary = $spvm_values->to_bin;
      is($binary, "");
    }
    {
      my $spvm_values = SPVM::api->new_int_array([]);
      my $binary = $spvm_values->to_bin;
      is($binary, "");
    }
    {
      my $spvm_values = SPVM::api->new_long_array([]);
      my $binary = $spvm_values->to_bin;
      is($binary, "");
    }
    {
      my $spvm_values = SPVM::api->new_float_array([]);
      my $binary = $spvm_values->to_bin;
      is($binary, "");
    }
    {
      my $spvm_values = SPVM::api->new_double_array([]);
      my $binary = $spvm_values->to_bin;
      is($binary, "");
    }
  }
  ...
  {
    {
      my $spvm_values = SPVM::api->new_byte_array([1, 2, $BYTE_MAX]);
      my $binary = $spvm_values->to_bin;
    ...
    {
      my $spvm_values = SPVM::api->new_short_array([1, 2, $SHORT_MAX]);
      my $binary = $spvm_values->to_bin;
    ...
    {
      my $spvm_values = SPVM::api->new_int_array([1, 2, $INT_MAX]);
      my $binary = $spvm_values->to_bin;
    ...
    {
      my $spvm_values = SPVM::api->new_long_array([1, 2, $LONG_MAX]);
      my $binary = $spvm_values->to_bin;
    ...
    {
      my $spvm_values = SPVM::api->new_float_array([1, 2, $FLOAT_PRECICE]);
      my $binary = $spvm_values->to_bin;
    ...
    {
      my $spvm_values = SPVM::api->new_double_array([1, 2, $DOUBLE_PRECICE]);
      my $binary = $spvm_values->to_bin;
...
# SPVM::BlessedObject::Array
{
  ...
  {
    {
      my $sp_values = SPVM::api->new_byte_array([0, 0]);
    ...
    {
      my $sp_values = SPVM::api->new_short_array([0, 0]);
    ...
    {
      my $sp_values = SPVM::api->new_int_array([0, 0]);
    ...
    {
      my $sp_values = SPVM::api->new_long_array([0, 0]);
    ...
    {
      my $sp_values = SPVM::api->new_float_array([0, 0]);
    ...
    {
      my $sp_values = SPVM::api->new_double_array([0, 0]);
...
# Array dereference overload
{
  # list context
  {
    my $values = SPVM::api->new_int_array([1, 2, 3]);
    my $copy_values = [];
    for my $value (@$values) {
