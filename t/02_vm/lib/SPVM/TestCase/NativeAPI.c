...
int32_t SPVM__TestCase__NativeAPI__check_native_api_runtime_indexes(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  if ((void*)&env->api->runtime->get_class_var_address_id_by_index != &env_array[32]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->get_class_var_address_id_by_name != &env_array[33]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->api->runtime->get_field_address_id_by_index != &env_array[36]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->get_field_address_id_by_name != &env_array[37]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->api->runtime->get_method_address_id_by_index != &env_array[41]) { stack[0].ival = 0; return 0; }
