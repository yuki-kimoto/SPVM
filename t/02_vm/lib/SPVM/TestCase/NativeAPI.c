...
int32_t SPVM__TestCase__NativeAPI__check_native_api_indexes(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  if ((void*)&env->call_method_raw != &env_array[88]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->init_flags != &env_array[210]) { stack[0].ival = 0; return 0; }
...
int32_t SPVM__TestCase__NativeAPI__native_call_class_method_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t output;
  {
    int32_t args_stack_length = 1;
    stack[0].ival = 5;
    env->call_class_method_by_name(env, stack, "TestCase::NativeAPI", "my_value", args_stack_length, &error, __func__, FILE_NAME, __LINE__);
    if (error) {
      return error;
    }
    output = stack[0].ival;
...
int32_t SPVM__TestCase__NativeAPI__native_call_class_method_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t output;
  {
    int32_t args_stack_length = 1;
    stack[0].ival = 5;
    env->call_class_method_by_name(env, stack, "TestCase::NativeAPI", "not_found", args_stack_length, &error, __func__, FILE_NAME, __LINE__);
    if (error) {
      return error;
    }
    output = stack[0].ival;
...
int32_t SPVM__TestCase__NativeAPI__call_instance_method_static_by_name_native(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t output;
  {
    int32_t args_stack_length = 1;
    stack[0].oval = minimal;
    env->call_instance_method_static_by_name(env, stack, "TestCase::Minimal", "x", args_stack_length, &error, __func__, FILE_NAME, __LINE__);
    if (error) { return error; }
    output = stack[0].ival;
  }
...
int32_t SPVM__TestCase__NativeAPI__call_instance_method_static_by_name_exception_native(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t output;
  {
    int32_t args_stack_length = 1;
    stack[0].oval = minimal;
    env->call_instance_method_static_by_name(env, stack, "TestCase::Minimal", "not_found", args_stack_length, &error, __func__, FILE_NAME, __LINE__);
    if (error) { return error; };
    output = stack[0].ival;
  }
...
int32_t SPVM__TestCase__NativeAPI__call_instance_method_by_name_native(SPVM_ENV* env, SPVM_VALUE* stack) {  
  ...
  int32_t output;
  {
    int32_t args_stack_length = 1;
    stack[0].oval = minimal;
    env->call_instance_method_by_name(env, stack, "x", args_stack_length, &error, __func__, FILE_NAME, __LINE__);
    if (error) { return error; }
    output = stack[0].ival;
  }
...
int32_t SPVM__TestCase__NativeAPI__call_instance_method_by_name_exception_native(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t output;
  {
    int32_t args_stack_length = 1;
    stack[0].oval = minimal;
    env->call_instance_method_by_name(env, stack, "not_found", args_stack_length, &error, __func__, FILE_NAME, __LINE__);
    if (error) { return error; };
    output = stack[0].ival;
  }
...
int32_t SPVM__TestCase__NativeAPI__check_native_api_runtime_indexes(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  if ((void*)&env->api->runtime->reserved20 != &env_array[20]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->reserved21 != &env_array[21]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->reserved22 != &env_array[22]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->reserved23 != &env_array[23]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->reserved24 != &env_array[24]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->reserved25 != &env_array[25]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->reserved26 != &env_array[26]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->reserved27 != &env_array[27]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->reserved28 != &env_array[28]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->api->runtime->get_method_opcodes_base_address_id != &env_array[59]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->get_method_opcodes_length != &env_array[60]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->get_method_args_base_address_id != &env_array[61]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->api->runtime->init_flags != &env_array[85]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->api->runtime->get_arg_basic_type_id != &env_array[109]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->api->runtime->get_method_current_basic_type_id != &env_array[112]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->get_field_current_basic_type_id != &env_array[113]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->api->runtime->get_class_var_current_basic_type_id != &env_array[114]) { stack[0].ival = 0; return 0; }
