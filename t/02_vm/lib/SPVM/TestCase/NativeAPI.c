...
int32_t SPVM__TestCase__NativeAPI__check_native_api_ids(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  if ((void*)&env->get_version_from_string != &env_array[228]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->get_version_from_basic_type_name != &env_array[229]) { stack[0].ival = 0; return 0; }
