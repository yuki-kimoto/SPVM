...
int32_t SPVM__TestCase__NativeAPI__check_native_api_indexes(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  if ((void*)&env->elem_isa != &env_array[14]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->runtime != &env_array[15]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->get_field_object_by_name_v2 != &env_array[16]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->set_field_object_by_name_v2 != &env_array[17]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->reserved18 != &env_array[18]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->reserved19 != &env_array[19]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->reserved176 != &env_array[176]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->reserved177 != &env_array[177]) { stack[0].ival = 0; return 0; }
  if ((void*)&env->reserved178 != &env_array[178]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->check_flag_pointer_dont_free != &env_array[201]) { stack[0].ival = 0; return 0;}
  if ((void*)&env->enable_flag_pointer_dont_free != &env_array[202]) { stack[0].ival = 0; return 0;}
  if ((void*)&env->disable_flag_pointer_dont_free != &env_array[203]) { stack[0].ival = 0; return 0;}
  if ((void*)&env->get_pointer_length != &env_array[204]) { stack[0].ival = 0; return 0;}
  if ((void*)&env->set_pointer_length != &env_array[205]) { stack[0].ival = 0; return 0;}
  if ((void*)&env->get_pointer_any_info != &env_array[206]) { stack[0].ival = 0; return 0;}
  if ((void*)&env->set_pointer_any_info != &env_array[207]) { stack[0].ival = 0; return 0;}
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_byte_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int8_t value = env->get_class_var_byte_by_name(env, stack, "TestCase::NativeAPI", "$BYTE_VALUE", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_byte_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int8_t value = env->get_class_var_byte_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_short_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int16_t value = env->get_class_var_short_by_name(env, stack, "TestCase::NativeAPI", "$SHORT_VALUE", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_short_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int16_t value = env->get_class_var_short_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_int_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t value = env->get_class_var_int_by_name(env, stack, "TestCase::NativeAPI", "$INT_VALUE", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_int_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t value = env->get_class_var_int_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_long_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int64_t value = env->get_class_var_long_by_name(env, stack, "TestCase::NativeAPI", "$LONG_VALUE", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_long_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int64_t value = env->get_class_var_long_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_float_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  float value = env->get_class_var_float_by_name(env, stack, "TestCase::NativeAPI", "$FLOAT_VALUE", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_float_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  float value = env->get_class_var_float_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_double_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  double value = env->get_class_var_double_by_name(env, stack, "TestCase::NativeAPI", "$DOUBLE_VALUE", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_double_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  double value = env->get_class_var_double_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_object_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  void* value = env->get_class_var_object_by_name(env, stack, "TestCase::NativeAPI", "$MINIMAL_VALUE", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_var_object_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  void* value = env->get_class_var_object_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_byte_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_byte_by_name(env, stack, "TestCase::NativeAPI", "$BYTE_VALUE", INT8_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_byte_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_byte_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", INT8_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_short_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_short_by_name(env, stack, "TestCase::NativeAPI", "$SHORT_VALUE", INT16_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_short_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_short_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", INT16_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_int_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_int_by_name(env, stack, "TestCase::NativeAPI", "$INT_VALUE", INT32_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_int_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_int_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", INT32_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_long_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_long_by_name(env, stack, "TestCase::NativeAPI", "$LONG_VALUE", INT64_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_long_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_long_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", INT64_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_float_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_float_by_name(env, stack, "TestCase::NativeAPI", "$FLOAT_VALUE", FLT_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_float_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_float_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", FLT_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_double_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_double_by_name(env, stack, "TestCase::NativeAPI", "$DOUBLE_VALUE", DBL_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_double_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_double_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", DBL_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_object_by_name_test(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  void* minimal = env->new_object_by_name(env, stack, "TestCase::Minimal", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
  
  env->set_class_var_object_by_name(env, stack, "TestCase::NativeAPI", "$MINIMAL_VALUE", minimal, &e, FILE_NAME, __LINE__);
...
int32_t SPVM__TestCase__NativeAPI__set_class_var_object_by_name_test_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_class_var_object_by_name(env, stack, "TestCase::NativeAPI", "$NOT_FOUND", minimal, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_new_object_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t e;
  void* minimal = env->new_object_by_name(env, stack, "NotFound", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_byte_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_byte_by_name(env, stack, object, "TestCase::Simple", "byte_value", INT8_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_byte_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_byte_by_name(env, stack, object, "TestCase::Simple", "not_found", INT8_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_short_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_short_by_name(env, stack, object, "TestCase::Simple", "short_value", INT16_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_short_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_short_by_name(env, stack, object, "TestCase::Simple", "not_found", INT16_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_int_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_int_by_name(env, stack, object, "TestCase::Simple", "int_value", INT32_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_int_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_int_by_name(env, stack, object, "TestCase::Simple", "not_found", INT32_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_long_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_long_by_name(env, stack, object, "TestCase::Simple", "long_value", INT64_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_long_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_long_by_name(env, stack, object, "TestCase::Simple", "not_found", INT64_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_float_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_float_by_name(env, stack, object, "TestCase::Simple", "float_value", FLT_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_float_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_float_by_name(env, stack, object, "TestCase::Simple", "not_found", FLT_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_double_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_double_by_name(env, stack, object, "TestCase::Simple", "double_value", DBL_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_double_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_double_by_name(env, stack, object, "TestCase::Simple", "not_found", DBL_MIN, &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_object_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t field_id_minimal_x = env->get_field_id(env, "TestCase::Minimal", "x");
  if (field_id_minimal_x < 0) {
    return 1;
  }
  env->set_field_int(env, stack, object_minimal, field_id_minimal_x, 3);
  
  env->set_field_object_by_name(env, stack, object_simple, "TestCase::Simple", "object_value", object_minimal, &e, FILE_NAME, __LINE__);
  
  return 0;
}

int32_t SPVM__TestCase__NativeAPI__native_set_field_object_by_name_v2(SPVM_ENV* env, SPVM_VALUE* stack) {
  (void)env;
  (void)stack;
  ...
  int32_t field_id_minimal_x = env->api->runtime->get_field_id_by_name(env->runtime, "TestCase::Minimal", "x");
  if (field_id_minimal_x < 0) {
    return 1;
  }
  env->set_field_int(env, stack, object_minimal, field_id_minimal_x, 3);
  
  env->set_field_object_by_name_v2(env, stack, object_simple, "TestCase::Simple", "object_value", object_minimal, &e, FILE_NAME, __LINE__);
...
int32_t SPVM__TestCase__NativeAPI__native_set_field_object_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  env->set_field_object_by_name(env, stack, object_simple, "TestCase::Simple", "not_found", object_minimal, &e, FILE_NAME, __LINE__);
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_byte_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int8_t byte_value = env->get_field_byte_by_name(env, stack, object, "TestCase::Simple", "byte_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_byte_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int8_t byte_value = env->get_field_byte_by_name(env, stack, object, "TestCase::Simple", "not_found", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_short_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int16_t short_value = env->get_field_short_by_name(env, stack, object, "TestCase::Simple", "short_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_short_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int16_t short_value = env->get_field_short_by_name(env, stack, object, "TestCase::Simple", "not_found", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_int_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t int_value = env->get_field_int_by_name(env, stack, object, "TestCase::Simple", "int_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_int_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t int_value = env->get_field_int_by_name(env, stack, object, "TestCase::Simple", "not_found", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_long_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int64_t long_value = env->get_field_long_by_name(env, stack, object, "TestCase::Simple", "long_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_long_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int64_t long_value = env->get_field_long_by_name(env, stack, object, "TestCase::Simple", "not_found", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_float_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  float float_value = env->get_field_float_by_name(env, stack, object, "TestCase::Simple", "float_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_float_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  float float_value = env->get_field_float_by_name(env, stack, object, "TestCase::Simple", "not_found", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_double_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  double double_value = env->get_field_double_by_name(env, stack, object, "TestCase::Simple", "double_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_double_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  double double_value = env->get_field_double_by_name(env, stack, object, "TestCase::Simple", "not_found", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_object_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  void* object_minimal = env->get_field_object_by_name(env, stack, object_simple, "TestCase::Simple", "object_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_object_by_name_v2(SPVM_ENV* env, SPVM_VALUE* stack) {
  (void)env;
  (void)stack;
  int32_t e;
  ...
  void* object_minimal = env->get_field_object_by_name_v2(env, stack, object_simple, "TestCase::Simple", "object_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_string_chars_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  const char* string_chars = env->get_field_string_chars_by_name(env, stack, string_chars_simple, "TestCase::Simple", "string_value", &e, FILE_NAME, __LINE__);
  if (e) { return e; };
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_string_chars_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  const char* string_chars = env->get_field_string_chars_by_name(env, stack, string_chars_simple, "TestCase::Simple", "not_found", &e, FILE_NAME, __LINE__);
  if (e) {
    stack[0].ival = 1;
  }
  else {
...
int32_t SPVM__TestCase__NativeAPI__native_get_field_object_by_name_exception(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  void* object_minimal = env->get_field_object_by_name(env, stack, object_simple, "TestCase::Simple", "not_found", &e, FILE_NAME, __LINE__);
  if (e) { return e; }
...
int32_t SPVM__TestCase__NativeAPI__call_void_method_exception_native(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  return env->die(env, stack, "Exception %s", "ppp", "TestCase/NativeAPI.native/NativeAPI.c", __LINE__);
}
...
int32_t SPVM__TestCase__NativeAPI__call_byte_method_exception_native(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  return env->die(env, stack, "Exception", "TestCase/NativeAPI.native/NativeAPI.c", __LINE__);
}
...
int32_t SPVM__TestCase__NativeAPI__native_call_spvm_method(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t method_id = env->get_class_method_id(env, "TestCase::NativeAPI", "my_value");
  if (method_id < 0) {
    return 1;
  }
  int32_t output;
...
int32_t SPVM__TestCase__NativeAPI__get_instance_method_id_static_native(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  int32_t method_id = env->get_instance_method_id_static(env, "TestCase::Minimal", "x");
...
int32_t SPVM__TestCase__NativeAPI__check_native_api_runtime_indexes(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  if ((void*)&env->api->runtime->get_type_stack_length != &env_array[17]) { stack[0].ival = 0; return 0; }
  ...
  if ((void*)&env->api->runtime->reserved47 != &env_array[47]) { stack[0].ival = 0; return 0; }
...
int32_t SPVM__TestCase__NativeAPI__get_class_id(SPVM_ENV* env, SPVM_VALUE* stack) {
  {
    int32_t error_class_id = env->get_class_id(env, "Error");
    if (!(error_class_id == 1)) {
      stack[0].ival = 0;
      return 0;
    }
  ...
  {
    int32_t error_class_id = env->get_class_id(env, "NotFoundClass");
    if (!(error_class_id < 0)) {
      stack[0].ival = 0;
      return 0;
    }
...
int32_t SPVM__TestCase__NativeAPI__get_class_id_by_name(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  {
    int32_t error_class_id = env->get_class_id_by_name(env, stack, "Error", &e, FILE_NAME, __LINE__);
...
int32_t SPVM__TestCase__NativeAPI__check_flag_pointer_dont_free(SPVM_ENV* env, SPVM_VALUE* stack) {
  
  {
    int32_t e = 0;
    int32_t num = 0;
    int32_t* num_ptr = &num;
    void* obj_pointer = env->new_pointer_by_name(env, stack, "TestCase::PointerDontFree", num_ptr, &e, FILE_NAME, __LINE__);
    if (e) { return e; }
    
    if (env->check_flag_pointer_dont_free(env, stack, obj_pointer)) {
      stack[0].ival = 0;
      return 0;
    }
    env->enable_flag_pointer_dont_free(env, stack, obj_pointer);
    ...
    env->disable_flag_pointer_dont_free(env, stack, obj_pointer);
    if (env->check_flag_pointer_dont_free(env, stack, obj_pointer)) {
      stack[0].ival = 0;
      return 0;
    }
...
int32_t SPVM__TestCase__NativeAPI__get_pointer_any_info(SPVM_ENV* env, SPVM_VALUE* stack) {
  
  {
    ...
    if (!(env->get_pointer_any_info(env, stack, obj_pointer) == NULL)) {
      stack[0].ival = 0;
      return 0;
    }
    
    env->set_pointer_any_info(env, stack, obj_pointer, num_ptr);
    
    if (!(env->get_pointer_any_info(env, stack, obj_pointer) == num_ptr)) {
      stack[0].ival = 0;
      return 0;
    }
  }
