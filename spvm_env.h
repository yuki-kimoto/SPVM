...
struct SPVM_env {
  ...
  void (*set_object_field_value_byte)(void*, void*, int32_t, int8_t);
  void (*set_object_field_value_short)(void*, void*, int32_t, int16_t);
  void (*set_object_field_value_int)(void*, void*, int32_t, int32_t);
  void (*set_object_field_value_long)(void*, void*, int32_t, int64_t);
  void (*set_object_field_value_float)(void*, void*, int32_t, float);
  void (*set_object_field_value_double)(void*, void*, int32_t, double);
  int8_t (*get_object_field_value_byte)(void*, void*, int32_t);
  int16_t (*get_object_field_value_short)(void*, void*, int32_t);
  int32_t (*get_object_field_value_int)(void*, void*, int32_t);
  int64_t (*get_object_field_value_long)(void*, void*, int32_t);
  float (*get_object_field_value_float)(void*, void*, int32_t);
  double (*get_object_field_value_double)(void*, void*, int32_t);
  void* (*get_object_field_value_ref)(void*, void*, int32_t);
