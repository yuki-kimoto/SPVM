...
int64_t SPVM_RUNTIME_API_calcurate_data_byte_size(SPVM_RUNTIME* runtime, SPVM_DATA* data) {
  ...
  if (data->type == SPVM_DATA_C_TYPE_ARRAY) {
    ...
    byte_size = SPVM_DATA_C_HEADER_BYTE_SIZE + data_array->length * SPVM_RUNTIME_API_get_array_value_size(runtime, data_array->value_type);
  }
  // Reference is object
...
int32_t SPVM_RUNTIME_API_get_array_value_size(SPVM_RUNTIME* runtime, int32_t type) {
  (void)runtime;
...
SPVM_VALUE* SPVM_RUNTIME_API_get_object_fields(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object) {
  (void)runtime;
  
  return (SPVM_VALUE*)((intptr_t)data_object + SPVM_DATA_C_HEADER_BYTE_SIZE);
}

int32_t SPVM_RUNTIME_API_get_object_field_index(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name) {
  (void)runtime;
...
int32_t SPVM_RUNTIME_API_get_object_fields_length(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object) {
  (void)runtime;
...
void SPVM_RUNTIME_API_set_object_field_value_byte(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name, int8_t value) {
  (void)runtime;
  
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_object_fields(runtime, data_object);
  int32_t field_index = SPVM_RUNTIME_API_get_object_field_index(runtime, data_object, name);
  fields[field_index].byte_value = value;
}

void SPVM_RUNTIME_API_set_object_field_value_short(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name, int16_t value) {
...
void SPVM_RUNTIME_API_set_object_field_value_int(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name, int32_t value) {
  (void)runtime;
...
void SPVM_RUNTIME_API_set_object_field_value_long(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name, int64_t value) {
...
void SPVM_RUNTIME_API_set_object_field_value_float(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name, float value) {
  (void)runtime;
...
void SPVM_RUNTIME_API_set_object_field_value_double(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name, double value) {
  (void)runtime;
...
int8_t SPVM_RUNTIME_API_get_object_field_value_byte(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name) {
  (void)runtime;
...
int16_t SPVM_RUNTIME_API_get_object_field_value_short(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name) {
  (void)runtime;
...
int32_t SPVM_RUNTIME_API_get_object_field_value_int(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name) {
  (void)runtime;
...
int64_t SPVM_RUNTIME_API_get_object_field_value_long(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name) {
  (void)runtime;
...
float SPVM_RUNTIME_API_get_object_field_value_float(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name) {
...
double SPVM_RUNTIME_API_get_object_field_value_double(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name) {
  (void)runtime;
...
SPVM_DATA* SPVM_RUNTIME_API_get_object_field_value_ref(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object, const char* name) {
  (void)runtime;
...
int32_t SPVM_RUNTIME_API_dump_object_field_names(SPVM_RUNTIME* runtime, SPVM_DATA_OBJECT* data_object) {
  (void)runtime;
...
int32_t* SPVM_RUNTIME_API_get_constant_pool(SPVM_RUNTIME* runtime) {
  (void)runtime;
  
  return runtime->constant_pool;
}

int32_t SPVM_RUNTIME_API_get_ref_count(SPVM_RUNTIME* runtime, SPVM_DATA* data) {
  (void)runtime;
  
  return data->ref_count;
}

int32_t SPVM_RUNTIME_API_get_array_length(SPVM_RUNTIME* runtime, SPVM_DATA_ARRAY* data_array) {
  (void)runtime;
  
  return data_array->length;
}

int8_t* SPVM_RUNTIME_API_get_array_values_byte(SPVM_RUNTIME* runtime, SPVM_DATA_ARRAY* data_array) {
  (void)runtime;

  return (int8_t*)((intptr_t)data_array + SPVM_DATA_C_HEADER_BYTE_SIZE);
}

int16_t* SPVM_RUNTIME_API_get_array_values_short(SPVM_RUNTIME* runtime, SPVM_DATA_ARRAY* data_array) {
  (void)runtime;
  
  return (int16_t*)((intptr_t)data_array + SPVM_DATA_C_HEADER_BYTE_SIZE);
}

int32_t* SPVM_RUNTIME_API_get_array_values_int(SPVM_RUNTIME* runtime, SPVM_DATA_ARRAY* data_array) {
  (void)runtime;
  
  return (int32_t*)((intptr_t)data_array + SPVM_DATA_C_HEADER_BYTE_SIZE);
}

int64_t* SPVM_RUNTIME_API_get_array_values_long(SPVM_RUNTIME* runtime, SPVM_DATA_ARRAY* data_array) {
  (void)runtime;
  
  return (int64_t*)((intptr_t)data_array + SPVM_DATA_C_HEADER_BYTE_SIZE);
}

float* SPVM_RUNTIME_API_get_array_values_float(SPVM_RUNTIME* runtime, SPVM_DATA_ARRAY* data_array) {
  (void)runtime;
  
  return (float*)((intptr_t)data_array + SPVM_DATA_C_HEADER_BYTE_SIZE);
}

double* SPVM_RUNTIME_API_get_array_values_double(SPVM_RUNTIME* runtime, SPVM_DATA_ARRAY* data_array) {
  (void)runtime;
  
  return (double*)((intptr_t)data_array + SPVM_DATA_C_HEADER_BYTE_SIZE);
}

SPVM_DATA** SPVM_RUNTIME_API_get_array_values_ref(SPVM_RUNTIME* runtime, SPVM_DATA_ARRAY* data_array) {
  (void)runtime;
