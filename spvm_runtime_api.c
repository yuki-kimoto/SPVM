...
void SPVM_RUNTIME_API_free_weaken_back_refs(SPVM_NAI* nai, SPVM_OBJECT* weaken_back_refs, int32_t weaken_back_refs_length) {
  ...
  SPVM_RUNTIME_API_dec_ref_count(nai, (SPVM_OBJECT*)weaken_back_refs);
}
...
void SPVM_RUNTIME_API_weaken(SPVM_NAI* nai, SPVM_OBJECT** object_address) {
  ...
  *object_address = (SPVM_OBJECT*)((intptr_t)*object_address | 1);
  ...
  if (object->weaken_back_refs == NULL) {
    object->weaken_back_refs = SPVM_RUNTIME_API_new_object_array(nai, 32);
  ...
  if (length == capacity) {
    ...
    SPVM_OBJECT* new_weaken_back_refs = SPVM_RUNTIME_API_new_object_array(nai, new_capacity);
    ...
    SPVM_RUNTIME_API_dec_ref_count(nai, (SPVM_OBJECT*)object->weaken_back_refs);
...
void SPVM_RUNTIME_API_set_exception(SPVM_NAI* nai, SPVM_OBJECT* exception) {
  ...
  if (runtime->exception != NULL) {
    SPVM_RUNTIME_API_dec_ref_count(nai, (SPVM_OBJECT*)runtime->exception);
  }
...
SPVM_OBJECT* SPVM_RUNTIME_API_new_byte_array(SPVM_NAI* nai, int32_t length) {
  ...
  SPVM_OBJECT* object = SPVM_RUNTIME_ALLOCATOR_malloc(nai, allocator, array_byte_size);
  ...
  assert(array_byte_size == SPVM_RUNTIME_API_calcurate_object_byte_size(nai, (SPVM_OBJECT*)object));
...
SPVM_OBJECT* SPVM_RUNTIME_API_new_short_array(SPVM_NAI* nai, int32_t length) {
  ...
  assert(array_byte_size == SPVM_RUNTIME_API_calcurate_object_byte_size(nai, object));
...
SPVM_OBJECT* SPVM_RUNTIME_API_new_object(SPVM_NAI* nai, int32_t package_constant_pool_index) {
  ...
  SPVM_OBJECT* object = SPVM_RUNTIME_ALLOCATOR_malloc(nai, allocator, object_byte_size);
  ...
  assert(object_byte_size == SPVM_RUNTIME_API_calcurate_object_byte_size(nai, object));

  return object;
}

int32_t SPVM_RUNTIME_API_get_array_length(SPVM_NAI* nai, SPVM_OBJECT* object) {
  (void)nai;
  
  return object->length;
}

int8_t* SPVM_RUNTIME_API_get_byte_array_elements(SPVM_NAI* nai, SPVM_OBJECT* object) {
  (void)nai;

  return (int8_t*)((intptr_t)object + sizeof(SPVM_OBJECT));
}

int16_t* SPVM_RUNTIME_API_get_short_array_elements(SPVM_NAI* nai, SPVM_OBJECT* object) {
  (void)nai;
  
  return (int16_t*)((intptr_t)object + sizeof(SPVM_OBJECT));
}

int32_t* SPVM_RUNTIME_API_get_int_array_elements(SPVM_NAI* nai, SPVM_OBJECT* object) {
  (void)nai;
  
  return (int32_t*)((intptr_t)object + sizeof(SPVM_OBJECT));
}

int64_t* SPVM_RUNTIME_API_get_long_array_elements(SPVM_NAI* nai, SPVM_OBJECT* object) {
  (void)nai;
  
  return (int64_t*)((intptr_t)object + sizeof(SPVM_OBJECT));
}

float* SPVM_RUNTIME_API_get_float_array_elements(SPVM_NAI* nai, SPVM_OBJECT* object) {
  (void)nai;
  
  return (float*)((intptr_t)object + sizeof(SPVM_OBJECT));
}

double* SPVM_RUNTIME_API_get_double_array_elements(SPVM_NAI* nai, SPVM_OBJECT* object) {
  (void)nai;
  
  return (double*)((intptr_t)object + sizeof(SPVM_OBJECT));
}

SPVM_OBJECT* SPVM_RUNTIME_API_get_object_array_element(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t index) {
  (void)nai;
...
void SPVM_RUNTIME_API_set_object_array_element(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t index, SPVM_OBJECT* value) {
  (void)nai;
  ...
  if(objects[index] != NULL) {
    nai->dec_ref_count(nai, objects[index]);
  }
  
  objects[index] = value;
  
  if(objects[index] != NULL) {
    nai->inc_ref_count(nai, objects[index]);
  }
}

void SPVM_RUNTIME_API_inc_dec_ref_count(SPVM_NAI* nai, SPVM_OBJECT* object) {
  SPVM_RUNTIME_API_inc_ref_count(nai, object);
        ...
        
        {
          ...
          for (i = 0; i < length; i++) {
            ...
            if (object_element != NULL) {
              SPVM_RUNTIME_API_dec_ref_count(nai, object_element);
            }
          }
        }
      }
      SPVM_RUNTIME_ALLOCATOR_free_object(nai, runtime->allocator, object);
    }
    // Reference is object
      ...
      
      {
        ...
        for (i = 0; i < object_fields_length; i++) {
          ...
          if (*object_field_address != NULL) {
            ...
            if (SPVM_RUNTIME_API_isweak(nai, *object_field_address)) {
              SPVM_RUNTIME_API_unweaken(nai, object_field_address);
              (*object_field_address)->ref_count--;
            }
            else {
              SPVM_RUNTIME_API_dec_ref_count(nai, *object_field_address);
            }
          }
        }
      }
      if (object->weaken_back_refs != NULL) {
        SPVM_RUNTIME_API_free_weaken_back_refs(nai, object->weaken_back_refs, object->weaken_back_refs_length);
      }
      
      SPVM_RUNTIME_ALLOCATOR_free_object(nai, runtime->allocator, (SPVM_OBJECT*)object);
    }
  }
}
...
void SPVM_RUNTIME_API_call_void_sub(SPVM_NAI* nai, int32_t sub_constant_pool_index, SPVM_VALUE* args) {
  ...
  SPVM_RUNTIME_call_sub(nai, sub_constant_pool_index);
}
...
int32_t SPVM_RUNTIME_API_get_field_id(SPVM_NAI* nai, SPVM_OBJECT* object, const char* name) {
  ...
  int32_t field_index = SPVM_NAI_ERROR_NO_ID;
  _Bool found = 0;
  {
    int32_t i;
    for (i = 0; i < length; i++) {
...
int32_t SPVM_RUNTIME_API_get_sub_id(SPVM_NAI* nai, const char* name) {
  ...
  int32_t found_sub_constant_pool_index = SPVM_NAI_ERROR_NO_ID;
  _Bool found = 0;
  {
    int32_t i;
    for (i = 0; i < length; i++) {
...
int32_t SPVM_RUNTIME_API_get_package_id(SPVM_NAI* nai, const char* name) {
  ...
  int32_t found_package_constant_pool_index = SPVM_NAI_ERROR_NO_ID;
  _Bool found = 0;
  {
    int32_t i;
    for (i = 0; i < length; i++) {
...
int8_t SPVM_RUNTIME_API_get_byte_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
  int8_t byte_value = fields[field_index].byte_value;
  
  return byte_value;
}

int16_t SPVM_RUNTIME_API_get_short_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
...
int32_t SPVM_RUNTIME_API_get_int_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
...
int64_t SPVM_RUNTIME_API_get_long_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
...
float SPVM_RUNTIME_API_get_float_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
...
double SPVM_RUNTIME_API_get_double_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
...
SPVM_OBJECT* SPVM_RUNTIME_API_get_object_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
...
void SPVM_RUNTIME_API_set_byte_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index, int8_t value) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
  fields[field_index].byte_value = value;
}

void SPVM_RUNTIME_API_set_short_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index, int16_t value) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
  fields[field_index].short_value = value;
}

void SPVM_RUNTIME_API_set_int_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index, int32_t value) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
  fields[field_index].int_value = value;
}

void SPVM_RUNTIME_API_set_long_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index, int64_t value) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
  fields[field_index].long_value = value;
}

void SPVM_RUNTIME_API_set_float_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index, float value) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
  fields[field_index].float_value = value;
}

void SPVM_RUNTIME_API_set_double_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index, double value) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
  fields[field_index].double_value = value;
}

void SPVM_RUNTIME_API_set_object_field(SPVM_NAI* nai, SPVM_OBJECT* object, int32_t field_index, SPVM_OBJECT* value) {
  SPVM_VALUE* fields = SPVM_RUNTIME_API_get_fields(nai, object);
  
  if(fields[field_index].object_value != NULL) {
    nai->dec_ref_count(nai, fields[field_index].object_value);
  }
  
  fields[field_index].object_value = value;
  
  if(fields[field_index].object_value != NULL) {
    nai->inc_ref_count(nai, fields[field_index].object_value);
  }
}

int32_t SPVM_RUNTIME_API_get_array_value_size(SPVM_NAI* nai, int32_t type) {
  (void)nai;
...
int64_t SPVM_RUNTIME_API_calcurate_object_byte_size(SPVM_NAI* nai, SPVM_OBJECT* object) {
  ...
  // Reference is string
  if (object->type == SPVM_OBJECT_C_TYPE_ARRAY) {
    byte_size = sizeof(SPVM_OBJECT) + (object->length + 1) * SPVM_RUNTIME_API_get_array_value_size(nai, object->value_type);
  }
  // Reference is object
  else if (object->type == SPVM_OBJECT_C_TYPE_OBJECT) {
    SPVM_CONSTANT_POOL_PACKAGE constant_pool_package;
...
SPVM_OBJECT* SPVM_RUNTIME_API_new_byte_array_from_pv(SPVM_NAI* nai, const char* pv) {
  ...
  SPVM_OBJECT* object = SPVM_RUNTIME_API_new_byte_array(nai, length);
