  ...
  PPCODE:
{
  ...
  if (is_array_type) {
    ...
    else if (array->type_category == SPVM_TYPE_C_TYPE_CATEGORY_OBJECT_ARRAY || array->type_category == SPVM_TYPE_C_TYPE_CATEGORY_OARRAY || array->type_category == SPVM_TYPE_C_TYPE_CATEGORY_ELEMENT_ARRAY) {
