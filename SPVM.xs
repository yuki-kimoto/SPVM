...
SV* SPVM_XS_UTIL_new_sv_object(SV* sv_builder, SPVM_ENV* env, void* object, const char* class) {
...
void* SPVM_XS_UTIL_get_object(SV* sv_data) {
...
void* SPVM_XS_UTIL_new_mulnum_array(SPVM_ENV* env, const char* basic_type_name, SV* sv_elems, SV** sv_error) {
            ...
            if (!SvOK(sv_value)) {
              ...
              if (arg_basic_type_id == SPVM_NATIVE_C_BASIC_TYPE_ID_STRING) {
                ...
                if (!SvROK(sv_value)) {
                  ...
                  SV* sv_string = SPVM_XS_UTIL_new_sv_object(sv_builder, env, string, "SPVM::BlessedObject::String");
            ...
            if (SvROK(sv_value) && sv_derived_from(sv_value, "ARRAY")) {
              ...
              switch (arg_basic_type_id) {
                ...
                case SPVM_NATIVE_C_BASIC_TYPE_ID_BYTE: {
                  ...
                  SV* sv_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
                  sv_value = sv_array;
                  break;
                }
        ...
        case SPVM_NATIVE_C_BASIC_TYPE_CATEGORY_MULNUM:
        {
          ...
          if (!SvOK(sv_value)) {
            ...
            if (SvROK(sv_value) && sv_derived_from(sv_value, "ARRAY")) {
              ...
              void* array = SPVM_XS_UTIL_new_mulnum_array(env, arg_basic_type_name, sv_value, &sv_error);
              if (sv_error) {
                croak_sv(sv_error);
              }
              SV* sv_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
          ...
          if (!SvOK(sv_value)) {
            ...
            if (SvROK(sv_value) && sv_derived_from(sv_value, "ARRAY")) {
              ...
              if (arg_basic_type_id == SPVM_NATIVE_C_BASIC_TYPE_ID_STRING) {
                ...
                AV* av_elems = (AV*)SvRV(sv_elems);
                int32_t length = av_len(av_elems) + 1;
                void* array = env->new_object_array(env, SPVM_NATIVE_C_BASIC_TYPE_ID_STRING, length);
                for (int32_t i = 0; i < length; i++) {
                  ...
                  if (!SvOK(sv_elem)) {
                    ...
                    if (sv_isobject(sv_elem) && sv_derived_from(sv_elem, "SPVM::BlessedObject::String")) {
                      void* object = SPVM_XS_UTIL_get_object(sv_elem);
        ...
        case SPVM_NATIVE_C_BASIC_TYPE_CATEGORY_ANY_OBJECT:
        {
          ...
          if (return_value != NULL) {
            ...
            if (env->get_object_type_dimension(env, return_value) > 0) {
              sv_return_value = SPVM_XS_UTIL_new_sv_object(sv_builder, env, return_value, "SPVM::BlessedObject::Array");
            }
            else {
              ...
              if (return_value_basic_type_id == SPVM_NATIVE_C_BASIC_TYPE_ID_STRING) {
                sv_return_value = SPVM_XS_UTIL_new_sv_object(sv_builder, env, return_value, "SPVM::BlessedObject::String");
              }
              // Object
              else {
                ...
                sv_return_value = SPVM_XS_UTIL_new_sv_object(sv_builder, env, return_value, SvPV_nolen(sv_perl_class_name));
              }
            }
          }
          // undef
      ...
      if (basic_type_id == SPVM_NATIVE_C_BASIC_TYPE_ID_STRING) {
        for (int32_t i = 0; i < length; i++) {
          ...
          if (object != NULL) {
            ...
            sv_value = SPVM_XS_UTIL_new_sv_object(sv_builder, env, object, "SPVM::BlessedObject::String");
          }
          else {
        ...
        for (int32_t index = 0; index < length; index++) {
          ...
          if (value == NULL) {
            ...
            if (element_type_is_array_type) {
              sv_value = SPVM_XS_UTIL_new_sv_object(sv_builder, env, value, "SPVM::BlessedObject::Array");
            }
            else {
              SV* sv_perl_class_name = sv_2mortal(newSVpv("SPVM::", 0));
              ...
              sv_value = SPVM_XS_UTIL_new_sv_object(sv_builder, env, value, SvPV_nolen(sv_perl_class_name));
            }
            av_push(av_values, SvREFCNT_inc(sv_value));
          }
        }
  ...
  PPCODE:
{
  ...
  if (dimension == 1) {
    switch (basic_type_id) {
      ...
      default: {
        // Get object
        void* value = SPVM_XS_UTIL_get_object(sv_value);
  ...
  PPCODE:
{
  ...
  if (is_object) {
    ...
    if (element_dimension == 0) {
      ...
      sv_value = SPVM_XS_UTIL_new_sv_object(sv_builder, env, value, "SPVM::Data::Array");
    }
  }
  ...
  PPCODE:
{
  ...
  if (SvOK(sv_elems)) {
    ...
    // New sv array
    sv_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
  }
  else {
  ...
  PPCODE:
{
  ...
  // New sv array
  SV* sv_byte_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
  ...
  PPCODE:
{
  ...
  if (SvOK(sv_value)) {
    ...
    if (SvROK(sv_value)) {
      ...
      sv_string = SPVM_XS_UTIL_new_sv_object(sv_builder, env, string, "SPVM::BlessedObject::String");
    }
  }
  else {
  ...
  PPCODE:
{
  ...
  // New sv array
  SV* sv_short_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
  ...
  PPCODE:
{
  ...
  // New sv array
  SV* sv_int_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
  ...
  PPCODE:
{
  ...
  // New sv array
  SV* sv_long_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
  ...
  PPCODE:
{
  ...
  // New sv array
  SV* sv_float_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
  ...
  PPCODE:
{
  ...
  // New sv array
  SV* sv_double_array = SPVM_XS_UTIL_new_sv_object(sv_builder, env, array, "SPVM::BlessedObject::Array");
  ...
  PPCODE:
{
  ...
  SV* sv_error = NULL;
  void* array = SPVM_XS_UTIL_new_mulnum_array(env, basic_type_name, sv_elems, &sv_error);
  ...
  PPCODE:
{
  ...
  if (str_exception) {
    ...
    sv_exception = SPVM_XS_UTIL_new_sv_object(sv_builder, env, str_exception, "SPVM::BlessedObject::String");
  }
  else {
  ...
  PPCODE:
{
  ...
  if (SvOK(sv_exception)) {
    ...
    void* exception = SPVM_XS_UTIL_get_object(sv_exception);
