...
void* SPVM_RUNTIME_ALLOCATOR_malloc(SPVM_SNI* sni, SPVM_RUNTIME_ALLOCATOR* allocator, int32_t size);
void SPVM_RUNTIME_ALLOCATOR_free_object(SPVM_SNI* sni, SPVM_RUNTIME_ALLOCATOR* allocator, SPVM_OBJECT* object);
int32_t SPVM_RUNTIME_ALLOCATOR_get_freelist_index(SPVM_SNI* sni, SPVM_RUNTIME_ALLOCATOR* allocator, int64_t size);
