...
void SPVM_BYTECODE_BUILDER_push_inc_bytecode(SPVM_COMPILER* compiler, SPVM_BYTECODE_ARRAY* bytecode_array, SPVM_OP* op_inc, int32_t value) {
  ...
  if (resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
  ...
  else if (resolved_type->id == SPVM_TYPE_C_ID_SHORT) {
    if (my_var->index > 0xFF || (value < -128 || value > 127)) {
      SPVM_BYTECODE_ARRAY_push(compiler, bytecode_array, SPVM_BYTECODE_C_CODE_WIDE);
  ...
  else if (resolved_type->id == SPVM_TYPE_C_ID_INT) {
    if (my_var->index > 0xFF || (value < -128 || value > 127)) {
      SPVM_BYTECODE_ARRAY_push(compiler, bytecode_array, SPVM_BYTECODE_C_CODE_WIDE);
  ...
  else if (resolved_type->id == SPVM_TYPE_C_ID_LONG) {
    if (my_var->index > 0xFF || (value < -128 || value > 127)) {
      SPVM_BYTECODE_ARRAY_push(compiler, bytecode_array, SPVM_BYTECODE_C_CODE_WIDE);
...
void SPVM_BYTECODE_BUILDER_build_bytecode_array(SPVM_COMPILER* compiler) {
  ...
  for (int32_t package_pos = 0; package_pos < compiler->op_packages->length; package_pos++) {
    ...
    for (int32_t sub_pos = 0; sub_pos < package->op_subs->length; sub_pos++) {
      ...
      SPVM_ARRAY* goto_exception_handler_bytecode_index_stack = SPVM_COMPILER_ALLOCATOR_alloc_array(compiler, compiler->allocator, 0);
            ...
            switch (op_cur->code) {
              ...
              case SPVM_OP_C_CODE_CATCH: {
                ...
                for (int32_t i = 0; i < pop_count; i++) {
                  ...
                  int32_t* bytecode_index_ptr = SPVM_ARRAY_pop(goto_exception_handler_bytecode_index_stack);
              ...
              case SPVM_OP_C_CODE_SWITCH: {
                ...
                // tableswitch
                if (switch_info->code == SPVM_SWITCH_INFO_C_CODE_TABLE_SWITCH) {
                  if (term_condition_resolved_type->id == SPVM_TYPE_C_ID_INT) {
                  ...
                  else if (term_condition_resolved_type->id == SPVM_TYPE_C_ID_LONG) {
              ...
              case SPVM_OP_C_CODE_CALL_FIELD: {
                ...
                if (!op_cur->lvalue) {
                  ...
                  else if (resolved_type->id == SPVM_TYPE_C_ID_FLOAT) {
                    SPVM_BYTECODE_ARRAY_push(compiler, bytecode_array, SPVM_BYTECODE_C_CODE_GET_FIELD_FLOAT);
                  }
                  else if (resolved_type->id == SPVM_TYPE_C_ID_DOUBLE) {
              ...
              case SPVM_OP_C_CODE_CALL_SUB: {
                ...
                if (try_stack->length > 0) {
                  ...
                  int32_t* bytecode_index_ptr = SPVM_COMPILER_ALLOCATOR_alloc_int(compiler, compiler->allocator);
                  *bytecode_index_ptr = bytecode_array->length - 1;
                  SPVM_ARRAY_push(goto_exception_handler_bytecode_index_stack, bytecode_index_ptr);
              ...
              case SPVM_OP_C_CODE_CONDITION: {
                ...
                if (op_condition_target->code == SPVM_OP_C_CODE_UNDEF) {
                  ...
                  else if (resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
              ...
              case SPVM_OP_C_CODE_ARRAY_ELEM: {
                ...
                assert(last_resolved_type->id == SPVM_TYPE_C_ID_INT);
              ...
              case SPVM_OP_C_CODE_ASSIGN: {
                ...
                if (op_cur->first->code == SPVM_OP_C_CODE_VAR) {
                  ...
                  assert(index_resolved_type->id == SPVM_TYPE_C_ID_INT);
              ...
              case SPVM_OP_C_CODE_CONVERT: {
                ...
                if (src_resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
                  if (dist_resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
                    // None
                  }
                  else if (dist_resolved_type->id == SPVM_TYPE_C_ID_SHORT) {
                    SPVM_BYTECODE_ARRAY_push(compiler, bytecode_array, SPVM_BYTECODE_C_CODE_CONVERT_BYTE_TO_SHORT);
                  }
                  else if (dist_resolved_type->id == SPVM_TYPE_C_ID_INT) {
                    SPVM_BYTECODE_ARRAY_push(compiler, bytecode_array, SPVM_BYTECODE_C_CODE_CONVERT_BYTE_TO_INT);
                  }
                  else if (dist_resolved_type->id == SPVM_TYPE_C_ID_LONG) {
                    SPVM_BYTECODE_ARRAY_push(compiler, bytecode_array, SPVM_BYTECODE_C_CODE_CONVERT_BYTE_TO_LONG);
                  }
                  else if (dist_resolved_type->id == SPVM_TYPE_C_ID_FLOAT) {
                    SPVM_BYTECODE_ARRAY_push(compiler, bytecode_array, SPVM_BYTECODE_C_CODE_CONVERT_BYTE_TO_FLOAT);
                  }
                  else if (dist_resolved_type->id == SPVM_TYPE_C_ID_DOUBLE) {
                ...
                else if (src_resolved_type->id == SPVM_TYPE_C_ID_SHORT) {
                  if (dist_resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
                ...
                else if (src_resolved_type->id == SPVM_TYPE_C_ID_INT) {
                  if (dist_resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
                ...
                else if (src_resolved_type->id == SPVM_TYPE_C_ID_LONG) {
                  if (dist_resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
                ...
                else if (src_resolved_type->id == SPVM_TYPE_C_ID_FLOAT) {
                  if (dist_resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
                ...
                else if (src_resolved_type->id == SPVM_TYPE_C_ID_DOUBLE) {
                  if (dist_resolved_type->id == SPVM_TYPE_C_ID_BYTE) {
