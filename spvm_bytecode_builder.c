            ...
            switch (op_cur->code) {
              ...
              case SPVM_OP_C_CODE_SWITCH_CONDITION: {
                ...
                if (switch_info->code == SPVM_SWITCH_INFO_C_CODE_TABLE_SWITCH) {
                  ...
                  int32_t switch_bytecode_index = bytecode_array->length - 8;
                  ...
                  int32_t case_pos = 0;
                  {
                    ...
                    for (i = 0; i < length; i++) {
                      ...
                      if (op_constant->uv.constant->value.int_value - min == i) {
                        ...
                        bytecode_array->values[switch_bytecode_index + 8 + i] = case_offset;
                        
                        case_pos++;
                      }
                      else {
                        // Default
                        bytecode_array->values[switch_bytecode_index + 8 + i] = default_offset;
                      }
                    }
                  }
                }
