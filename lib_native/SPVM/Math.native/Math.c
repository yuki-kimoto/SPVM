...
int32_t SPVM__Math__isinff(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
int32_t SPVM__Math__isfinitef(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
int32_t SPVM__Math__isnanf(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
float SPVM__Math__INFINITYF(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
float SPVM__Math__NANF(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
double SPVM__Math__INFINITY(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
double SPVM__Math__NAN(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
int32_t SPVM__Math__isinf(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
int32_t SPVM__Math__isnan(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
int32_t SPVM__Math__isfinite(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
  (void)args;
...
double SPVM__Math__acosh(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__atanh(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__asinh(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__exp2(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__remainder(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__nearbyint(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
int64_t SPVM__Math__labs(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__fabs(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__erf(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__erfc(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__lgamma(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
...
double SPVM__Math__tgamma(SPVM_API* api, SPVM_API_VALUE* args) {
  (void)api;
