...
SPVM_API_VALUE SPVM_RUNTIME_call_sub(SPVM_API* api, int32_t sub_id, SPVM_API_VALUE* args) {
  ...
  if (sub_is_native) {
    ...
    if (sub_return_type_code == SPVM_INFO_TYPE_CODE_VOID) {
      ...
      SPVM_API_byte return_value_native = (*native_address)(api, (SPVM_API_VALUE*)call_stack);
      *(SPVM_API_byte*)&return_value = return_value_native;
      ...
      SPVM_API_short return_value_native = (*native_address)(api, (SPVM_API_VALUE*)call_stack);
      *(SPVM_API_short*)&return_value = return_value_native;
      ...
      SPVM_API_int return_value_native = (*native_address)(api, (SPVM_API_VALUE*)call_stack);
      *(SPVM_API_int*)&return_value = return_value_native;
      ...
      SPVM_API_long return_value_native = (*native_address)(api, (SPVM_API_VALUE*)call_stack);
  ...
  SPVM_API_VALUE auto_dec_ref_count_stack[65535];
  
  // Auto decrement reference count variable index stack top
  int32_t auto_dec_ref_count_stack_base = 0;
  ...
  while (1) {
    ...
    switch (opcode->code) {
      ...
      case SPVM_OPCODE_C_CODE_PUSH_AUTO_DEC_REF_COUNT: {
        ...
        auto_dec_ref_count_stack[auto_dec_ref_count_stack_base + auto_dec_ref_count_stack_top].int_value = opcode->operand0;
        break;
      }
      case SPVM_OPCODE_C_CODE_LEAVE_SCOPE: {
        ...
        for (auto_dec_ref_count_index = auto_dec_ref_count_stack_current_base; auto_dec_ref_count_index <= auto_dec_ref_count_stack_top; auto_dec_ref_count_index++) {
          int32_t var_index = auto_dec_ref_count_stack[auto_dec_ref_count_stack_base + auto_dec_ref_count_index].int_value;
