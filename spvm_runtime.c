...
SPVM_API* SPVM_RUNTIME_new_api(SPVM_RUNTIME* runtime) {
  ...
  api->push_byte = SPVM_RUNTIME_API_push_byte;
  api->push_short = SPVM_RUNTIME_API_push_short;
  api->push_int = SPVM_RUNTIME_API_push_int;
  api->push_long = SPVM_RUNTIME_API_push_long;
  api->push_float = SPVM_RUNTIME_API_push_float;
  api->push_double = SPVM_RUNTIME_API_push_double;
  api->push_ref = SPVM_RUNTIME_API_push_ref;
