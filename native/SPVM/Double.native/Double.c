...
double SPVM__Double__NEGATIVE_INFINITY(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
double SPVM__Double__NaN(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
double SPVM__Double__MAX_VALUE(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
double SPVM__Double__MIN_NORMAL(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
double SPVM__Double__MIN_VALUE(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
int32_t SPVM__Double__is_infinite(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
int32_t SPVM__Double__is_nan(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
int32_t SPVM__Double__is_finite(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
int64_t SPVM__Double__double_to_long_bits(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
int64_t SPVM__Double__double_to_raw_long_bits(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
...
double SPVM__Double__long_bits_to_double(SPVM_API* api, SPVM_VALUE* args) {
  (void)api;
