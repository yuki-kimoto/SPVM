...
enum {
  ...
  SPVM_OPCODE_C_ID_LOAD_CONSTANT_BYTE_0,
  SPVM_OPCODE_C_ID_LOAD_CONSTANT_SHORT_0,
  SPVM_OPCODE_C_ID_LOAD_CONSTANT_INT_0,
  SPVM_OPCODE_C_ID_LOAD_CONSTANT_LONG_0,
  SPVM_OPCODE_C_ID_LOAD_CONSTANT_FLOAT_0,
  SPVM_OPCODE_C_ID_LOAD_CONSTANT_DOUBLE_0,
  ...
  SPVM_OPCODE_C_ID_PUSH_AUTO_DEC_REF_COUNT,
