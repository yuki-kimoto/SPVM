...
enum {
  ...
  SPVM_OPCODE_C_ID_GET_PACKAGE_VAR_ACCESS_BYTE,
  SPVM_OPCODE_C_ID_GET_PACKAGE_VAR_ACCESS_SHORT,
  SPVM_OPCODE_C_ID_GET_PACKAGE_VAR_ACCESS_INT,
  SPVM_OPCODE_C_ID_GET_PACKAGE_VAR_ACCESS_LONG,
  SPVM_OPCODE_C_ID_GET_PACKAGE_VAR_ACCESS_FLOAT,
  SPVM_OPCODE_C_ID_GET_PACKAGE_VAR_ACCESS_DOUBLE,
  SPVM_OPCODE_C_ID_GET_PACKAGE_VAR_ACCESS_OBJECT,
  SPVM_OPCODE_C_ID_SET_PACKAGE_VAR_ACCESS_BYTE,
  SPVM_OPCODE_C_ID_SET_PACKAGE_VAR_ACCESS_SHORT,
  SPVM_OPCODE_C_ID_SET_PACKAGE_VAR_ACCESS_INT,
  SPVM_OPCODE_C_ID_SET_PACKAGE_VAR_ACCESS_LONG,
  SPVM_OPCODE_C_ID_SET_PACKAGE_VAR_ACCESS_FLOAT,
  SPVM_OPCODE_C_ID_SET_PACKAGE_VAR_ACCESS_DOUBLE,
  SPVM_OPCODE_C_ID_SET_PACKAGE_VAR_ACCESS_OBJECT,
  SPVM_OPCODE_C_ID_SET_PACKAGE_VAR_ACCESS_UNDEF,
