...
enum {
  ...
  SPVM_OPCODE_C_ID_CHECK_CAST_TO_PACKAGE,
  SPVM_OPCODE_C_ID_CHECK_CAST_TO_INTERFACE,
  SPVM_OPCODE_C_ID_CHECK_CAST_TO_PACKAGE_ARRAY,
  SPVM_OPCODE_C_ID_CHECK_CAST_TO_INTERFACE_ARRAY,
};
