...
enum {
  ...
  SPVM_OPCODE_C_CODE_ADD_BYTE,
  SPVM_OPCODE_C_CODE_ADD_SHORT,
  SPVM_OPCODE_C_CODE_ADD_INT,
  SPVM_OPCODE_C_CODE_ADD_LONG,
  SPVM_OPCODE_C_CODE_ADD_FLOAT,
  SPVM_OPCODE_C_CODE_ADD_DOUBLE,
  SPVM_OPCODE_C_CODE_SUBTRACT_BYTE,
  SPVM_OPCODE_C_CODE_SUBTRACT_SHORT,
  ...
  SPVM_OPCODE_C_CODE_MULTIPLY_BYTE,
  SPVM_OPCODE_C_CODE_MULTIPLY_SHORT,
  ...
  SPVM_OPCODE_C_CODE_DIVIDE_BYTE,
  SPVM_OPCODE_C_CODE_DIVIDE_SHORT,
  ...
  SPVM_OPCODE_C_CODE_COMPLEMENT_BYTE,
  SPVM_OPCODE_C_CODE_COMPLEMENT_SHORT,
  SPVM_OPCODE_C_CODE_COMPLEMENT_INT,
  SPVM_OPCODE_C_CODE_COMPLEMENT_LONG,
  SPVM_OPCODE_C_CODE_NEGATE_BYTE,
  SPVM_OPCODE_C_CODE_NEGATE_SHORT,
  ...
  SPVM_OPCODE_C_CODE_LOAD_CONSTANT,
  SPVM_OPCODE_C_CODE_LOAD_CONSTANT2,
  SPVM_OPCODE_C_CODE_LOAD_CONSTANT_0,
  SPVM_OPCODE_C_CODE_LOAD_CONSTANT2_0,
  ...
  SPVM_OPCODE_C_CODE_RETURN_VOID,
  SPVM_OPCODE_C_CODE_RETURN_BYTE,
  SPVM_OPCODE_C_CODE_RETURN_SHORT,
  SPVM_OPCODE_C_CODE_RETURN_INT,
  SPVM_OPCODE_C_CODE_RETURN_LONG,
  SPVM_OPCODE_C_CODE_RETURN_FLOAT,
  SPVM_OPCODE_C_CODE_RETURN_DOUBLE,
  SPVM_OPCODE_C_CODE_RETURN_OBJECT,
  ...
  SPVM_OPCODE_C_CODE_LOAD_PACKAGE_VAR,
  SPVM_OPCODE_C_CODE_STORE_PACKAGE_VAR,
