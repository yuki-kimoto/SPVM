...
static const char* FILE_NAME = "Array2.c";

int32_t SPVM__Array2__memcpy_byte(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memcpy_double(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memcpy_float(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memcpy_int(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memcpy_long(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memcpy_short(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memmove_byte(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memmove_double(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memmove_float(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memmove_int(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memmove_long(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__memmove_short(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array2__new_proto(SPVM_ENV* env, SPVM_VALUE* stack) {
