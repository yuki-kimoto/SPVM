...
int32_t SPNATIVE__Fn__FLT_MAX(SPVM_ENV* env, SPVM_VALUE* stack) {
  (void)env;
  (void)stack;
...
int32_t SPNATIVE__Fn__FLT_MIN(SPVM_ENV* env, SPVM_VALUE* stack) {
  (void)env;
  (void)stack;
...
int32_t SPNATIVE__Fn__DBL_MAX(SPVM_ENV* env, SPVM_VALUE* stack) {
  (void)env;
  (void)stack;
...
int32_t SPNATIVE__Fn__DBL_MIN(SPVM_ENV* env, SPVM_VALUE* stack) {
  (void)env;
  (void)stack;
...
int32_t SPNATIVE__Fn__srand(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__crand(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__RAND_MAX(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn___snsprintf_double(SPVM_ENV* env, SPVM_VALUE* stack) {
  (void)env;
...
int32_t SPNATIVE__Fn___long_to_unsigned_digits(SPVM_ENV* env, SPVM_VALUE* stack) {
  (void)env;
...
int32_t SPNATIVE__Fn__to_int_with_base(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__to_long_with_base(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__to_float(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__to_double(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memcpy_byte(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memmove_byte(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memcpy_short(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memmove_short(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memcpy_int(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memmove_int(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memcpy_long(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memmove_long(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memcpy_float(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memmove_float(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memcpy_double(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__memmove_double(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPNATIVE__Fn__new_array_proto(SPVM_ENV* env, SPVM_VALUE* stack) {
