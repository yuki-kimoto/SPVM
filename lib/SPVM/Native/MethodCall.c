...
int32_t SPVM__Native__MethodCall__new_method_with_env_stack_common(SPVM_ENV* env, SPVM_VALUE* stack, int32_t method_call_type) {
  ...
  if (method_call_type == 0) {
    ...
    if (!obj_method_name) {
      return env->die_v2(env, stack, "The method name $method_name must be defined.", __func__, FILE_NAME, __LINE__);
    }
    ...
    if (!method) {
      return env->die_v2(env, stack, "The \"%s\" class method in the \"%s\" class cannot be found.", __func__, FILE_NAME, __LINE__, method_name, basic_type_name);
    }
  }
    ...
    if (!method) {
      return env->die_v2(env, stack, "The \"%s\" instance method in the \"%s\" class cannot be found.", __func__, FILE_NAME, __LINE__, method_name, basic_type_name);
    }
  }
  else if (method_call_type == 2) {
    
    if (!obj_instance) {
      return env->die_v2(env, stack, "The instance $instance must be defined.", __func__, FILE_NAME, __LINE__);
    }
    ...
    if (!method) {
      return env->die_v2(env, stack, "The \"%s\" instance method cannot be found.", __func__, FILE_NAME, __LINE__, method_name);
    }
  }
...
int32_t SPVM__Native__MethodCall__call(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  if (obj_error_id_ref) {
    ...
    if (!(error_id_ref_length == 1)) {
      return env->die_v2(env, stack, "If the reference to an error id $error_id_ref exists, the length of it must be 1.", __func__, FILE_NAME, __LINE__);
    }
  }
  ...
  if (!(args_length >= method_required_args_length)) {
    return env->die_v2(env, stack, "%s#%s method failed to execute. Too few arguments.", __func__, FILE_NAME, __LINE__, class_name, method_name);
  }
  ...
  for (int32_t arg_index = 0; arg_index < args_length; arg_index++) {
    ...
    if (method_arg_is_object_type) {
      ...
      if (obj_arg) {
        ...
        if (!can_assign) {
          return env->die_v2(env, stack, "%s#%s method failed to execute. The %dth argument cannot be assigned.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
        }
        ...
        if (!is_binary_compatible_object) {
          return env->die_v2(env, stack, "%s#%s method failed to execute. The object of the %dth argument is not binary compatible.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
        }
      }
      ...
      if (!obj_arg) {
        return env->die_v2(env, stack, "%s#%s method failed to execute. The %dth argument must be defined.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
      }
      ...
      if (!method_arg_type_is_ref) {
        if (method_arg_basic_type_category == SPVM_NATIVE_C_BASIC_TYPE_CATEGORY_NUMERIC) {
          switch (method_arg_basic_type_id) {
            case SPVM_NATIVE_C_BASIC_TYPE_ID_BYTE : {
              if (!env->is_type_by_name(env, stack, obj_arg, "Byte", 0)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the Byte class.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_SHORT : {
              if (!env->is_type_by_name(env, stack, obj_arg, "Short", 0)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the Short class.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_INT : {
              if (!env->is_type_by_name(env, stack, obj_arg, "Int", 0)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the Int class.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_LONG : {
              if (!env->is_type_by_name(env, stack, obj_arg, "Long", 0)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the Long class.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT : {
              if (!env->is_type_by_name(env, stack, obj_arg, "Float", 0)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the Float class.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE : {
              if (!env->is_type_by_name(env, stack, obj_arg, "Double", 0)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the Double class.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
          ...
          if (!(arg_array_length == method_arg_width)) {
            return env->die_v2(env, stack, "%s#%s method failed to execute. The array length of the %dth argument must be %d.", class_name, method_name, arg_index + 1, method_arg_width, __func__, FILE_NAME, __LINE__);
          }
          ...
          switch (method_arg_mulnum_field_basic_type_id) {
            case SPVM_NATIVE_C_BASIC_TYPE_ID_BYTE : {
              if (!env->is_type_by_name(env, stack, obj_arg, "byte", 1)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the byte[] type.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_SHORT : {
              if (!env->is_type_by_name(env, stack, obj_arg, "short", 1)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the short[] type.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_INT : {
              if (!env->is_type_by_name(env, stack, obj_arg, "int", 1)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the int[] type.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_LONG : {
              if (!env->is_type_by_name(env, stack, obj_arg, "long", 1)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the long[] type.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT : {
              if (!env->is_type_by_name(env, stack, obj_arg, "float", 1)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the float[] type.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
            ...
            case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE : {
              if (!env->is_type_by_name(env, stack, obj_arg, "double", 1)) {
                return env->die_v2(env, stack, "%s#%s method failed to execute. The type of the %dth argument must be the double[] type.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
              }
        ...
        if (method_arg_basic_type_category == SPVM_NATIVE_C_BASIC_TYPE_CATEGORY_NUMERIC) {
          ...
          if (!(arg_array_length == 1)) {
            return env->die_v2(env, stack, "%s#%s method failed to execute. The array length of the %dth argument must be 1.", __func__, FILE_NAME, __LINE__, class_name, method_name, arg_index + 1);
          }
  ...
  if (method_return_is_object_type) {
    ...
    if (!is_binary_compatible_object) {
      return env->die_v2(env, stack, "The return object is not binary compatible.", __func__, FILE_NAME, __LINE__);
    }
  }
  else {
