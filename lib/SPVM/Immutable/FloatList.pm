package SPVM::Immutable::FloatList;
...
C<static method new : L<Immutable::FloatList|SPVM::Immutable::FloatList> ($array : float[] = undef);>
...
C<static method new_len : L<Immutable::FloatList|SPVM::Immutable::FloatList> ($length : int);>
