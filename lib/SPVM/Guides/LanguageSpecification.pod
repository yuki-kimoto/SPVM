...
=begin html
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            The SPVM <a href="#language-type-short"> short </a> matches the C99 int16_t type.
          </ td>
        </ tr>
        <tr>
          <td>
...
<tr>
          ...
          <td>
            The SPVM <a href="#language-type-float"> float type </a> matches the C99 float type.
          </ td>
        <tr>
          <td>
            <b> double </ b>
          ...
          <td>
            SPVM <a href="#language-type-double"> double </a> matches C99 double.
          </ td>
        </ tr>
        <tr>
          <td>
          ...
          <td>
            The SPVM <a href="#language-type-object"> object type </a> matches the C99 void * type.
          </ td>
        </ tr>        
<tr>
          <td>
            <b> Multiple numeric types </ b>
          </ td>
          <td>
            Numeric array type that matches the number and length of multiple numeric fields
          </ td>
          <td>
            <p>
              For example, if <a href="#language-type-multi-numeric"> multiple numeric types </a>
            </ p>
            <p>
              package Point_2i: mulnum_t {has x: int; has y: int;}
            </ p>
            <p>
              If the field type is int type and the number of fields is 2,
            </ p>
            <p>
              Matches the type declared in C99 "int32_t var [2];".
            </ p>
          </ td>
        </ tr>
      </table>
