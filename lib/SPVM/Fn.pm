...
$string_or_ref must be defined. Otherwise an exception is thrown.

$string_or_ref must be a string or a string array of 1-length. Otherwise an exception is thrown.
