...
The range format of the (pattern|replace) cannnot be contain an invalid Unicode code point. If it is, an exception is thrown. If it is, an exception is thrown.
