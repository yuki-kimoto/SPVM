...
You must include C<spvm_interface.h> to use SPVM Native API. 
...
SPVM Native API object. This object is always First Argument of native function .
  ...
  int32_t SPVM__TestCase__Extension__array_sum(SPVM_API* api, SPVM_VALUE* args) {
