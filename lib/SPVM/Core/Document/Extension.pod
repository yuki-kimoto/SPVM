...
SPVM::Core::Document::Extension - C/C++ Binding using SPVM Extension(BETA before 1.0)
...
Next, you write C language. You include C<spvm_interface.h>.
...
First argument is C<api>. This is the pointer to C<SPVM_API>. Second argument is C<args>. This is array of C<SPVM_VALUE>.
