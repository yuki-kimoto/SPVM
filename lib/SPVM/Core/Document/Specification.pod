...
SPVM::Core::Document::Specification - SPVM Language Specification(BETA before 1.0)
...
Array Initialization Syntax:
  ...
  my $nums : int[] = [1, 2, 3];
  my $points : Point[] = [Point::new(), Point::new(), Point::new()];
  
Note that Array Initialization syntax don't support Type Inference. You must write Type.
