...
enum {
  ...
  SPVM_OPCODE_C_ID_VALUE_T_DEREF_GET_FETCH_SHORT,
  SPVM_OPCODE_C_ID_VALUE_T_DEREF_GET_FETCH_INT,
  SPVM_OPCODE_C_ID_VALUE_T_DEREF_GET_FETCH_LONG,
  SPVM_OPCODE_C_ID_VALUE_T_DEREF_GET_FETCH_FLOAT,
  SPVM_OPCODE_C_ID_VALUE_T_DEREF_GET_FETCH_DOUBLE,
