...
void SPVM_CSOURCE_BUILDER_build_sub_implementation(SPVM_COMPILER* compiler, SPVM_STRING_BUFFER* string_buffer, const char* package_name, const char* sub_name) {
  ...
  if (var_alloc_length > 0) {
    ...
    SPVM_STRING_BUFFER_add(compiler, string_buffer , "];\n");
    SPVM_STRING_BUFFER_add(compiler, string_buffer , "  memset(vars, 0, sizeof(SPVM_VALUE) * ");
    SPVM_STRING_BUFFER_add_int(compiler, string_buffer , var_alloc_length);
    SPVM_STRING_BUFFER_add(compiler, string_buffer , ");\n");
  }
  ...
  SPVM_STRING_BUFFER_add(compiler, string_buffer , "  int32_t call_sub_arg_stack_top = 0;\n");
  ...
  if (arg_alloc_length > 0) {
    SPVM_STRING_BUFFER_add(compiler, string_buffer , "  memcpy(vars, stack, sizeof(SPVM_VALUE) * ");
    SPVM_STRING_BUFFER_add_int(compiler, string_buffer , arg_alloc_length);
    SPVM_STRING_BUFFER_add(compiler, string_buffer , ");\n");
  }
  ...
  while (opcode_index < opcode_length) {
    ...
    switch (opcode->id) {
      ...
      case SPVM_OPCODE_C_ID_MOVE_VALUES:
        SPVM_STRING_BUFFER_add(compiler, string_buffer , "memcpy(&vars[opcode->operand0], &vars[opcode->operand1], sizeof(SPVM_VALUE) * ");
      ...
      {
        SPVM_STRING_BUFFER_add(compiler, string_buffer , "  *(void**)&stack[call_sub_arg_stack_top] = NULL;\n");
      ...
      case SPVM_OPCODE_C_ID_CALL_INTERFACE_METHOD:
      {
        ...
        SPVM_STRING_BUFFER_add(compiler, string_buffer , "    call_sub_arg_stack_top -= ");
        SPVM_STRING_BUFFER_add_int(compiler, string_buffer , decl_sub_args_length);
        SPVM_STRING_BUFFER_add(compiler, string_buffer , ";\n");
        SPVM_STRING_BUFFER_add(compiler, string_buffer , "  }\n");
