                  ...
                  case SPVM_OP_C_ID_ASSIGN: {
                    ...
                    if (op_assign_dist->id == SPVM_OP_C_ID_VAR) {
                      ...
                      if (0) {
                        ...
                        _Bool type_dist_is_value_t = SPVM_TYPE_is_value_type(compiler, type_dist->basic_type->id, type_dist->dimension);

                        if (type_dist_is_value_t) {
