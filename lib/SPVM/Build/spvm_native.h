...
struct SPVM_env {
  ...
  void* (*new_object_immortal)(SPVM_ENV*, int32_t);
  void* (*new_byte_array_immortal)(SPVM_ENV*, int32_t);
  void* (*new_short_array_immortal)(SPVM_ENV*, int32_t);
  void* (*new_int_array_immortal)(SPVM_ENV*, int32_t);
  void* (*new_long_array_immortal)(SPVM_ENV*, int32_t);
  void* (*new_float_array_immortal)(SPVM_ENV*, int32_t);
  void* (*new_double_array_immortal)(SPVM_ENV*, int32_t);
  void* (*new_object_array_immortal)(SPVM_ENV*, int32_t, int32_t);
  void* (*new_multi_array_immortal)(SPVM_ENV*, int32_t, int32_t, int32_t);
  void* (*new_string_immortal)(SPVM_ENV* env, char* bytes, int32_t length);
  void* (*new_struct_immortal)(SPVM_ENV*, int32_t basic_type_id, void* ptr);
