...
List of Native APIs.
  ...
  void* (*new_string)(SPVM_ENV* api, int8_t* bytes, int32_t length);
  void* (*new_string_chars)(SPVM_ENV* api, const char* chars);
  int32_t (*get_string_length)(SPVM_ENV* api, void*);
  int8_t* (*get_string_bytes)(SPVM_ENV* api, void*);
  void* (*get_exception)(SPVM_ENV* api);
  void (*set_exception)(SPVM_ENV* api, void* exception);
  int32_t (*get_ref_count)(SPVM_ENV* api, void* base_object);
  void (*inc_ref_count)(SPVM_ENV* api, void* base_object);
  void (*dec_ref_count)(SPVM_ENV* api, void* base_object);
  void (*inc_dec_ref_count)(SPVM_ENV* api, void* base_object);
  int32_t (*get_objects_count)(SPVM_ENV* api);
  void* (*get_runtime)(SPVM_ENV* api);
  void (*dec_ref_count_only)(SPVM_ENV* api, void* base_object);
