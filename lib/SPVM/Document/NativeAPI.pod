...
To mprove peformance, you can write programing logic by C language and Native API.
...
You must include C<spvm_api.h> to use SPVM Native API. 
...
and add C<SPVM> to the top of it.
  ...
  SPVM::TestCase::Inline::sum  SPVM__TestCase__Inline__sum   
...
SPVM Native API object. This object is always First Argument of native function .
  ...
  int32_t SPVM__TestCase__Inline__array_sum(SPVM_API* api, SPVM_API_VALUE* args) {
