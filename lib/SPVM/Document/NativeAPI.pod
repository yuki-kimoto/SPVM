...
=head1 LIST of NATIVE API
  ...
  void* (*i_to_string_raw)(SPVM_ENV* env, int32_t value);
  void* (*i_to_string)(SPVM_ENV* env, int32_t value);
  void* (*l_to_string_raw)(SPVM_ENV* env, int64_t value);
  void* (*l_to_string)(SPVM_ENV* env, int64_t value);
  void* (*f_to_string_raw)(SPVM_ENV* env, float value);
  void* (*f_to_string)(SPVM_ENV* env, float value);
  void* (*d_to_string_raw)(SPVM_ENV* env, double value);
  void* (*d_to_string)(SPVM_ENV* env, double value);
  ...
  int8_t* (*get_elems_byte)(SPVM_ENV*, void*);
  int16_t* (*get_elems_short)(SPVM_ENV*, void*);
  int32_t* (*get_elems_int)(SPVM_ENV*, void*);
  int64_t* (*get_elems_long)(SPVM_ENV*, void*);
  float* (*get_elems_float)(SPVM_ENV*, void*);
  double* (*get_elems_double)(SPVM_ENV*, void*);
  void* (*get_elem_object)(SPVM_ENV*, void*, int32_t index);
  void (*set_elem_object)(SPVM_ENV*, void*, int32_t index, void* value);
  int32_t (*field_id)(SPVM_ENV*, const char*, const char*, const char*);
  int8_t (*get_field_byte)(SPVM_ENV*, void*, int32_t);
  int16_t (*get_field_short)(SPVM_ENV*, void*, int32_t);
  int32_t (*get_field_int)(SPVM_ENV*, void*, int32_t);
  int64_t (*get_field_long)(SPVM_ENV*, void*, int32_t);
  float (*get_field_float)(SPVM_ENV*, void*, int32_t);
  double (*get_field_double)(SPVM_ENV*, void*, int32_t);
  void* (*get_field_object)(SPVM_ENV*, void*, int32_t);
  void (*set_field_byte)(SPVM_ENV*, void*, int32_t, int8_t);
  void (*set_field_short)(SPVM_ENV*, void*, int32_t, int16_t);
  void (*set_field_int)(SPVM_ENV*, void*, int32_t, int32_t);
  void (*set_field_long)(SPVM_ENV*, void*, int32_t, int64_t);
  void (*set_field_float)(SPVM_ENV*, void*, int32_t, float);
  void (*set_field_double)(SPVM_ENV*, void*, int32_t, double);
  void (*set_field_object)(SPVM_ENV*, void*, int32_t, void*);
  ...
  int8_t (*get_package_var_byte)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  int16_t (*get_package_var_short)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  int32_t (*get_package_var_int)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  int64_t (*get_package_var_long)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  float (*get_package_var_float)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  double (*get_package_var_double)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  void* (*get_package_var_object)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  void (*set_package_var_byte)(SPVM_ENV* env, void* object, int32_t pkgvar_id, int8_t value);
  void (*set_package_var_short)(SPVM_ENV* env, void* object, int32_t pkgvar_id, int16_t value);
  void (*set_package_var_int)(SPVM_ENV* env, void* object, int32_t pkgvar_id, int32_t value);
  void (*set_package_var_long)(SPVM_ENV* env, void* object, int32_t pkgvar_id, int64_t value);
  void (*set_package_var_float)(SPVM_ENV* env, void* object, int32_t pkgvar_id, float value);
  void (*set_package_var_double)(SPVM_ENV* env, void* object, int32_t pkgvar_id, double value);
  void (*set_package_var_object)(SPVM_ENV* env, void* object, int32_t pkgvar_id, void* value);
