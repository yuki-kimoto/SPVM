...
=head1 LIST of NATIVE API
  ...
  int8_t (*get_bpkgvar)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  int16_t (*get_spkgvar)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  int32_t (*get_ipkgvar)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  int64_t (*get_lpkgvar)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  float (*get_fpkgvar)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  double (*get_dpkgvar)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
  void* (*get_opkgvar)(SPVM_ENV* env, void* object, int32_t pkgvar_id);
