...
List of Native APIs.
  ...
  void* (*new_string)(SPVM_API* api, int8_t* bytes, int32_t length);
  void* (*new_string_chars)(SPVM_API* api, const char* chars);
  int32_t (*get_string_length)(SPVM_API* api, void*);
  int8_t* (*get_string_bytes)(SPVM_API* api, void*);
  void* (*get_exception)(SPVM_API* api);
  void (*set_exception)(SPVM_API* api, void* exception);
  int32_t (*get_ref_count)(SPVM_API* api, void* base_object);
  void (*inc_ref_count)(SPVM_API* api, void* base_object);
  void (*dec_ref_count)(SPVM_API* api, void* base_object);
  void (*inc_dec_ref_count)(SPVM_API* api, void* base_object);
  int32_t (*get_objects_count)(SPVM_API* api);
  void* (*get_runtime)(SPVM_API* api);
  void (*dec_ref_count_only)(SPVM_API* api, void* base_object);
