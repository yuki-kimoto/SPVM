...
=head1 Usage
  ...
  SPVM_NATIVE_STRING_BUFFER* string_buffer = string_buffer_api->new_instance(allocator, capacity);
...
C<SPVM_NATIVE_STRING_BUFFER* (*new_instance)(L<SPVM_NATIVE_ALLOCATOR* allocator|SPVM::Document::NativeAPI::Allocator>, int32_t capacity);>

Creates a new L<string buffer|SPVM::Document::NativeAPI::StringBuffer> given its capacity I<capacity>, and returns it.

=head2 free_instance

C<void (*free_instance)(L<SPVM_NATIVE_STRING_BUFFER* string_buffer|SPVM::Document::NativeAPI::StringBuffer>);>

Frees the string buffer I<string_buffer>.

=head2 get_string

C<const char* (*get_string)(L<SPVM_NATIVE_STRING_BUFFER* string_buffer|SPVM::Document::NativeAPI::StringBuffer>);>

Returns the string stored in the string buffer I<string_buffer>.

=head2 get_length

C<int32_t (*get_length)(L<SPVM_NATIVE_STRING_BUFFER* string_buffer|SPVM::Document::NativeAPI::StringBuffer>);>
