...
C<SPVM_NATIVE_STRING_BUFFER* (*new_instance)(SPVM_NATIVE_ALLOCATOR* allocator, int32_t capacity);>

Creates a new L<string buffer|SPVM::Document::NativeAPI::StringBuffer> given its capacity I<capacity>, and returns it.

=head2 free_instance

C<void (*free_instance)(SPVM_NATIVE_STRING_BUFFER* string_buffer);>

Frees the string buffer I<string_buffer>.

=head2 get_string

C<const char* (*get_string)(SPVM_NATIVE_STRING_BUFFER* string_buffer);>

Returns the string stored in the string buffer I<string_buffer>.

=head2 get_length

C<int32_t (*get_length)(SPVM_NATIVE_STRING_BUFFER* string_buffer);>
