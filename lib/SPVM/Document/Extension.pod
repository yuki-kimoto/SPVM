...
This is similar with L<Extension::C>, but L<SPVM> implement this feature by default.
  ...
  int32_t SPVM__TestCase__Extension__sum(SPVM_ENV* api, SPVM_VALUE* args) {
...
First argument is C<api>. This is the pointer to C<SPVM_ENV>. Second argument is C<args>. This is array of C<SPVM_VALUE>.
