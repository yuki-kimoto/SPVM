...
Field names cannot be duplicated. If it is, a compilation error occurs.
...
The values of the case statements cannnot be duplicated. If it is, a compilation error occurs.
...
If the return type of the current L<method|/"Method Definition"> is the L<void type|/"void Type">, the C<OPERAND> cannnot exist. If it is, a compilation error occurs.
...
The right type of the is_type operator cannnot be the any object type. If it is, a compilation error occurs.

The right type of the is_type operator cannnot be the any object array type. If it is, a compilation error occurs.

The right type of the is_type operator cannnot be an interface type. If it is, a compilation error occurs.
