...
SPVM::Document::NativeModule - Document of Native Module
...
The name of the native module file is the SPVM module file extension replaced by the L<extension of the native class|/"Native Module File Extension">.
