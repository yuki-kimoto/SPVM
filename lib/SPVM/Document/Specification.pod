...
C<arg_name> is Argument Name. This is Variable name. Variable name is explained in L</"Variable Definition"> section,
...
=head2 Variable Definition

Variable Definition is the following.
...
If Variable Definition is done, you can use variable after the Definition.

C<type_name> is a <Type>. Type is explained at L</"Type"> section.

You can Initialize the variable as same time as Variable Definition.

  my $num : int = 3;

B<Variable Definition Example:>
...
If you know more Variable Definition, see L</"Variable Definition"> section.
...
You can create Object by C<new> keyword.
...
Array Initialization Syntax:
  ...
  my $nums : int[] = [1, 2, 3];
  my $points : Point[] = [new Point, new Point, new Point];
  
Note that array initialization syntax don't support type inference. You must write type Definition.
