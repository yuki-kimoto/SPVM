...
A native class can include native header files of a resource and add the object files generated by native source files of a resource to the object files for the linker using the L<use_resource|SPVM::Builder::Config/"use_resource"> method in the SPVM::Builder::Config class.
