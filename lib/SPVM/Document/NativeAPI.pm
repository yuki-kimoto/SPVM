...
<h2 id="native-api-native-sub-api-package_vars_heap">package_vars_heap</h2>
  <p>
    the pointer to the storage area of the package variables. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-object_header_byte_size">object_header_byte_size</h2>
  <p>
    The byte size of the object's header. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-object_weaken_backref_head_offset">object_weaken_backref_head_offset</h2>
  <p>
    Offset to a pointer to the back reference of the weak reference in the object structure. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-object_ref_count_offset">object_ref_count_offset</h2>
  <p>
    Reference count offset in the object structure. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-object_basic_type_id_offset">object_basic_type_id_offset</h2>
  <p>
    Offset of basic type ID in object structure. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-object_type_dimension_offset">object_type_dimension_offset</h2>
  <p>
    Offset of type dimension in object structure. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-object_runtime_type_category_offset">object_runtime_type_category_offset</h2>
  <p>
    Offset of runtime type category in object structure. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-object_flag_offset">object_flag_offset</h2>
  <p>
    Offset of flag in object structure. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-object_length_offset">object_length_offset</h2>
  <p>
    The length offset in the object structure. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-byte_object_basic_type_id">byte_object_basic_type_id</h2>
  <p>
    Basic type ID of SPVM::Byte type. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-short_object_basic_type_id">short_object_basic_type_id</h2>
  <p>
    ID of the base type of SPVM::Short type. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-int_object_basic_type_id">int_object_basic_type_id</h2>
  <p>
    ID of the base type of SPVM::Int type. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-long_object_basic_type_id">long_object_basic_type_id</h2>
  <p>
    ID of the base type of SPVM::Long type. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-float_object_basic_type_id">float_object_basic_type_id</h2>
  <p>
    ID of the base type of SPVM::Float type. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-double_object_basic_type_id">double_object_basic_type_id</h2>
  <p>
    ID of the base type of SPVM::Double type. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-compiler">compiler</h2>
  <p>
    A pointer to the SPVM compiler. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-exception_object">exception_object</h2>
  <p>
    Exception object. It is used internally.
  </p>
<p>
<h2 id="native-api-native-sub-api-native_mortal_stack">native_mortal_stack</h2>
  <p>
     Mortal stack used for native calls. It is used internally.
</p>
<h2 id="native-api-native-sub-api-native_mortal_stack_top">native_mortal_stack_top</h2>
  <p>
    The top position of the mortal stack used for native calls. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-native_mortal_stack_capacity">native_mortal_stack_capacity</h2>
  <p>
    The amount of mortal stack used for native calls. It is used internally.
  </p>
  
<h2 id="native-api-native-sub-api-get_basic_type_id">get_basic_type_id</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_field_id">get_field_id</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_field_offset">get_field_offset</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_package_var_id">get_package_var_id</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_sub_id">get_sub_id</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_method_sub_id">get_method_sub_id</h2>
<pre>
...
int32_t sub_id = env->get_method_sub_id(env, object, "method", "int(self,long,string)");
   ...
   <h2 id="native-api-native-sub-api-new_object_raw">new_object_raw</h2>
      <p>
...
void* (*new_object_raw)(SPVM_ENV* env, int32_t basic_type_id);
    ...
    <h2 id="native-api-native-sub-api-new_object">new_object</h2>
      <p>
...
void* object = env-&gt;new_object(env, basic_type_id);
    ...
    <h2 id="native-api-native-sub-api-new_byte_array_raw">new_byte_array_raw</h2>
      <p>
...
void* (*new_byte_array_raw)(SPVM_ENV* env, int32_t length);
    ...
    <h2 id="native-api-native-sub-api-new_byte_array">new_byte_array</h2>
      <p>
...
<h2 id="native-api-native-sub-api-new_short_array_raw">new_short_array_raw</h2>
      <p>
...
<h2 id="native-api-native-sub-api-new_short_array">new_short_array</h2>
      <p>
...
<h2 id="native-api-native-sub-api-new_int_array_raw">new_int_array_raw</h2>
      <p>
...
<h2 id="native-api-native-sub-api-new_int_array">new_int_array</h2>
      <p>
...
<h2 id="native-api-native-sub-api-new_long_array_raw">new_long_array_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_long_array">new_long_array</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_float_array_raw">new_float_array_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_float_array">new_float_array</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_double_array_raw">new_double_array_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_double_array">new_double_array</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_object_array_raw">new_object_array_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_object_array">new_object_array</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_muldim_array_raw">new_muldim_array_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_muldim_array">new_muldim_array</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_mulnum_array_raw">new_mulnum_array_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_mulnum_array">new_mulnum_array</h2>
  <p>
    Generate a new multi-numeric array by specifying the basic type ID and array length and return it. The basic type ID must be the correct basic type ID acquired by the "basic_type_id function" and must be valid as a composite numeric type. The initial value of all fields for all elements is 0.
  </p>
<pre>
...
<h2 id="native-api-native-sub-api-new_string_nolen_raw">new_string_nolen_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_string_nolen">new_string_nolen</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_string_raw">new_string_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_string">new_string</h2>
...
<h2 id="native-api-native-sub-api-new_pointer_raw">new_pointer_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_pointer">new_pointer</h2>
  <p>
...
<h2 id="native-api-native-sub-api-concat_raw">concat_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-concat">concat</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_stack_trace_raw">new_stack_trace_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_stack_trace">new_stack_trace</h2>
  <p>
...
<h2 id="native-api-native-sub-api-length">length</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_elems_byte">get_elems_byte</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_elems_short">get_elems_short</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_elems_int">get_elems_int</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_elems_long">get_elems_long</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_elems_float">get_elems_float</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_elems_double">get_elems_double</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_elem_object">get_elem_object</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_elem_object">set_elem_object</h2>
<p>
...
<h2 id="native-api-native-sub-api-get_field_byte">get_field_byte</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_field_short">get_field_short</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_field_int">get_field_int</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_field_long">get_field_long</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_field_float">get_field_float</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_field_double">get_field_double</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_field_object">get_field_object</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_field_byte">set_field_byte</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_field_short">set_field_short</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_field_int">set_field_int</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_field_long">set_field_long</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_field_float">set_field_float</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_field_double">set_field_double</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_field_object">set_field_object</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_package_var_byte">get_package_var_byte</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_package_var_short">get_package_var_short</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_package_var_int">get_package_var_int</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_package_var_long">get_package_var_long</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_package_var_float">get_package_var_float</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_package_var_double">get_package_var_double</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_package_var_object">get_package_var_object</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_package_var_byte">set_package_var_byte</h2>
  <p>
    If you specify the object and field ID and the value of the field, the value is set to the byte type field. The field ID must be a valid field ID obtained with the field_id function.
  </p>
<pre>
...
<h2 id="native-api-native-sub-api-set_package_var_short">set_package_var_short</h2>
  <p>
    If you specify the object and field ID and the value of the field, the value is set to the short type field. The field ID must be a valid field ID obtained with the field_id function.
  </p>
<pre>
...
<h2 id="native-api-native-sub-api-set_package_var_int">set_package_var_int</h2>
  <p>
    If you specify the object and field ID and the value of the field, the value is set to the int type field. The field ID must be a valid field ID obtained with the field_id function.
  </p>
<pre>
...
<h2 id="native-api-native-sub-api-set_package_var_long">set_package_var_long</h2>
  <p>
    If you specify the object and field ID and the value of the field, the value is set to the long type field. The field ID must be a valid field ID obtained with the field_id function.
  </p>
<pre>
...
<h2 id="native-api-native-sub-api-set_package_var_float">set_package_var_float</h2>
  <p>
    If you specify the object and field ID and the value of the field, the value is set to the float type field. The field ID must be a valid field ID obtained with the field_id function.
  </p>
<pre>
...
<h2 id="native-api-native-sub-api-set_package_var_double">set_package_var_double</h2>
  <p>
    If you specify the object and field ID and the value of the field, the value is set to the double type field. The field ID must be a valid field ID obtained with the field_id function.
  </p>
<pre>
...
<h2 id="native-api-native-sub-api-set_package_var_object">set_package_var_object</h2>
  <p>
    Object and field Specify the ID and the value of the field and set the value to the object type field. The field ID must be a valid field ID obtained with the field_id function. After setting, the reference count is incremented by 1. The original value has the reference count decremented by 1.
  </p>
<pre>
...
<h2 id="native-api-native-sub-api-get_pointer">get_pointer</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_pointer">set_pointer</h2>
  <p>
...
<h2 id="native-api-native-sub-api-call_sub">call_sub</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_exception">get_exception</h2>
  <p>
...
<h2 id="native-api-native-sub-api-set_exception">set_exception</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_ref_count">get_ref_count</h2>
</p>
<pre>
int32_t (*get_ref_count)(SPVM_ENV* env, void* object);
</pre>

<h2 id="native-api-native-sub-api-inc_ref_count">inc_ref_count</h2>
  <p>
...
<h2 id="native-api-native-sub-api-dec_ref_count">dec_ref_count</h2>
  <p>
...
<h2 id="native-api-native-sub-api-enter_scope">enter_scope</h2>
  <p>
...
<h2 id="native-api-native-sub-api-push_mortal">push_mortal</h2>
  <p>
...
<h2 id="native-api-native-sub-api-leave_scope">leave_scope</h2>
  <p>
...
<h2 id="native-api-native-sub-api-remove_mortal">remove_mortal</h2>
  <p>
...
<h2 id="native-api-native-sub-api-is_type">is_type</h2>
  <p>
...
<h2 id="native-api-native-sub-api-has_callback">has_callback</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_object_basic_type_id">get_object_basic_type_id</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_object_type_dimension">get_object_type_dimension</h2>
  <p>
...
<h2 id="native-api-native-sub-api-weaken">weaken</h2>
...
<h2 id="native-api-native-sub-api-isweak">isweak</h2> <p>
...
<h2 id="native-api-native-sub-api-unweaken">unweaken</h2>
  <p>
...
<h2 id="native-api-native-sub-api-alloc_memory_block_zero">alloc_memory_block_zero</h2>
...
<h2 id="native-api-native-sub-api-free_memory_block">free_memory_block</h2>
...
<h2 id="native-api-native-sub-api-get_memory_blocks_count">get_memory_blocks_count</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_type_name_raw">get_type_name_raw</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_type_name">get_type_name</h2>
  <p>
...
<h2 id="native-api-native-sub-api-new_env">new_env</h2>
  <p>
...
<h2 id="native-api-native-sub-api-free_env">free_env</h2>
  <p>
...
<h2 id="native-api-native-sub-api-memory_blocks_count">memory_blocks_count</h2>
  <p>
...
<h2 id="native-api-native-sub-api-get_chars">get_chars</h2>
...
<h2 id="native-api-native-sub-api-die">die</h2>

<pre>
int32_t (*die)(SPVM_ENV* env, const char* message, ...);
</pre>

<h2 id="native-api-native-sub-api-new_object_by_name">new_object_by_name</h2>

<pre>
void* (*new_object_by_name)(SPVM_ENV* env, const char* package_name, int32_t* exception_flag, const char* file, int32_t line);
</pre>

<h2 id="native-api-native-sub-api-new_pointer_by_name">new_pointer_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_field_byte_by_name">set_field_byte_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_field_short_by_name">set_field_short_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_field_int_by_name">set_field_int_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_field_long_by_name">set_field_long_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_field_float_by_name">set_field_float_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_field_double_by_name">set_field_double_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_field_object_by_name">set_field_object_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_field_byte_by_name">get_field_byte_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_field_short_by_name">get_field_short_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_field_int_by_name">get_field_int_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_field_long_by_name">get_field_long_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_field_float_by_name">get_field_float_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_field_double_by_name">get_field_double_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_field_object_by_name">get_field_object_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_package_var_byte_by_name">set_package_var_byte_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_package_var_short_by_name">set_package_var_short_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_package_var_int_by_name">set_package_var_int_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_package_var_long_by_name">set_package_var_long_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_package_var_float_by_name">set_package_var_float_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_package_var_double_by_name">set_package_var_double_by_name</h2>
...
<h2 id="native-api-native-sub-api-set_package_var_object_by_name">set_package_var_object_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_package_var_byte_by_name">get_package_var_byte_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_package_var_short_by_name">get_package_var_short_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_package_var_int_by_name">get_package_var_int_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_package_var_long_by_name">get_package_var_long_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_package_var_float_by_name">get_package_var_float_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_package_var_double_by_name">get_package_var_double_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_package_var_object_by_name">get_package_var_object_by_name</h2>
...
<h2 id="native-api-native-sub-api-call_sub_by_name">call_sub_by_name</h2>
...
<h2 id="native-api-native-sub-api-call_poly_sub_by_name">call_poly_sub_by_name</h2>
...
<h2 id="native-api-native-sub-api-get_field_string_chars_by_name">get_field_string_chars_by_name</h2>
...
<h2 id="native-api-native-sub-api-any_object_basic_type_id">any_object_basic_type_id</h2>
