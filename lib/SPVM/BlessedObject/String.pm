...
sub to_string {
  ...
  my $string = SPVM::ExchangeAPI::string_object_to_bin($self->api, $self->env, $self->stack, $self);
...
sub to_bin {
  ...
  my $bin = SPVM::ExchangeAPI::string_object_to_bin($self->api, $self->env, $self->stack, $self);
