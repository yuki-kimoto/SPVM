...
sub string_object_to_string { my $ret; eval { $ret =  &_xs_string_object_to_string(@_) }; if ($@) { confess $@ } $ret}
...
sub string_object_to_bin { my $ret; eval { $ret =  &_xs_string_object_to_bin(@_) }; if ($@) { confess $@ } $ret}
