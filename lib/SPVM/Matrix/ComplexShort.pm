...
SPVM::Matrix::ComplexShort - complex short Matrix

=head1 SYNOPSYS
  
  my $values = new SPVM::Complex_2s[10];
  my $row = 3;
  my $col = 2;
  my $matrix = SPVM::Matrix::ComplexShort->new($values, $row, $col);
...
SPVM::Matrix::ComplexShort is complex short Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::ComplexShort ($values : ${element_type}[], $row : int, $col : int)
