...
SPVM::Matrix::Double - real double Matrix
...
=head1 SYNOPSYS
  ...
  my $row = 2;
  my $col = 3;
  my $matrix = SPVM::Matrix::Double->new($values, $row, $col);
...
SPVM::Matrix::Double is real double Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::Double ($values : ${element_type}[], $row : int, $col : int)
