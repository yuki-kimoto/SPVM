...
SPVM::Matrix::QuatLong - quat long Matrix

=head1 SYNOPSYS
  
  my $values = new SPVM::Quat_4l[10];
  my $row = 3;
  my $col = 2;
  my $matrix = SPVM::Matrix::QuatLong->new($values, $row, $col);
...
SPVM::Matrix::QuatLong is quat long Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::QuatLong ($values : ${element_type}[], $row : int, $col : int)
