...
SPVM::Matrix::Float - real float Matrix
...
=head1 SYNOPSYS
  ...
  my $row = 2;
  my $col = 3;
  my $matrix = SPVM::Matrix::Float->new($values, $row, $col);
...
SPVM::Matrix::Float is real float Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::Float ($values : ${element_type}[], $row : int, $col : int)
