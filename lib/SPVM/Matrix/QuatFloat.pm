...
SPVM::Matrix::QuatFloat - quat float Matrix

=head1 SYNOPSYS
  
  my $values = new SPVM::Quat_4f[10];
  my $row = 3;
  my $col = 2;
  my $matrix = SPVM::Matrix::QuatFloat->new($values, $row, $col);
...
SPVM::Matrix::QuatFloat is quat float Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::QuatFloat ($values : ${element_type}[], $row : int, $col : int)
