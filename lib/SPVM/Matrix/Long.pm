...
SPVM::Matrix::Long - real long Matrix

=head1 SYNOPSYS
  
  my $values = new long[10];
  my $row = 3;
  my $col = 2;
  my $matrix = SPVM::Matrix::Long->new($values, $row, $col);
...
SPVM::Matrix::Long is real long Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::Long ($values : ${element_type}[], $row : int, $col : int)
