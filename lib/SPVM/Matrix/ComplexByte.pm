...
SPVM::Matrix::ComplexByte - complex byte Matrix

=head1 SYNOPSYS
  
  my $values = new SPVM::Complex_2b[10];
  my $row = 3;
  my $col = 2;
  my $matrix = SPVM::Matrix::ComplexByte->new($values, $row, $col);
...
SPVM::Matrix::ComplexByte is complex byte Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::ComplexByte ($values : ${element_type}[], $row : int, $col : int)
