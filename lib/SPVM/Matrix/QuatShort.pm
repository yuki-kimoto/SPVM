...
SPVM::Matrix::QuatShort - quat short Matrix

=head1 SYNOPSYS
  
  my $values = new SPVM::Quat_4s[10];
  my $row = 2;
  my $col = 3;
  my $matrix = SPVM::Matrix::QuatShort->new($values, $row, $col);
...
SPVM::Matrix::QuatShort is quat short Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::QuatShort ($values : ${element_type}[], $row : int, $col : int)
