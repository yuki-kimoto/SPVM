...
SPVM::Matrix::Byte - real byte Matrix

=head1 SYNOPSYS
  
  my $values = new byte[10];
  my $row = 2;
  my $col = 3;
  my $matrix = SPVM::Matrix::Byte->new($values, $row, $col);
...
SPVM::Matrix::Byte is real byte Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::Byte ($values : ${element_type}[], $row : int, $col : int)
