...
SPVM::Matrix::Int - real int Matrix
...
=head1 SYNOPSYS
  ...
  my $row = 2;
  my $col = 3;
  my $matrix = SPVM::Matrix::Int->new($values, $row, $col);
...
SPVM::Matrix::Int is real int Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::Int ($values : ${element_type}[], $row : int, $col : int)
