...
SPVM::Matrix::ComplexInt - complex int Matrix

=head1 SYNOPSYS
  
  my $values = new SPVM::Complex_2i[10];
  my $row = 3;
  my $col = 2;
  my $matrix = SPVM::Matrix::ComplexInt->new($values, $row, $col);
...
SPVM::Matrix::ComplexInt is complex int Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::ComplexInt ($values : ${element_type}[], $row : int, $col : int)
