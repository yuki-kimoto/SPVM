...
SPVM::Matrix::Short - real short Matrix

=head1 SYNOPSYS
  
  my $values = new short[10];
  my $row = 2;
  my $col = 3;
  my $matrix = SPVM::Matrix::Short->new($values, $row, $col);
...
SPVM::Matrix::Short is real short Matrix.

=head1 METHODS

=head2 new : SPVM::Matrix::Short ($values : ${element_type}[], $row : int, $col : int)
