...
If the C<$array1> is defined and the C<$array2> is defined and the all elements of array1 are equal to all elements of array2, return C<1>.
...
If the C<$array1> is defined and the C<$array2> is defined and the all elements of array1 are equal to all elements of array2 using the equality checker, return C<1>.
...
If the C<$array1> is defined and the C<$array2> is defined and the all elements of array1 are equal to all elements of array2 using the C<eq> operator, return C<1>.
