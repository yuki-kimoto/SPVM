...
C<method replace : void ($offset : int, $remove_length : int, $replace : int[] = undef);>
...
C<method splice : int[] ($offset : int, $remove_length : int, $replace : int[] = undef);>
...
C<method clone : L<IntList|SPVM::IntList> ();>
