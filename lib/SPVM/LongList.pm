...
C<static method new_ref : L<LongList|SPVM::LongList> ($array : long[]);>

Creates a new L<LongList|SPVM::LongList> object, and set L</"array"> field to the array $array, and return the new object.
...
C<method replace : void ($offset : int, $remove_length : int, $replace : long[] = undef);>
...
C<method splice : long[] ($offset : int, $remove_length : int, $replace : long[] = undef);>
...
C<method clone : L<LongList|SPVM::LongList> ();>

Clones this instance and returns it.

=head2 push_

C<method push_ : void ($elements : long[]);>
...
C<method unshift_ : void ($elements : long[]);>
