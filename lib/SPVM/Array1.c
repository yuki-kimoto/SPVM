...
int32_t SPVM__Array1__memmove_byte(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array1__memmove_short(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array1__memmove_int(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array1__memmove_long(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array1__memmove_float(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Array1__memmove_double(SPVM_ENV* env, SPVM_VALUE* stack) {
