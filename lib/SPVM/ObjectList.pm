...
=head1 SYNOPSYS
  ...
  my $object_list = SPVM::ObjectList->new_len;

  # Create a object list with array
  my $object_list = SPVM::ObjectList->new([(object)SPVM::Byte->new(1), SPVM::Int->new(2), SPVM::Long->new(3)]);
...
=head2 new
    ...
    sub new : SPVM::ObjectList ($array : object[])

Create a new L<SPVM::ObjectList> object with specific C<object> array.

=head2 new_len

    sub new_len : SPVM::ObjectList ($length : int)

Create a new L<SPVM::ObjectList> object with array length.
