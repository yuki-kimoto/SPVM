...
enum {
  SPVM_CSOURCE_BUILDER_PRECOMPILE_C_TYPE_BYTE,
  SPVM_CSOURCE_BUILDER_PRECOMPILE_C_TYPE_SHORT,
  SPVM_CSOURCE_BUILDER_PRECOMPILE_C_TYPE_INT,
  SPVM_CSOURCE_BUILDER_PRECOMPILE_C_TYPE_LONG,
  SPVM_CSOURCE_BUILDER_PRECOMPILE_C_TYPE_FLOAT,
  SPVM_CSOURCE_BUILDER_PRECOMPILE_C_TYPE_DOUBLE,
  SPVM_CSOURCE_BUILDER_PRECOMPILE_C_TYPE_ADDRESS,
};
