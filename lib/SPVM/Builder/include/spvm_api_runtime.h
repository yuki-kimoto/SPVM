...
int32_t SPVM_API_RUNTIME_has_interface_by_id_v2(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* basic_type, int32_t interface_basic_type_id);
...
int32_t SPVM_API_RUNTIME_is_super_by_id_v2(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* super_basic_type, SPVM_RUNTIME_BASIC_TYPE* child_basic_type);
