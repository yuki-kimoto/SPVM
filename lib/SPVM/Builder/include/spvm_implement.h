...
#define SPVM_IMPLEMENT_CALL_INSTANCE_METHOD(env, stack, error_id, method_name, args_width) (error_id = env->api->internal->call_instance_method_impl(env, stack, method_name, args_width))
