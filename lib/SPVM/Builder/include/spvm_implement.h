...
#define SPVM_IMPLEMENT_CALL_INSTANCE_METHOD_STATIC_V2(env, stack, error_id, method_id, args_stack_length) (error_id = env->call_method_raw_v2(env, stack, env->api->runtime->get_method(env->runtime, invocant_decl_basic_type_id, decl_method_index), args_stack_length))
