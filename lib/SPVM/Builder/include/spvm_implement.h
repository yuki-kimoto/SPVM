...
#define SPVM_IMPLEMENT_CALL_CLASS_METHOD_V2(env, stack, error_id, method, args_stack_length) (error_id = env->call_method_raw(env, stack, method, args_stack_length))

#define SPVM_IMPLEMENT_CALL_INSTANCE_METHOD_STATIC_V2(env, stack, error_id, method, args_stack_length) (error_id = env->call_method_raw(env, stack, method, args_stack_length))
