...
#define SPVM_IMPLEMENT_GET_CLASS_VAR_SHORT_V2(env, stack, out, basic_type_id, class_var_index) (out = *(int16_t*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index])
#define SPVM_IMPLEMENT_GET_CLASS_VAR_INT_V2(env, stack, out, basic_type_id, class_var_index) (out = *(int32_t*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index])
#define SPVM_IMPLEMENT_GET_CLASS_VAR_LONG_V2(env, stack, out, basic_type_id, class_var_index) (out = *(int64_t*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index])
#define SPVM_IMPLEMENT_GET_CLASS_VAR_FLOAT_V2(env, stack, out, basic_type_id, class_var_index) (out = *(float*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index])
#define SPVM_IMPLEMENT_GET_CLASS_VAR_DOUBLE_V2(env, stack, out, basic_type_id, class_var_index) (out = *(double*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index])
#define SPVM_IMPLEMENT_GET_CLASS_VAR_OBJECT_V2(env, stack, out, basic_type_id, class_var_index) (SPVM_IMPLEMENT_OBJECT_ASSIGN(env, stack, out, *(void**)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index]))
...
#define SPVM_IMPLEMENT_SET_CLASS_VAR_BYTE_V2(env, stack, basic_type_id, class_var_index, in) (*(int8_t*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index] = in)
#define SPVM_IMPLEMENT_SET_CLASS_VAR_SHORT_V2(env, stack, basic_type_id, class_var_index, in) (*(int16_t*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index] = in)
#define SPVM_IMPLEMENT_SET_CLASS_VAR_INT_V2(env, stack, basic_type_id, class_var_index, in) (*(int32_t*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index] = in)
#define SPVM_IMPLEMENT_SET_CLASS_VAR_LONG_V2(env, stack, basic_type_id, class_var_index, in) (*(int64_t*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index] = in)
#define SPVM_IMPLEMENT_SET_CLASS_VAR_FLOAT_V2(env, stack, basic_type_id, class_var_index, in) (*(float*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index] = in)
#define SPVM_IMPLEMENT_SET_CLASS_VAR_DOUBLE_V2(env, stack, basic_type_id, class_var_index, in) (*(double*)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index] = in)
#define SPVM_IMPLEMENT_SET_CLASS_VAR_OBJECT_V2(env, stack, basic_type_id, class_var_index, in) (SPVM_IMPLEMENT_OBJECT_ASSIGN(env, stack, (void**)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index], in))
#define SPVM_IMPLEMENT_SET_CLASS_VAR_UNDEF_V2(env, stack, basic_type_id, class_var_index) (SPVM_IMPLEMENT_OBJECT_ASSIGN(env, stack, (void**)&((SPVM_VALUE*)env->class_vars_heap)[env->api->runtime->get_basic_type_class_vars_base_address_id(env->runtime, basic_type_id) + class_var_index], NULL))
