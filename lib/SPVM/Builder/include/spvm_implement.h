...
static inline void* SPVM_IMPLEMENT_GET_BASIC_TYPE_BY_NAME(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, int32_t* error_id) {
  ...
  if (!basic_type) {
    snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, SPVM_IMPLEMENT_STRING_LITERALS[SPVM_IMPLEMENT_C_STRING_ERROR_BASIC_TYPE_NOT_FOUND], basic_type_name);
...
static inline void* SPVM_IMPLEMENT_GET_FIELD_STATIC_BY_NAME(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* field_name, int32_t* error_id) {
  ...
  if (!field) {
    snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, SPVM_IMPLEMENT_STRING_LITERALS[SPVM_IMPLEMENT_C_STRING_ERROR_FIELD_NOT_FOUND], basic_type_name, field_name);
    void* exception = env->new_string_nolen_no_mortal(env, stack, tmp_buffer);
    env->set_exception(env, stack, exception);
    *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
  }
...
static inline void* SPVM_IMPLEMENT_GET_CLASS_VAR_BY_NAME(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t* error_id) {
  ...
  if (!class_var) {
    snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, SPVM_IMPLEMENT_STRING_LITERALS[SPVM_IMPLEMENT_C_STRING_ERROR_CLASS_VAR_NOT_FOUND], basic_type_name, class_var_name);
    void* exception = env->new_string_nolen_no_mortal(env, stack, tmp_buffer);
    env->set_exception(env, stack, exception);
    *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
  }
...
static inline void* SPVM_IMPLEMENT_GET_METHOD_BY_NAME(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* method_name, int32_t* error_id) {
  ...
  if (!method) {
    snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, SPVM_IMPLEMENT_STRING_LITERALS[SPVM_IMPLEMENT_C_STRING_ERROR_METHOD_NOT_FOUND], basic_type_name, method_name);
    void* exception = env->new_string_nolen_no_mortal(env, stack, tmp_buffer);
    env->set_exception(env, stack, exception);
    *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
  }
  ...
  if (__builtin_expect(array == NULL, 0)) { 
    ...
    *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
    ...
    if (__builtin_expect(index < 0 || index >= *(int32_t*)((intptr_t)array + object_length_offset), 0)) { 
      env->set_exception(env, stack, env->new_string_nolen_no_mortal(env, stack, SPVM_IMPLEMENT_STRING_LITERALS[SPVM_IMPLEMENT_C_STRING_ELEMENT_ACCESS_INDEX_OUT_OF_RANGE]));
      *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
    }
    else { 
...
static inline void SPVM_IMPLEMENT_SET_ARRAY_ELEMENT_BYTE(SPVM_ENV* env, SPVM_VALUE* stack, void* array, int32_t index, int8_t in, int32_t* error_id, int32_t object_data_offset, int32_t object_length_offset) {
  if (__builtin_expect(!array, 0)) {
    ...
    *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
    ...
    if (__builtin_expect(index < 0 || index >= *(int32_t*)((intptr_t)array + object_length_offset), 0)) {
      void* exception = env->new_string_nolen_no_mortal(env, stack, SPVM_IMPLEMENT_STRING_LITERALS[SPVM_IMPLEMENT_C_STRING_ELEMENT_ACCESS_INDEX_OUT_OF_RANGE]);
      env->set_exception(env, stack, exception);
      *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
    }
    else {
...
static inline void SPVM_IMPLEMENT_GET_MULNUM_FIELD_BYTE(int8_t* out, int8_t* in, int32_t field_index) {
  *out = *(in + field_index);
}

static inline void SPVM_IMPLEMENT_GET_MULNUM_FIELD_SHORT(int16_t* out, int16_t* in, int32_t field_index) {
  *out = *(in + field_index);
}

static inline void SPVM_IMPLEMENT_GET_MULNUM_FIELD_INT(int32_t* out, int32_t* in, int32_t field_index) {
  *out = *(in + field_index);
}

static inline void SPVM_IMPLEMENT_GET_MULNUM_FIELD_LONG(int64_t* out, int64_t* in, int32_t field_index) {
  *out = *(in + field_index);
}

static inline void SPVM_IMPLEMENT_GET_MULNUM_FIELD_FLOAT(float* out, float* in, int32_t field_index) {
  *out = *(in + field_index);
}

static inline void SPVM_IMPLEMENT_GET_MULNUM_FIELD_DOUBLE(double* out, double* in, int32_t field_index) {
  *out = *(in + field_index);
}

static inline void SPVM_IMPLEMENT_SET_MULNUM_FIELD_BYTE(int8_t* out, int32_t field_index, int8_t in) {
  
  *(out + field_index) = in;
  
}

static inline void SPVM_IMPLEMENT_SET_MULNUM_FIELD_SHORT(int16_t* out, int32_t field_index, int16_t in) {
  
  *(out + field_index) = in;
  
}

static inline void SPVM_IMPLEMENT_SET_MULNUM_FIELD_INT(int32_t* out, int32_t field_index, int32_t in) {
  
  *(out + field_index) = in;
  
}

static inline void SPVM_IMPLEMENT_SET_MULNUM_FIELD_LONG(int64_t* out, int32_t field_index, int64_t in) {
  
  *(out + field_index) = in;
  
}

static inline void SPVM_IMPLEMENT_SET_MULNUM_FIELD_FLOAT(float* out, int32_t field_index, float in) {
  
  *(out + field_index) = in;
  
}

static inline void SPVM_IMPLEMENT_SET_MULNUM_FIELD_DOUBLE(double* out, int32_t field_index, double in) {
...
static inline void SPVM_IMPLEMENT_CALL_INSTANCE_METHOD(SPVM_ENV* env, SPVM_VALUE* stack, const char* interface_name, const char* method_name, int32_t args_width, int32_t* error_id) {
  ...
  *error_id = 0;
  ...
  void* method = NULL;
  if (!object) {
    snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, SPVM_IMPLEMENT_STRING_LITERALS[SPVM_IMPLEMENT_C_STRING_CALL_INSTANCE_METHOD_INVOCANT_UNDEF], interface_name, method_name);
    void* exception = env->new_string_nolen_no_mortal(env, stack, tmp_buffer);
    env->set_exception(env, stack, exception);
    *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
  }
    ...
    if (!method) {
      snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, SPVM_IMPLEMENT_STRING_LITERALS[SPVM_IMPLEMENT_C_STRING_CALL_INSTANCE_METHOD_IMPLEMENT_NOT_FOUND], interface_name, method_name);
      void* exception = env->new_string_nolen_no_mortal(env, stack, tmp_buffer);
      env->set_exception(env, stack, exception);
      *error_id = SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_CLASS;
    }
