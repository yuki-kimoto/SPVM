...
#define SPVM_IMPLEMENT_CALL_INSTANCE_METHOD(env, stack, error_id, method_name, args_width) (error_id = env->call_instance_method_no_mortal(env, stack, method_name, args_width))
