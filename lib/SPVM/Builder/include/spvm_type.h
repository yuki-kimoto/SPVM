...
enum {
  ...
  SPVM_TYPE_C_TYPE_CATEGORY_MULNUM,
  SPVM_TYPE_C_TYPE_CATEGORY_BASIC_OBJECT,
  SPVM_TYPE_C_TYPE_CATEGORY_NUMERIC_ARRAY,
  SPVM_TYPE_C_TYPE_CATEGORY_MULNUM_ARRAY,
  SPVM_TYPE_C_TYPE_CATEGORY_OBJECT_ARRAY,
  SPVM_TYPE_C_TYPE_CATEGORY_NUMERIC_REF,
  SPVM_TYPE_C_TYPE_CATEGORY_MULNUM_REF,
  SPVM_TYPE_C_TYPE_CATEGORY_STRING,
  SPVM_TYPE_C_TYPE_CATEGORY_CLASS,
  SPVM_TYPE_C_TYPE_CATEGORY_INTERFACE,
  SPVM_TYPE_C_TYPE_CATEGORY_CALLBACK,
  SPVM_TYPE_C_TYPE_CATEGORY_ANY_OBJECT,
  SPVM_TYPE_C_TYPE_CATEGORY_STRING_ARRAY,
  SPVM_TYPE_C_TYPE_CATEGORY_CLASS_ARRAY,
  SPVM_TYPE_C_TYPE_CATEGORY_INTERFACE_ARRAY,
  SPVM_TYPE_C_TYPE_CATEGORY_CALLBACK_ARRAY,
  SPVM_TYPE_C_TYPE_CATEGORY_ANY_OBJECT_ARRAY,
  SPVM_TYPE_C_TYPE_CATEGORY_MULDIM_ARRAY,
};
