...
enum {
  ...
  SPVM_TYPE_C_RUNTIME_TYPE_MULNUM_BYTE,
  SPVM_TYPE_C_RUNTIME_TYPE_MULNUM_SHORT,
  SPVM_TYPE_C_RUNTIME_TYPE_MULNUM_INT,
  SPVM_TYPE_C_RUNTIME_TYPE_MULNUM_LONG,
  SPVM_TYPE_C_RUNTIME_TYPE_MULNUM_FLOAT,
  SPVM_TYPE_C_RUNTIME_TYPE_MULNUM_DOUBLE,
  SPVM_TYPE_C_RUNTIME_TYPE_ANY_OBJECT,
  SPVM_TYPE_C_RUNTIME_TYPE_PACKAGE,
  SPVM_TYPE_C_RUNTIME_TYPE_NUMERIC_ARRAY,
  SPVM_TYPE_C_RUNTIME_TYPE_MULNUM_ARRAY,
  ...
  SPVM_TYPE_C_RUNTIME_TYPE_REF_MULNUM_BYTE,
  SPVM_TYPE_C_RUNTIME_TYPE_REF_MULNUM_SHORT,
  SPVM_TYPE_C_RUNTIME_TYPE_REF_MULNUM_INT,
  SPVM_TYPE_C_RUNTIME_TYPE_REF_MULNUM_LONG,
