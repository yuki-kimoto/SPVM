...
int8_t SPVM_RUNTIME_API_get_package_var_byte(SPVM_ENV* env, int32_t package_var_id);
int16_t SPVM_RUNTIME_API_get_package_var_short(SPVM_ENV* env, int32_t package_var_id);
int32_t SPVM_RUNTIME_API_get_package_var_int(SPVM_ENV* env, int32_t package_var_id);
int64_t SPVM_RUNTIME_API_get_package_var_long(SPVM_ENV* env, int32_t package_var_id);
float SPVM_RUNTIME_API_get_package_var_float(SPVM_ENV* env, int32_t package_var_id);
double SPVM_RUNTIME_API_get_package_var_double(SPVM_ENV* env, int32_t package_var_id);
SPVM_OBJECT* SPVM_RUNTIME_API_get_package_var_object(SPVM_ENV* env, int32_t package_var_id);
void SPVM_RUNTIME_API_set_package_var_byte(SPVM_ENV* env, int32_t package_var_id, int8_t value);
void SPVM_RUNTIME_API_set_package_var_short(SPVM_ENV* env, int32_t package_var_id, int16_t value);
void SPVM_RUNTIME_API_set_package_var_int(SPVM_ENV* env, int32_t package_var_id, int32_t value);
void SPVM_RUNTIME_API_set_package_var_long(SPVM_ENV* env, int32_t package_var_id, int64_t value);
void SPVM_RUNTIME_API_set_package_var_float(SPVM_ENV* env, int32_t package_var_id, float value);
void SPVM_RUNTIME_API_set_package_var_double(SPVM_ENV* env, int32_t package_var_id, double value);
void SPVM_RUNTIME_API_set_package_var_object(SPVM_ENV* env, int32_t package_var_id, SPVM_OBJECT* value);
