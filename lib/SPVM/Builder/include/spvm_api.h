...
enum {
  ...
  SPVM_API_C_STACK_INDEX_DESTROY_EXECUTION_STACK_STACK = 358,
  SPVM_API_C_STACK_INDEX_DESTROY_EXECUTION_STACK_STACK_LENGTH = 357,
  SPVM_API_C_STACK_INDEX_DESTROY_EXECUTION_STACK_STACK_CAPACITY = 356,
};
