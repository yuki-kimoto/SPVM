...
enum {
  ...
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS = 370,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS_LENGTH = 369,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCK_OFFSET = 368,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS_CAPACITY = 367,
};
...
int32_t SPVM_API_push_stack_frame(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_RUNTIME_CALL_STACK_FRAME_INFO* call_stack_frame_info);
void SPVM_API_pop_stack_frame(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_RUNTIME_CALL_STACK_FRAME_INFO* call_stack_frame_info);
int32_t SPVM_API_set_call_stack_frame_info(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_RUNTIME_CALL_STACK_FRAME_INFO* call_stack_frame_info, void* call_stack_frame);
