...
enum {
  ...
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCK_SIZE = 367,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCK_OFFSET = 366,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS = 365,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS_LENGTH = 364,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS_CAPACITY = 363,
};
