...
enum {
  ...
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS = 367,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS_LENGTH = 366,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCK_OFFSET = 365,
  SPVM_API_C_STACK_INDEX_CALL_STACK_MEMORY_BLOCKS_CAPACITY = 364,
};
