...
enum {
  SPVM_API_C_BASIC_TYPE_C_ID_UNKNOWN,
  SPVM_API_C_BASIC_TYPE_C_ID_UNDEF,
  SPVM_API_C_BASIC_TYPE_C_ID_VOID,
  SPVM_API_C_BASIC_TYPE_C_ID_BYTE,
  SPVM_API_C_BASIC_TYPE_C_ID_SHORT,
  SPVM_API_C_BASIC_TYPE_C_ID_INT,
  SPVM_API_C_BASIC_TYPE_C_ID_LONG,
  SPVM_API_C_BASIC_TYPE_C_ID_FLOAT,
  SPVM_API_C_BASIC_TYPE_C_ID_DOUBLE,
  SPVM_API_C_BASIC_TYPE_C_ID_STRING,
  SPVM_API_C_BASIC_TYPE_C_ID_ANY_OBJECT,
  SPVM_API_C_BASIC_TYPE_C_ID_ELEMENT,
  SPVM_API_C_BASIC_TYPE_C_ID_BYTE_OBJECT,
  SPVM_API_C_BASIC_TYPE_C_ID_SHORT_OBJECT,
  SPVM_API_C_BASIC_TYPE_C_ID_INT_OBJECT,
  SPVM_API_C_BASIC_TYPE_C_ID_LONG_OBJECT,
  SPVM_API_C_BASIC_TYPE_C_ID_FLOAT_OBJECT,
  SPVM_API_C_BASIC_TYPE_C_ID_DOUBLE_OBJECT,
  SPVM_API_C_BASIC_TYPE_C_ID_BOOL_OBJECT,
};
