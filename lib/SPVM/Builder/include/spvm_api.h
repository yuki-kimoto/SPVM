...
enum {
  ...
  SPVM_API_C_STACK_INDEX_LOCAL_VARS_STACK = 373,
  SPVM_API_C_STACK_INDEX_LOCAL_VARS_STACK_LENGTH = 372,
  SPVM_API_C_STACK_INDEX_LOCAL_VARS_STACK_CAPACITY = 371,
  SPVM_API_C_STACK_INDEX_LOCAL_VARS_BASES = 370,
  SPVM_API_C_STACK_INDEX_LOCAL_VARS_BASES_LENGTH = 369,
  SPVM_API_C_STACK_INDEX_LOCAL_VARS_BASES_CAPACITY = 368,
};
