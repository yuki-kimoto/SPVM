...
enum {
  SPVM_RUNTIME_C_RUNTIME_TYPE_BYTE,
  SPVM_RUNTIME_C_RUNTIME_TYPE_SHORT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_INT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_LONG,
  SPVM_RUNTIME_C_RUNTIME_TYPE_FLOAT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_DOUBLE,
  SPVM_RUNTIME_C_RUNTIME_TYPE_VALUE_BYTE,
  SPVM_RUNTIME_C_RUNTIME_TYPE_VALUE_SHORT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_VALUE_INT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_VALUE_LONG,
  SPVM_RUNTIME_C_RUNTIME_TYPE_VALUE_FLOAT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_VALUE_DOUBLE,
  SPVM_RUNTIME_C_RUNTIME_TYPE_OBJECT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_REF_BYTE,
  SPVM_RUNTIME_C_RUNTIME_TYPE_REF_SHORT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_REF_INT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_REF_LONG,
  SPVM_RUNTIME_C_RUNTIME_TYPE_REF_FLOAT,
  SPVM_RUNTIME_C_RUNTIME_TYPE_REF_DOUBLE,
};
