...
int32_t SPVM_BASIC_TYPE_isa_interface(SPVM_COMPILER* compiler, int32_t basic_type_id, int32_t interface_basic_type_id, char* error_reason);

int32_t SPVM_BASIC_TYPE_isa_interface_common(SPVM_COMPILER* compiler, int32_t basic_type_id, int32_t interface_basic_type_id, char* error_reason);
