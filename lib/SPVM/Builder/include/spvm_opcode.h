...
enum {
  ...
  SPVM_OPCODE_C_ID_BOOL_CONVERSION_INT,
  SPVM_OPCODE_C_ID_BOOL_CONVERSION_LONG,
  SPVM_OPCODE_C_ID_BOOL_CONVERSION_FLOAT,
  SPVM_OPCODE_C_ID_BOOL_CONVERSION_DOUBLE,
  SPVM_OPCODE_C_ID_BOOL_CONVERSION_OBJECT,
  SPVM_OPCODE_C_ID_BOOL_CONVERSION_REF,
  SPVM_OPCODE_C_ID_BOOL_CONVERSION_BOOL_OBJECT,
  ...
  SPVM_OPCODE_C_ID_CLEAR_EVAL_ERROR, // The operator doesn't exist
  SPVM_OPCODE_C_ID_GET_EVAL_ERROR,
  SPVM_OPCODE_C_ID_GET_CLASS_ID,
  SPVM_OPCODE_C_ID_SET_ERROR, // The operator doesn't exist
  ...
  SPVM_OPCODE_C_ID_CALL_INSTANCE_METHOD_INTERFACE,
  ...
  SPVM_OPCODE_C_ID_GET_ARG_OPTIONAL_BYTE,
  SPVM_OPCODE_C_ID_GET_ARG_OPTIONAL_SHORT,
  SPVM_OPCODE_C_ID_GET_ARG_OPTIONAL_INT,
  SPVM_OPCODE_C_ID_GET_ARG_OPTIONAL_LONG,
  SPVM_OPCODE_C_ID_GET_ARG_OPTIONAL_FLOAT,
  SPVM_OPCODE_C_ID_GET_ARG_OPTIONAL_DOUBLE,
  SPVM_OPCODE_C_ID_GET_ARG_OPTIONAL_OBJECT,
