...
enum {
  ...
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_BYTE,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_SHORT,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_INT,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_LONG,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_FLOAT,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_DOUBLE,
