...
enum {
  ...
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_TO_SHORT,
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_TO_INT,
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_TO_LONG,
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_TO_FLOAT,
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_TO_DOUBLE,
  SPVM_OPCODE_C_ID_TYPE_CAST_SHORT_TO_BYTE,
  SPVM_OPCODE_C_ID_TYPE_CAST_SHORT_TO_INT,
  SPVM_OPCODE_C_ID_TYPE_CAST_SHORT_TO_LONG,
  SPVM_OPCODE_C_ID_TYPE_CAST_SHORT_TO_FLOAT,
  SPVM_OPCODE_C_ID_TYPE_CAST_SHORT_TO_DOUBLE,
  SPVM_OPCODE_C_ID_TYPE_CAST_INT_TO_BYTE,
  SPVM_OPCODE_C_ID_TYPE_CAST_INT_TO_SHORT,
  SPVM_OPCODE_C_ID_TYPE_CAST_INT_TO_LONG,
  SPVM_OPCODE_C_ID_TYPE_CAST_INT_TO_FLOAT,
  SPVM_OPCODE_C_ID_TYPE_CAST_INT_TO_DOUBLE,
  SPVM_OPCODE_C_ID_TYPE_CAST_LONG_TO_BYTE,
  SPVM_OPCODE_C_ID_TYPE_CAST_LONG_TO_SHORT,
  SPVM_OPCODE_C_ID_TYPE_CAST_LONG_TO_INT,
  SPVM_OPCODE_C_ID_TYPE_CAST_LONG_TO_FLOAT,
  SPVM_OPCODE_C_ID_TYPE_CAST_LONG_TO_DOUBLE,
  SPVM_OPCODE_C_ID_TYPE_CAST_FLOAT_TO_BYTE,
  SPVM_OPCODE_C_ID_TYPE_CAST_FLOAT_TO_SHORT,
  SPVM_OPCODE_C_ID_TYPE_CAST_FLOAT_TO_INT,
  SPVM_OPCODE_C_ID_TYPE_CAST_FLOAT_TO_LONG,
  SPVM_OPCODE_C_ID_TYPE_CAST_FLOAT_TO_DOUBLE,
  SPVM_OPCODE_C_ID_TYPE_CAST_DOUBLE_TO_BYTE,
  SPVM_OPCODE_C_ID_TYPE_CAST_DOUBLE_TO_SHORT,
  SPVM_OPCODE_C_ID_TYPE_CAST_DOUBLE_TO_INT,
  SPVM_OPCODE_C_ID_TYPE_CAST_DOUBLE_TO_LONG,
  SPVM_OPCODE_C_ID_TYPE_CAST_DOUBLE_TO_FLOAT,
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_TO_STRING,
  SPVM_OPCODE_C_ID_TYPE_CAST_SHORT_TO_STRING,
  SPVM_OPCODE_C_ID_TYPE_CAST_INT_TO_STRING,
  SPVM_OPCODE_C_ID_TYPE_CAST_LONG_TO_STRING,
  SPVM_OPCODE_C_ID_TYPE_CAST_FLOAT_TO_STRING,
  SPVM_OPCODE_C_ID_TYPE_CAST_DOUBLE_TO_STRING,
  SPVM_OPCODE_C_ID_TYPE_CAST_STRING_TO_BYTE_ARRAY,
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_ARRAY_TO_STRING,
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_TO_BYTE_OBJECT,
  SPVM_OPCODE_C_ID_TYPE_CAST_SHORT_TO_SHORT_OBJECT,
  SPVM_OPCODE_C_ID_TYPE_CAST_INT_TO_INT_OBJECT,
  SPVM_OPCODE_C_ID_TYPE_CAST_LONG_TO_LONG_OBJECT,
  SPVM_OPCODE_C_ID_TYPE_CAST_FLOAT_TO_FLOAT_OBJECT,
  SPVM_OPCODE_C_ID_TYPE_CAST_DOUBLE_TO_DOUBLE_OBJECT,
  SPVM_OPCODE_C_ID_TYPE_CAST_BYTE_OBJECT_TO_BYTE,
  SPVM_OPCODE_C_ID_TYPE_CAST_SHORT_OBJECT_TO_SHORT,
  SPVM_OPCODE_C_ID_TYPE_CAST_INT_OBJECT_TO_INT,
  SPVM_OPCODE_C_ID_TYPE_CAST_LONG_OBJECT_TO_LONG,
  SPVM_OPCODE_C_ID_TYPE_CAST_FLOAT_OBJECT_TO_FLOAT,
  SPVM_OPCODE_C_ID_TYPE_CAST_DOUBLE_OBJECT_TO_DOUBLE,
  ...
  SPVM_OPCODE_C_ID_HAS_IMPLEMENT,
  SPVM_OPCODE_C_ID_MOVE_OBJECT_CHECK_ASSIGN,
  SPVM_OPCODE_C_ID_TYPE_CAST_CALLBACK,
  SPVM_OPCODE_C_ID_TYPE_CAST_INTERFACE,
