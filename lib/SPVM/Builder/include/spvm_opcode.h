...
enum {
  ...
  SPVM_OPCODE_C_ID_GOTO_END_OF_EVAL_ON_EXCEPTION,
  SPVM_OPCODE_C_ID_GOTO_END_OF_METHOD_ON_EXCEPTION,
  ...
  SPVM_OPCODE_C_ID_GET_DIE_ERROR_CODE,
  SPVM_OPCODE_C_ID_SET_DIE_ERROR_CODE,
  SPVM_OPCODE_C_ID_CLEAR_EVAL_ERROR_CODE, // The operator doesn't exist
  SPVM_OPCODE_C_ID_GET_EVAL_ERROR_CODE,
