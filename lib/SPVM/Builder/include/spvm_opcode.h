...
enum {
  ...
  SPVM_OPCODE_C_ID_DEREF_GET_MULNUM_FIELD_BYTE,
  SPVM_OPCODE_C_ID_DEREF_GET_MULNUM_FIELD_SHORT,
  SPVM_OPCODE_C_ID_DEREF_GET_MULNUM_FIELD_INT,
  SPVM_OPCODE_C_ID_DEREF_GET_MULNUM_FIELD_LONG,
  SPVM_OPCODE_C_ID_DEREF_GET_MULNUM_FIELD_FLOAT,
  SPVM_OPCODE_C_ID_DEREF_GET_MULNUM_FIELD_DOUBLE,
  SPVM_OPCODE_C_ID_DEREF_SET_MULNUM_FIELD_BYTE,
  SPVM_OPCODE_C_ID_DEREF_SET_MULNUM_FIELD_SHORT,
  SPVM_OPCODE_C_ID_DEREF_SET_MULNUM_FIELD_INT,
  SPVM_OPCODE_C_ID_DEREF_SET_MULNUM_FIELD_LONG,
  SPVM_OPCODE_C_ID_DEREF_SET_MULNUM_FIELD_FLOAT,
  SPVM_OPCODE_C_ID_DEREF_SET_MULNUM_FIELD_DOUBLE,
