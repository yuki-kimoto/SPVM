...
enum {
  ...
  SPVM_OPCODE_C_ID_DEREF_MULNUM_GET_FIELD_BYTE,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_GET_FIELD_SHORT,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_GET_FIELD_INT,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_GET_FIELD_LONG,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_GET_FIELD_FLOAT,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_GET_FIELD_DOUBLE,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_SET_FIELD_BYTE,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_SET_FIELD_SHORT,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_SET_FIELD_INT,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_SET_FIELD_LONG,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_SET_FIELD_FLOAT,
  SPVM_OPCODE_C_ID_DEREF_MULNUM_SET_FIELD_DOUBLE,
  ...
  SPVM_OPCODE_C_ID_NEW_CONSTANT_STRING,
