...
enum {
  ...
  SPVM_OPCODE_C_ID_IS_FIXED_LENGTH,
  SPVM_OPCODE_C_ID_MAKE_READ_ONLY,
  SPVM_OPCODE_C_ID_MAKE_FIXED_LENGTH,
  ...
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_ANY_OBJECT_TO_BYTE,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_ANY_OBJECT_TO_SHORT,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_ANY_OBJECT_TO_INT,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_ANY_OBJECT_TO_LONG,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_ANY_OBJECT_TO_FLOAT,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_ANY_OBJECT_TO_DOUBLE,
  SPVM_OPCODE_C_ID_TYPE_CONVERSION_ANY_OBJECT_TO_STRING,
  ...
  SPVM_OPCODE_C_ID_EXISTS,
  SPVM_OPCODE_C_ID_DELETE,
  SPVM_OPCODE_C_ID_CAPACITY,
  SPVM_OPCODE_C_ID_SET_LENGTH,
  SPVM_OPCODE_C_ID_SET_CAPACITY,
  SPVM_OPCODE_C_ID_CALLER,
  SPVM_OPCODE_C_ID_BREAK_POINT,
};
