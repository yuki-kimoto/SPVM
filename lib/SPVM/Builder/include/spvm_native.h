...
struct spvm_env {
  ...
  SPVM_ENV_API* api;
  const char* (*get_name)(SPVM_ENV* env, int32_t string_id);
  int32_t (*get_basic_type_name_id)(SPVM_ENV* env, int32_t basic_type_id);
  int32_t (*get_basic_type_class_id)(SPVM_ENV* env, int32_t basic_type_id);
  int32_t (*get_basic_type_category)(SPVM_ENV* env, int32_t basic_type_id);
  int32_t (*get_type_basic_type_id)(SPVM_ENV* env, int32_t type_id);
  int32_t (*get_type_dimension)(SPVM_ENV* env, int32_t type_id);
  int32_t (*get_type_width)(SPVM_ENV* env, int32_t type_id);
  int32_t (*get_type_is_object)(SPVM_ENV* env, int32_t type_id);
  int32_t (*get_type_is_ref)(SPVM_ENV* env, int32_t type_id);
  int32_t (*get_class_id)(SPVM_ENV* env, const char* class_name);
  int32_t (*get_class_name_id)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_field_ids_base)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_field_ids_length)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_method_ids_base)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_method_ids_length)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_class_var_ids_base)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_var_name_id)(SPVM_ENV* env, int32_t class_var_id);
  int32_t (*get_class_var_signature_id)(SPVM_ENV* env, int32_t class_var_id);
  int32_t (*get_class_var_class_id)(SPVM_ENV* env, int32_t class_var_id);
  int32_t (*get_class_is_anon)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_module_file_id)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_anon_method_ids_base)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_class_anon_method_ids_length)(SPVM_ENV* env, int32_t class_id);
  int32_t (*get_field_name_id)(SPVM_ENV* env, int32_t field_id);
  int32_t (*get_field_type_id)(SPVM_ENV* env, int32_t field_id);
  int32_t (*get_field_signature_id)(SPVM_ENV* env, int32_t field_id);
  int32_t (*get_field_class_id)(SPVM_ENV* env, int32_t field_id);
  int32_t (*get_method_arg_ids_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_is_class_method)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_arg_ids_base)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_return_type_id)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_name_id)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_signature_id)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_class_id)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_is_anon)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_has_precompile_flag)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_call_stack_byte_vars_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_call_stack_short_vars_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_call_stack_int_vars_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_call_stack_long_vars_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_call_stack_float_vars_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_call_stack_double_vars_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_call_stack_object_vars_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_call_stack_ref_vars_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_mortal_stack_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_opcode_ids_base)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_method_opcode_ids_length)(SPVM_ENV* env, int32_t method_id);
  int32_t (*get_arg_type_id)(SPVM_ENV* env, int32_t arg_id);
  int32_t (*get_anon_method_method_id)(SPVM_ENV* env, int32_t anon_method_id);
  int32_t* (*get_runtime_opcodes)(SPVM_ENV* env);
  int32_t (*get_runtime_opcode_ids_length)(SPVM_ENV* env);
