...
#ifndef SPVM_NATIVE_NO_VERSION_UTILITIES
  #define SPVM_NATIVE_VERSION_NUMBER 0.990192
...
struct spvm_api_cfunc;
typedef struct spvm_api_cfunc SPVM_API_CFUNC;
...
struct spvm_env {
  ...
  int32_t (*weaken)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ** object_address);
  int32_t (*isweak)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ** object);
  void (*unweaken)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ** object_address);
  ...
  SPVM_OBJ* (*get_field_object_defined_and_has_pointer_by_name)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file_name, int32_t line);
  ...
  void (*assign_object)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ** dist_ref, SPVM_OBJ* object);
  ...
  int32_t (*get_byte_object_value)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ* byte_object);
  int32_t (*get_short_object_value)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ* short_object);
  ...
  SPVM_OBJ* (*longmess_no_mortal)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ* obj_message, const char* func_name, const char* file, int32_t line, int32_t start_call_depth, int32_t end_call_depth);
  SPVM_OBJ* (*longmess)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ* obj_message, const char* func_name, const char* file, int32_t line, int32_t start_call_depth, int32_t end_call_depth);
...
enum {
  ...
  SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_FIELD_NOT_SPECIFIED_CLASS,
};
