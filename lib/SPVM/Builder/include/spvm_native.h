...
struct SPVM_env {
  ...
  int8_t (*bfield)(SPVM_ENV* env, void* array, int32_t index);
  int16_t (*sfield)(SPVM_ENV* env, void* array, int32_t index);
  int32_t (*ifield)(SPVM_ENV* env, void* array, int32_t index);
  int64_t (*lfield)(SPVM_ENV* env, void* array, int32_t index);
  float (*ffield)(SPVM_ENV* env, void* array, int32_t index);
  double (*dfield)(SPVM_ENV* env, void* array, int32_t index);
  void* (*ofield)(SPVM_ENV* env, void* array, int32_t index);
  void (*set_bfield)(SPVM_ENV* env, void* array, int32_t index, int8_t value);
  void (*set_sfield)(SPVM_ENV* env, void* array, int32_t index, int16_t value);
  void (*set_ifield)(SPVM_ENV* env, void* array, int32_t index, int32_t value);
  void (*set_lfield)(SPVM_ENV* env, void* array, int32_t index, int64_t value);
  void (*set_ffield)(SPVM_ENV* env, void* array, int32_t index, float value);
  void (*set_dfield)(SPVM_ENV* env, void* array, int32_t index, double value);
  void (*set_ofield)(SPVM_ENV* env, void* array, int32_t index, void* value);
