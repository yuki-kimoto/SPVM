...
#define SPVM_NATIVE_VERSION_NUMBER 0.989021
...
struct spvm_api_runtime {
  ...
  void (*build_precompile_module_source_v2)(void* runtime, void* string_buffer, void* module_basic_type);
  void (*build_precompile_method_source_v2)(void* runtime, void* string_buffer, void* method);
};
