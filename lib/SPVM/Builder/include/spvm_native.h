...
struct spvm_env_runtime {
  ...
  int32_t (*get_class_field_ids_base)(void* runtime, int32_t class_id);
  int32_t (*get_class_field_ids_length)(void* runtime, int32_t class_id);
  int32_t (*get_class_method_ids_base)(void* runtime, int32_t class_id);
  int32_t (*get_class_method_ids_length)(void* runtime, int32_t class_id);
  int32_t (*get_class_class_var_ids_base)(void* runtime, int32_t class_id);
  int32_t (*get_class_class_var_ids_length)(void* runtime, int32_t class_id);
  int32_t (*get_class_anon_method_ids_base)(void* runtime, int32_t class_id);
  int32_t (*get_class_anon_method_ids_length)(void* runtime, int32_t class_id);
