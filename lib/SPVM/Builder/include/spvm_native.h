...
struct spvm_api_internal {
  ...
  char* (*get_stack_tmp_buffer)(SPVM_ENV* env, SPVM_VALUE* stack);
  void (*leave_scope_local_v2)(SPVM_ENV* env, SPVM_VALUE* stack, void** object_vars, int32_t* mortal_stack, int32_t* mortal_stack_top_ptr, int32_t original_mortal_stack_top);
};
