...
struct spvm_env {
  ...
  SPVM_OBJ* (*longmess_no_mortal)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ* obj_message, const char* func_name, const char* file, int32_t line, int32_t start_call_depth);
  SPVM_OBJ* (*longmess)(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJ* obj_message, const char* func_name, const char* file, int32_t line, int32_t start_call_depth);
