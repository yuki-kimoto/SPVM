...
enum {
  ...
  SPVM_OP_C_ID_COMPARISON_NUMERIC_EQ,
  SPVM_OP_C_ID_COMPARISON_NUMERIC_NE,
  SPVM_OP_C_ID_COMPARISON_NUMERIC_LT,
  SPVM_OP_C_ID_COMPARISON_NUMERIC_LE,
  SPVM_OP_C_ID_COMPARISON_NUMERIC_GT,
  SPVM_OP_C_ID_COMPARISON_NUMERIC_GE,
  SPVM_OP_C_ID_COMPARISON_NUMERIC_CMP,
