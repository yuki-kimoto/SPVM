...
enum {
  ...
  SPVM_OP_C_ID_ISA_CATEGORY,
  SPVM_OP_C_ID_GET_ELEM_WIDTH,
  SPVM_OP_C_ID_DIV_UINT,
  SPVM_OP_C_ID_DIV_ULONG,
  SPVM_OP_C_ID_REM_UINT,
  SPVM_OP_C_ID_REM_ULONG,
};
...
enum {
  // ISA_CATEGORY flag
  SPVM_OP_C_FLAG_ISA_CATEGORY_NUMERIC_ARRAY = 1,
  SPVM_OP_C_FLAG_ISA_CATEGORY_MULNUM_ARRAY = 2,
  SPVM_OP_C_FLAG_ISA_CATEGORY_OBJECT_ARRAY = 4,
  SPVM_OP_C_FLAG_ISA_CATEGORY_ARRAY = 8,
};
