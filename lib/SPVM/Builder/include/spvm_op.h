...
enum {
  ...
  SPVM_OP_C_ID_ARRAY_ELEMENT_ACCESS,
  SPVM_OP_C_ID_ASSIGN,
...
enum {
  ...
  SPVM_OP_C_FLAG_SPECIAL_ASSIGN_DEFINED_OR,
};
...
enum {
  // ARRAY_ELEMENT_ACCESS flag
  SPVM_OP_C_FLAG_ARRAY_ELEMENT_ACCESS_WEAKEN = 1,
  SPVM_OP_C_FLAG_ARRAY_ELEMENT_ACCESS_STRING = 2,
  SPVM_OP_C_FLAG_ARRAY_ELEMENT_ACCESS_UNWEAKEN = 4,
  SPVM_OP_C_FLAG_ARRAY_ELEMENT_ACCESS_ISWEAK = 8,
  SPVM_OP_C_FLAG_ARRAY_ELEMENT_ACCESS_GETTER = 16,
  SPVM_OP_C_FLAG_ARRAY_ELEMENT_ACCESS_SETTER = 32,
};
...
SPVM_OP* SPVM_OP_build_array_type(SPVM_COMPILER* compiler, SPVM_OP* op_type, SPVM_OP* op_operand, int32_t is_varargs);
...
SPVM_OP* SPVM_OP_build_field(SPVM_COMPILER* compiler, SPVM_OP* op_field, SPVM_OP* op_field_base_name, SPVM_OP* op_descripters, SPVM_OP* type, SPVM_OP* op_getter, SPVM_OP* op_setter);

SPVM_OP* SPVM_OP_build_class_var(SPVM_COMPILER* compiler, SPVM_OP* class_var, SPVM_OP* op_class_var_name, SPVM_OP* op_attributes, SPVM_OP* op_type, SPVM_OP* op_getter, SPVM_OP* op_setter);
...
SPVM_OP* SPVM_OP_build_accessor(SPVM_COMPILER* compiler, SPVM_OP* op_accessor, SPVM_OP* op_block, SPVM_OP* op_arg, SPVM_OP* op_return_type);
