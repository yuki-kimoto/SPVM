...
const char* SPVM_API_STRING_BUFFER_get_string(SPVM_NATIVE_STRING_BUFFER* env_string_buffer);

int32_t SPVM_API_STRING_BUFFER_get_length(SPVM_NATIVE_STRING_BUFFER* env_string_buffer);

void SPVM_API_STRING_BUFFER_free_instance(SPVM_NATIVE_STRING_BUFFER* env_string_buffer);
