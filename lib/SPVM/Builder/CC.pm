...
sub create_dl_func_list {
  ...
  my $dl_func_list = [];
  my $method_names = $builder->get_method_names($builder->runtime, $class_name, $category);
  ...
  if ($category eq 'precompile') {
    ...
    my $anon_class_names = $builder->get_anon_class_names_by_parent_class_name($builder->runtime, $class_name);
