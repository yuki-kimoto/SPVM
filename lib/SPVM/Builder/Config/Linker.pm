...
Gets and sets the C<"output_type"> field, which is the type of the output file generated by the linker C<"ld">.
...
=head2 ld_debug_output_option_name

  my $ld_debug_output_option_name = $config->ld_debug_output_option_name;
  $config->ld_debug_output_option_name($ld_debug_output_option_name);

Gets and sets C<ld_debug_output_option_name> field, a string that is an option name to specify a linker debug output file name such as C</PDB> in MSVC.
...
=head2 debug_output_file

  my $debug_output_file = $config->debug_output_file;
  $config->debug_output_file($debug_output_file);

Gets and sets C<debug_output_file> field. A path of a debug information file (e.g., .pdb) generated by the linker L</"ld">.

=head2 debug_output_file_ext

  my $debug_output_file_ext = $config->debug_output_file_ext;
  $config->debug_output_file_ext($debug_output_file_ext);

Gets and sets C<debug_output_file_ext> field. An extension of a debug information file (e.g., .pdb) generated by the linker L</"ld">.

=head2 enable_ld_debug_output_option

  my $enable_ld_debug_output_option = $config->enable_ld_debug_output_option;
  $config->enable_ld_debug_output_option($enable_ld_debug_output_option);

Gets and sets C<enable_ld_debug_output_option> field. If this field is true, the linker L</"ld"> generates a debug information file.
