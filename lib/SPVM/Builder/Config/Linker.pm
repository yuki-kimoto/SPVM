...
=head2 enable_debug_output_file

  my $enable_debug_output_file = $config->enable_debug_output_file;
  $config->enable_debug_output_file($enable_debug_output_file);

Gets and sets C<enable_debug_output_file> field. If this field is true, the linker L</"ld"> generates a debug information file.
