...
sub build_precompile_inline_header_c_source {
  my $builder_dir = &get_builder_dir;
...
EOS
  ...
  $header_content .= "\n/* spvm_native.h */\n" . &slurp_binary("$include_dir/spvm_native.h");
  $header_content .= "\n/* spvm_implement.h */\n" . &slurp_binary("$include_dir/spvm_implement.h");

  my $c_string_literal = &create_c_string_literal($header_content);

  my $final_c_source = "/* This file is auto-generated by SPVM::Builder::Util::build_precompile_inline_header_c_source */\n";
  $final_c_source .= "#include \"spvm_native.h\"\n\n";
  $final_c_source .= "static const char* spvm_precompile_inline_header = \n$c_string_literal;\n\n";
  $final_c_source .= "const char* get_precompile_inline_header() {\n";
  $final_c_source .= "  return spvm_precompile_inline_header;\n";
  $final_c_source .= "}\n";

  my $output_file = "$builder_dir/precompile_inline_header.c";
