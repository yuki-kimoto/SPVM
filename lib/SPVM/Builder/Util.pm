...
sub convert_module_file_to_dynamic_lib_file {
  ...
  $dynamic_lib_category_file .= $category eq 'native' ? ".$dlext" : "__$category.$dlext";
...
sub convert_class_name_to_dynamic_lib_rel_file {
  ...
  $dynamic_lib_category_rel_file .= $category eq 'native' ? ".$dlext" : "__$category.$dlext";
...
sub convert_class_name_to_category_rel_file {
  ...
  $rel_file_with_ext .= $category eq 'native' ? "" : "__$category";
  if (defined $ext) {
