...
const char* const* SPVM_OPCODE_C_ID_NAMES(void) {
  ...
  static const char* const id_names[] = {
    ...
    "DEREF_MULNUM_FLOAT",
    "DEREF_MULNUM_DOUBLE",
    "DEREF_MULNUM_GET_FIELD_BYTE",
    "GET_DEREF_MULNUM_GET_SHORT",
    "GET_DEREF_MULNUM_GET_INT",
    "GET_DEREF_MULNUM_GET_LONG",
    "GET_DEREF_MULNUM_GET_FLOAT",
    "GET_DEREF_MULNUM_GET_DOUBLE",
    "DEREF_MULNUM_SET_FIELD_BYTE",
    "DEREF_MULNUM_SET_FIELD_SHORT",
    "DEREF_MULNUM_SET_FIELD_INT",
    "DEREF_MULNUM_SET_FIELD_LONG",
    "DEREF_MULNUM_SET_FIELD_FLOAT",
    "DEREF_MULNUM_SET_FIELD_DOUBLE",
    "MULNUM_MOVE_BYTE",
    "MULNUM_MOVE_SHORT",
    "MULNUM_MOVE_INT",
    "MULNUM_MOVE_LONG",
