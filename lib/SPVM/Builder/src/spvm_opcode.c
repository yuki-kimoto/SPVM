...
const char* const SPVM_OPCODE_C_ID_NAMES[] = {
  "WIDE",
  "VALUE_ARRAY_FIELD_FETCH_BYTE",
  "VALUE_ARRAY_FIELD_FETCH_SHORT",
  "VALUE_ARRAY_FIELD_FETCH_INT",
  "VALUE_ARRAY_FIELD_FETCH_LONG",
  "VALUE_ARRAY_FIELD_FETCH_FLOAT",
  "VALUE_ARRAY_FIELD_FETCH_DOUBLE",
  "VALUE_ARRAY_FIELD_STORE_BYTE",
  "VALUE_ARRAY_FIELD_STORE_SHORT",
  "VALUE_ARRAY_FIELD_STORE_INT",
  "VALUE_ARRAY_FIELD_STORE_LONG",
  "VALUE_ARRAY_FIELD_STORE_FLOAT",
  "VALUE_ARRAY_FIELD_STORE_DOUBLE",
  "VALUE_ARRAY_FETCH_BYTE",
  "VALUE_ARRAY_FETCH_SHORT",
  "VALUE_ARRAY_FETCH_INT",
  "VALUE_ARRAY_FETCH_LONG",
  "VALUE_ARRAY_FETCH_FLOAT",
  "VALUE_ARRAY_FETCH_DOUBLE",
  "VALUE_ARRAY_STORE_BYTE",
  "VALUE_ARRAY_STORE_SHORT",
  "VALUE_ARRAY_STORE_INT",
  "VALUE_ARRAY_STORE_LONG",
  "VALUE_ARRAY_STORE_FLOAT",
  "VALUE_ARRAY_STORE_DOUBLE",
  "VALUE_DEREF_BYTE",
  "VALUE_DEREF_SHORT",
  "VALUE_DEREF_INT",
  "VALUE_DEREF_LONG",
  "VALUE_DEREF_FLOAT",
  "VALUE_DEREF_DOUBLE",
  "VALUE_DEREF_GET_FIELD_BYTE",
  "VALUE_DEREF_GET_FETCH_SHORT",
  "VALUE_DEREF_GET_FETCH_INT",
  "VALUE_DEREF_GET_FETCH_LONG",
  "VALUE_DEREF_GET_FETCH_FLOAT",
  "VALUE_DEREF_GET_FETCH_DOUBLE",
  "VALUE_DEREF_SET_FIELD_BYTE",
  "VALUE_DEREF_SET_FIELD_SHORT",
  "VALUE_DEREF_SET_FIELD_INT",
  "VALUE_DEREF_SET_FIELD_LONG",
  "VALUE_DEREF_SET_FIELD_FLOAT",
  "VALUE_DEREF_SET_FIELD_DOUBLE",
  "VALUE_MOVE_BYTE",
  "VALUE_MOVE_SHORT",
  "VALUE_MOVE_INT",
  "VALUE_MOVE_LONG",
  "VALUE_MOVE_FLOAT",
  "VALUE_MOVE_DOUBLE",
  "VALUE_SET_FIELD_BYTE",
  "VALUE_SET_FIELD_SHORT",
  "VALUE_SET_FIELD_INT",
  "VALUE_SET_FIELD_LONG",
  "VALUE_SET_FIELD_FLOAT",
  "VALUE_SET_FIELD_DOUBLE",
  "VALUE_GET_FIELD_BYTE",
  "VALUE_GET_FIELD_SHORT",
  "VALUE_GET_FIELD_INT",
  "VALUE_GET_FIELD_LONG",
  "VALUE_GET_FIELD_FLOAT",
  "VALUE_GET_FIELD_DOUBLE",
  "CALL_SUB_VOID",
  "CALL_SUB_BYTE",
  "CALL_SUB_SHORT",
  "CALL_SUB_INT",
  ...
  "CALL_SUB_OBJECT",
  "CALL_SUB_VALUE_BYTE",
  "CALL_SUB_VALUE_SHORT",
  "CALL_SUB_VALUE_INT",
  "CALL_SUB_VALUE_LONG",
  "CALL_SUB_VALUE_FLOAT",
  "CALL_SUB_VALUE_DOUBLE",
  "CALL_METHOD_VOID",
  "CALL_METHOD_BYTE",
  "CALL_METHOD_SHORT",
  "CALL_METHOD_INT",
  ...
  "CALL_METHOD_DOUBLE",
  "CALL_METHOD_OBJECT",
  "CALL_METHOD_VALUE_BYTE",
  "CALL_METHOD_VALUE_SHORT",
  "CALL_METHOD_VALUE_INT",
  "CALL_METHOD_VALUE_LONG",
  "CALL_METHOD_VALUE_FLOAT",
  "CALL_METHOD_VALUE_DOUBLE",
  "ADD_INT",
  "ADD_LONG",
  "ADD_FLOAT",
  "ADD_DOUBLE",
  ...
  "PUSH_ARG_UNDEF",
  "PUSH_ARG_VALUE_BYTE",
  "PUSH_ARG_VALUE_SHORT",
  "PUSH_ARG_VALUE_INT",
  "PUSH_ARG_VALUE_LONG",
  "PUSH_ARG_VALUE_FLOAT",
  "PUSH_ARG_VALUE_DOUBLE",
  "RETURN_VOID",
  "RETURN_BYTE",
  "RETURN_SHORT",
  "RETURN_INT",
  ...
  "COMPLEX_ADD_FLOAT",
  "COMPLEX_ADD_DOUBLE",
  "COMPLEX_SUBTRACT_FLOAT",
  "COMPLEX_SUBTRACT_DOUBLE",
  "COMPLEX_MULTIPLY_FLOAT",
  "COMPLEX_MULTIPLY_DOUBLE",
  "COMPLEX_DIVIDE_FLOAT",
  "COMPLEX_DIVIDE_DOUBLE",
  "END_SUB",
};
