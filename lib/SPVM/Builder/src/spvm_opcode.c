...
const char* const* SPVM_OPCODE_C_ID_NAMES(void) {
  ...
  static const char* const id_names[] = {
    ...
    "TYPE_CONVERSION_OBJECT_TO_BYTE",
    "TYPE_CONVERSION_OBJECT_TO_SHORT",
    "TYPE_CONVERSION_OBJECT_TO_INT",
    "TYPE_CONVERSION_OBJECT_TO_LONG",
    "TYPE_CONVERSION_OBJECT_TO_FLOAT",
    "TYPE_CONVERSION_OBJECT_TO_DOUBLE",
    "GET_STACK_BYTE",
    "GET_STACK_SHORT",
    "GET_STACK_INT",
    "GET_STACK_LONG",
