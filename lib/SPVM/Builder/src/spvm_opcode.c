...
const char* const* SPVM_OPCODE_C_ID_NAMES(void) {
  ...
  static const char* const id_names[] = {
    ...
    "DEREF_MULNUM_FLOAT",
    "DEREF_MULNUM_DOUBLE",
    "DEREF_GET_MULNUM_FIELD_BYTE",
    "GET_DEREF_GET_MULNUM_SHORT",
    "GET_DEREF_GET_MULNUM_INT",
    "GET_DEREF_GET_MULNUM_LONG",
    "GET_DEREF_GET_MULNUM_FLOAT",
    "GET_DEREF_GET_MULNUM_DOUBLE",
    "DEREF_SET_MULNUM_FIELD_BYTE",
    "DEREF_SET_MULNUM_FIELD_SHORT",
    "DEREF_SET_MULNUM_FIELD_INT",
    "DEREF_SET_MULNUM_FIELD_LONG",
    "DEREF_SET_MULNUM_FIELD_FLOAT",
    "DEREF_SET_MULNUM_FIELD_DOUBLE",
    "MOVE_MULNUM_BYTE",
    "MOVE_MULNUM_SHORT",
    "MOVE_MULNUM_INT",
    "MOVE_MULNUM_LONG",
