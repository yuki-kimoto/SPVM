              ...
              while (1) {
                ...
                switch (op_cur->id) {
                  ...
                  case SPVM_OP_C_ID_DIE: {
                    ...
                    SPVM_OPCODE_BUILDER_push_if_exception(compiler, opcode_array, push_eval_opcode_rel_index_stack, if_die_catch_goto_opcode_rel_index_stack, if_die_return_goto_opcode_rel_index_stack, method->op_method, op_cur->line);
                      ...
                      switch (op_assign_src->id) {
                        ...
                        case SPVM_OP_C_ID_FIELD_ACCESS : {
                          ...
                          if (op_assign_src->flag & SPVM_OP_C_FLAG_FIELD_ACCESS_WEAKEN) {
                            ...
                            SPVM_OPCODE_BUILDER_push_if_exception(compiler, opcode_array, push_eval_opcode_rel_index_stack, if_die_catch_goto_opcode_rel_index_stack, if_die_return_goto_opcode_rel_index_stack, method->op_method, op_assign_src->line);
                          }
...
void SPVM_OPCODE_BUILDER_push_if_exception(
