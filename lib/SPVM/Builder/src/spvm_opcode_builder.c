...
void SPVM_OPCODE_BUILDER_build_opcode_array(SPVM_COMPILER* compiler) {
  ...
  for (int32_t basic_type_index = compiler->cur_basic_type_base; basic_type_index < compiler->basic_types->length; basic_type_index++) {
    ...
    for (int32_t method_index = 0; method_index < methods->length; method_index++) {
      ...
      SPVM_LIST* block_stack_call_stack_id_top = SPVM_LIST_new(compiler->allocator, 0, SPVM_ALLOCATOR_C_ALLOC_TYPE_TMP);
      ...
      int32_t call_stack_ids_stack_top = 0;
      ...
      while (op_cur) {
        ...
        switch (op_cur->id) {
          case SPVM_OP_C_ID_BLOCK: { // Preorder
            ...
            SPVM_LIST_push(block_stack_call_stack_id_top, (void*)(intptr_t)call_stack_ids_top);
            ...
            switch (op_cur->id) {
              case SPVM_OP_C_ID_BLOCK: { // Postorder
                ...
                if (block->id == SPVM_BLOCK_C_ID_IF) {
                  ...
                  int32_t if_eq_or_if_ne_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                  ...
                  int32_t if_block_end_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                  ...
                  for (int32_t i = 0; i < unresolved_last_opcode_rel_index_stack_pop_count; i++) {
                    ...
                    int32_t last_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                  ...
                  for (int32_t i = 0; i < unresolved_next_opcode_rel_index_stack_pop_count; i++) {
                    ...
                    int32_t next_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                  ...
                  for (int32_t i = 0; i < unresolved_break_opcode_rel_index_stack_pop_count; i++) {
                    ...
                    int32_t break_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                  ...
                  while (unresolved_goto_end_of_eval_on_exception_opcode_rel_index_stack->length > 0) {
                    ...
                    SPVM_OPCODE* goto_end_of_eval_on_exception_goto = (opcode_array->values + method_opcodes_base_id + goto_end_of_eval_on_exception_goto_opcode_rel_index);
                    int32_t goto_end_of_eval_on_exception_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                  ...
                  while (unresolved_return_opcode_rel_index_stack->length > 0) {
                    ...
                    int32_t return_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                  ...
                  while (unresolved_goto_end_of_method_on_exception_opcode_rel_index_stack->length > 0) {
                    ...
                    SPVM_OPCODE* goto_end_of_method_on_exception_goto = (opcode_array->values + method_opcodes_base_id + goto_end_of_method_on_exception_goto_opcode_rel_index);
                    int32_t goto_end_of_method_on_exception_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                    goto_end_of_method_on_exception_goto->operand0 = goto_end_of_method_on_exception_goto_opcode_base_rel_index;
                  }
                }
                
                int32_t call_stack_ids_top = (intptr_t)SPVM_LIST_get(block_stack_call_stack_id_top, block_stack_call_stack_id_top->length - 1);
                ...
                SPVM_LIST_pop(block_stack_call_stack_id_top);
              ...
              case SPVM_OP_C_ID_LOOP_INCREMENT: {
                ...
                int32_t loop_first_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
              ...
              case SPVM_OP_C_ID_RETURN: {
                if (op_cur->first) {
                  SPVM_TYPE* return_type = SPVM_AST_CHECKER_get_type(compiler, op_cur->first);
              ...
              case SPVM_OP_C_ID_DIE: {
                ...
                SPVM_TYPE* type = SPVM_AST_CHECKER_get_type(compiler, op_cur->last);
              ...
              case SPVM_OP_C_ID_ASSIGN: {
                ...
                if (op_assign_dist->id == SPVM_OP_C_ID_VAR) {
                  SPVM_TYPE* type_dist = SPVM_AST_CHECKER_get_type(compiler, op_assign_dist);
                  
                  switch (op_assign_src->id) {
                    case SPVM_OP_C_ID_CONCAT: {
                      SPVM_TYPE* first_type = SPVM_AST_CHECKER_get_type(compiler, op_assign_src->first);
                    ...
                    case SPVM_OP_C_ID_CALL_METHOD: {
                      ...
                      int32_t args_stack_length = 0;
                      {
                        for (int32_t arg_index = 0; arg_index < method_call_method->args_length; arg_index++) {
                          ...
                          SPVM_TYPE* term_arg_type = SPVM_AST_CHECKER_get_type(compiler, op_term_arg);
                    ...
                    case SPVM_OP_C_ID_ARRAY_FIELD_ACCESS : {
                      ...
                      // Array type
                      SPVM_TYPE* array_type = SPVM_AST_CHECKER_get_type(compiler, op_array_field_access->first);
                      SPVM_BASIC_TYPE* array_basic_type = array_type->basic_type;
                      
                      // Element type
                      SPVM_TYPE* element_type = SPVM_AST_CHECKER_get_type(compiler, op_array_field_access);
                    ...
                    case SPVM_OP_C_ID_FIELD_ACCESS : {
                      ...
                      if (op_assign_src->flag & SPVM_OP_C_FLAG_FIELD_ACCESS_WEAKEN) {
                        ...
                        SPVM_TYPE* field_type = SPVM_AST_CHECKER_get_type(compiler, op_field_access);

                        SPVM_TYPE* invocant_type = SPVM_AST_CHECKER_get_type(compiler, op_term_invocant);
                    ...
                    case SPVM_OP_C_ID_ARRAY_ACCESS : {
                      ...
                      SPVM_TYPE* array_type = SPVM_AST_CHECKER_get_type(compiler, op_term_array);
                      ...
                      if (SPVM_TYPE_is_mulnum_array_type(compiler, array_type->basic_type->id, array_type->dimension, array_type->flag)) {
                        ...
                        SPVM_TYPE* element_type = SPVM_AST_CHECKER_get_type(compiler, first_field->op_field);
                        ...
                        SPVM_TYPE* element_type = SPVM_AST_CHECKER_get_type(compiler, op_array_access);
                    ...
                    case SPVM_OP_C_ID_CLASS_VAR_ACCESS : {
                      SPVM_TYPE* type = SPVM_AST_CHECKER_get_type(compiler, op_assign_src);
                    ...
                    case SPVM_OP_C_ID_DEREF : {
                      SPVM_TYPE* src_type = SPVM_AST_CHECKER_get_type(compiler, op_assign_src);
                    ...
                    case SPVM_OP_C_ID_CREATE_REF : {
                      ...
                      int32_t call_stack_id_out = SPVM_OPCODE_BUILDER_get_call_stack_id(compiler, op_assign_dist);
                      int32_t call_stack_id_in;
                      SPVM_TYPE* src_type = SPVM_AST_CHECKER_get_type(compiler, op_assign_src->first);
                      if (SPVM_TYPE_is_mulnum_type(compiler, src_type->basic_type->id, src_type->dimension, src_type->flag)) {
                    ...
                    case SPVM_OP_C_ID_TYPE_CAST : {
                      ...
                      SPVM_TYPE* src_type = SPVM_AST_CHECKER_get_type(compiler, op_src_term);
                      SPVM_TYPE* cast_type = SPVM_AST_CHECKER_get_type(compiler, op_cast_type);
                    ...
                    case SPVM_OP_C_ID_NUMERIC_EQ : {
                      if (op_assign_src->first->id == SPVM_OP_C_ID_UNDEF || op_assign_src->last->id == SPVM_OP_C_ID_UNDEF) {
                        ...
                        SPVM_TYPE* operand_type = SPVM_AST_CHECKER_get_type(compiler, op_assign_src->first);
                    ...
                    case  SPVM_OP_C_ID_BOOL: {
                      SPVM_TYPE* type = SPVM_AST_CHECKER_get_type(compiler, op_assign_src->first);
                    ...
                    case SPVM_OP_C_ID_IS_ERROR:
                    {
                      ...
                      SPVM_TYPE* type = SPVM_AST_CHECKER_get_type(compiler, op_type);
                    ...
                    case SPVM_OP_C_ID_CAN: {
                      ...
                      SPVM_TYPE* interface_type = SPVM_AST_CHECKER_get_type(compiler, op_var);
                ...
                // $VAR = $var
                  ...
                  SPVM_OP* op_module_var_access = op_assign_dist;
                  ...
                  // CLASS_VAR_ACCESS = $var
                    ...
                    SPVM_TYPE* type = SPVM_AST_CHECKER_get_type(compiler, op_module_var_access);
                ...
                // $$var_ref = $var
                  ...
                  SPVM_TYPE* type = SPVM_AST_CHECKER_get_type(compiler, op_deref->first);
                ...
                // $array->[$index] = $var
                  ...
                  if (SPVM_TYPE_is_any_object_array_type(compiler, array_type->basic_type->id, array_type->dimension, array_type->flag)) {
                    ...
                    SPVM_TYPE* element_type = SPVM_AST_CHECKER_get_type(compiler, op_assign_src);
      ...
      method->mortal_stack_length = call_stack_ids_stack_top + 1;
      ...
      SPVM_LIST_free(block_stack_call_stack_id_top);
    }
  }
...
)
{
  ...
  if (in_eval_block) {
    ...
    int32_t goto_end_of_eval_on_exception_opcode_rel_index = opcode_array->length - 1 - method_opcodes_base_id;
    ...
    int32_t goto_end_of_method_on_exception_opcode_rel_index = opcode_array->length - 1 - method_opcodes_base_id;
