                  ...
                  switch (op_assign_src->id) {
                    ...
                    case SPVM_OP_C_ID_FIELD_ACCESS : {
                      ...
                      if (op_assign_src->flag & SPVM_OP_C_FLAG_FIELD_ACCESS_WEAKEN) {
                        ...
                        opcode.operand1 = op_assign_src->uv.field_access->unmerged_field->address_id;
                        opcode.operand3 = op_assign_src->uv.field_access->unmerged_field->index + (op_assign_src->uv.field_access->unmerged_field->current_basic_type->id << 8);
                        SPVM_OPCODE_ARRAY_push_opcode(compiler, opcode_array, &opcode);
                        ...
                        opcode.operand1 = call_stack_id_invocant;
                        opcode.operand2 = op_assign_src->uv.field_access->unmerged_field->address_id;
                        opcode.operand3 = op_assign_src->uv.field_access->unmerged_field->index + (op_assign_src->uv.field_access->unmerged_field->current_basic_type->id << 8);
                        SPVM_OPCODE_ARRAY_push_opcode(compiler, opcode_array, &opcode);
                        ...
                        // Mulnum field access
                          ...
                          opcode.operand0 = call_stack_id_out;
                          opcode.operand1 = call_stack_id_in;
                          opcode.operand2 = field_access->unmerged_field->index;
                        ...
                        // Field access
                          ...
                          opcode.operand0 = call_stack_id_out;
                          opcode.operand1 = call_stack_id_invocant;
                          opcode.operand2 = field_access->unmerged_field->address_id;
                          opcode.operand3 = field_access->unmerged_field->index + (field_access->unmerged_field->current_basic_type->id << 8);
                ...
                // $invocant->{FIELD_NAME} = $var
                  ...
                  if (SPVM_TYPE_is_mulnum_ref_type(compiler, invocant_type->basic_type->id, invocant_type->dimension, invocant_type->flag)) {
                    ...
                    if (SPVM_TYPE_is_undef_type(compiler, src_type->basic_type->id, src_type->dimension, src_type->flag)) {
                      ...
                      opcode.operand0 = call_stack_id_invocant;
                      opcode.operand1 = field_access->unmerged_field->address_id;
                      opcode.operand3 = field_access->unmerged_field->index + (field_access->unmerged_field->current_basic_type->id << 8);
                      SPVM_OPCODE_ARRAY_push_opcode(compiler, opcode_array, &opcode);
