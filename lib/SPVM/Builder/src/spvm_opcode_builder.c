              ...
              while (1) {
                ...
                switch (op_cur->id) {
                  case SPVM_OP_C_ID_BLOCK: { // Postorder
                    ...
                    if (block->id == SPVM_BLOCK_C_ID_IF) {
                      ...
                      while (if_die_catch_goto_opcode_rel_index_stack->length > 0) {
                        ...
                        int32_t if_die_catch_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                        if_die_catch_goto->operand0 = if_die_catch_goto_opcode_base_rel_index;
                      }
                      ...
                      while (if_die_return_goto_opcode_rel_index_stack->length > 0) {
                        ...
                        int32_t if_die_return_goto_opcode_base_rel_index = opcode_array->length - method_opcodes_base_id;
                        if_die_return_goto->operand0 = if_die_return_goto_opcode_base_rel_index;
                      }
                    }
                  ...
                  case SPVM_OP_C_ID_DIE: {
                    ...
                    SPVM_OPCODE_BUILDER_push_goto_on_exception(compiler, opcode_array, push_eval_opcode_rel_index_stack, if_die_catch_goto_opcode_rel_index_stack, if_die_return_goto_opcode_rel_index_stack, method->op_method, op_cur->line);
                  ...
                  case SPVM_OP_C_ID_ASSIGN: {
                    ...
                    if (op_assign_dist->id == SPVM_OP_C_ID_VAR) {
                      ...
                      switch (op_assign_src->id) {
                        case SPVM_OP_C_ID_CONCAT: {
                          ...
                          SPVM_OPCODE_BUILDER_push_goto_on_exception(compiler, opcode_array, push_eval_opcode_rel_index_stack, if_die_catch_goto_opcode_rel_index_stack, if_die_return_goto_opcode_rel_index_stack, method->op_method, op_assign->line);
                          break;
                        }
                        ...
                        case SPVM_OP_C_ID_FIELD_ACCESS : {
                          ...
                          if (op_assign_src->flag & SPVM_OP_C_FLAG_FIELD_ACCESS_WEAKEN) {
                            ...
                            SPVM_OPCODE_BUILDER_push_goto_on_exception(compiler, opcode_array, push_eval_opcode_rel_index_stack, if_die_catch_goto_opcode_rel_index_stack, if_die_return_goto_opcode_rel_index_stack, method->op_method, op_assign_src->line);
                          }
                    ...
                    // $mulnum_array->[$index]{FIELD_NAME} = OPERAND
