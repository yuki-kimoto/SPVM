...
SPVM_OBJECT* SPVM_RUNTIME_API_new_short_array_raw(SPVM_ENV* env, int32_t length) {
  ...
  // Alloc body length + 1
  object->body = SPVM_RUNTIME_API_alloc_memory_block_zero(env, (length + 1) * sizeof(SPVM_VALUE_short));
...
SPVM_OBJECT* SPVM_RUNTIME_API_new_int_array_raw(SPVM_ENV* env, int32_t length) {
  ...
  // Alloc body length + 1
  object->body = SPVM_RUNTIME_API_alloc_memory_block_zero(env, (length + 1) * sizeof(SPVM_VALUE_int));
...
SPVM_OBJECT* SPVM_RUNTIME_API_new_long_array_raw(SPVM_ENV* env, int32_t length) {
  ...
  // Alloc body length + 1
  object->body = SPVM_RUNTIME_API_alloc_memory_block_zero(env, (length + 1) * sizeof(SPVM_VALUE_long));
