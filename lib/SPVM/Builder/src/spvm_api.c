      ...
      for (int32_t array_index = 0; array_index < array_length; array_index++) {
        ...
        if (SPVM_API_is_mulnum_array(env, stack, object)) {
          ...
          for (int32_t field_index = 0; field_index < fields_length; field_index++) {
            ...
            SPVM_RUNTIME_FIELD* field = SPVM_API_RUNTIME_get_field_by_index(runtime, object_basic_type, field_index);
...
int32_t SPVM_API_get_elem_size(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* array) {
  ...
  if (array) {
    if (SPVM_API_is_string(env, stack, array)) {
      ...
      SPVM_RUNTIME_FIELD* first_field = SPVM_API_RUNTIME_get_field_by_index(runtime, array_basic_type, 0);
...
SPVM_OBJECT* SPVM_API_new_mulnum_array_raw(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_RUNTIME_BASIC_TYPE* basic_type, int32_t length) {
  ...
  int32_t fields_length = basic_type->fields_length;
  SPVM_RUNTIME_FIELD* field_first = SPVM_API_RUNTIME_get_field_by_index(runtime, basic_type, 0);
