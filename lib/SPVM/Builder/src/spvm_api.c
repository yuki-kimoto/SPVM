...
SPVM_ENV* SPVM_API_new_env_raw() {
  ...
  void* env_init[]  = {
    ...
    SPVM_API_RUNTIME_get_class_method_ids_base,
    SPVM_API_RUNTIME_get_class_method_ids_length,
    SPVM_API_RUNTIME_get_class_class_var_ids_base,
    ...
    SPVM_API_RUNTIME_get_class_anon_method_ids_base,
    SPVM_API_RUNTIME_get_class_anon_method_ids_length,
    ...
    SPVM_API_RUNTIME_get_method_arg_ids_length,
    SPVM_API_RUNTIME_get_method_is_class_method,
    SPVM_API_RUNTIME_get_method_arg_ids_base,
      ...
      for (int32_t array_index = 0; array_index < array_length; array_index++) {
        ...
        if (SPVM_API_is_mulnum_array(env, object)) {
          ...
          for (int32_t field_index = 0; field_index < fields_length; field_index++) {
            ...
            SPVM_RUNTIME_FIELD* field = SPVM_API_RUNTIME_get_field(env->runtime, class->field_ids_base + field_index);
...
int32_t SPVM_API_get_elem_byte_size(SPVM_ENV* env, SPVM_OBJECT* array) {
  ...
  if (array) {
    if (SPVM_API_is_string(env, array)) {
      ...
      SPVM_RUNTIME_FIELD* first_field = SPVM_API_RUNTIME_get_field(env->runtime, class->field_ids_base + 0);
...
SPVM_OBJECT* SPVM_API_new_mulnum_array_raw(SPVM_ENV* env, int32_t basic_type_id, int32_t length) {
  ...
  SPVM_RUNTIME_CLASS* class = SPVM_API_get_class(env, basic_type->class_id);
  int32_t fields_length = class->field_ids_length;
  SPVM_RUNTIME_FIELD* field_first = SPVM_API_RUNTIME_get_field(env->runtime, class->field_ids_base + 0);
...
const char* SPVM_API_get_basic_type_name(SPVM_ENV* env, int32_t basic_type_id) {
  ...
  SPVM_RUNTIME_BASIC_TYPE* basic_type = (SPVM_RUNTIME_BASIC_TYPE*)SPVM_API_RUNTIME_get_basic_type(env->runtime, basic_type_id);
...
int32_t SPVM_API_get_type_basic_type_id(SPVM_ENV* env, int32_t type_id) {
  ...
  SPVM_RUNTIME_TYPE* type =SPVM_API_RUNTIME_get_type(env->runtime, type_id);
