...
SPVM_ENV* SPVM_API_new_env_raw() {
  ...
  void* env_init[]  = {
    ...
    env_api,
    SPVM_API_get_name,
    SPVM_API_get_basic_type_name_id,
    SPVM_API_get_basic_type_class_id,
    SPVM_API_get_basic_type_category,
    SPVM_API_get_type_basic_type_id,
    SPVM_API_get_type_dimension,
    SPVM_API_get_type_width,
    SPVM_API_get_type_is_object,
    SPVM_API_get_type_is_ref,
    SPVM_API_get_class_id,
    SPVM_API_get_class_name_id,
    SPVM_API_get_class_field_ids_base,
    SPVM_API_get_class_field_ids_length,
    SPVM_API_get_class_method_ids_base,
    SPVM_API_get_class_method_ids_length,
    SPVM_API_get_class_class_var_ids_base,
    SPVM_API_get_class_var_name_id,
    SPVM_API_get_class_var_signature_id,
    SPVM_API_get_class_var_class_id,
    SPVM_API_get_class_is_anon,
    SPVM_API_get_class_module_file_id,
    SPVM_API_get_class_anon_method_ids_base,
    SPVM_API_get_class_anon_method_ids_length,
    SPVM_API_get_field_name_id,
    SPVM_API_get_field_type_id,
    SPVM_API_get_field_signature_id,
    SPVM_API_get_field_class_id,
    SPVM_API_get_method_arg_ids_length,
    SPVM_API_get_method_is_class_method,
    SPVM_API_get_method_arg_ids_base,
    SPVM_API_get_method_return_type_id,
    SPVM_API_get_method_name_id,
    SPVM_API_get_method_signature_id,
    SPVM_API_get_method_class_id,
    SPVM_API_get_method_is_anon,
    SPVM_API_get_method_has_precompile_flag,
    SPVM_API_get_method_call_stack_byte_vars_length,
    SPVM_API_get_method_call_stack_short_vars_length,
    SPVM_API_get_method_call_stack_int_vars_length,
    SPVM_API_get_method_call_stack_long_vars_length,
    SPVM_API_get_method_call_stack_float_vars_length,
    SPVM_API_get_method_call_stack_double_vars_length,
    SPVM_API_get_method_call_stack_object_vars_length,
    SPVM_API_get_method_call_stack_ref_vars_length,
  ...
  while (1) {
    ...
    switch (opcode_id) {
      ...
      case SPVM_OPCODE_C_ID_NEW_STRING: {
        ...
        const char* constant_string = env->get_constant_string_value(env, string_id, &constant_string_length);
      ...
      case SPVM_OPCODE_C_ID_CALL_INSTANCE_METHOD_BY_SIGNATURE:
      {
        ...
        if (call_method_id < 0) {
          ...
          SPVM_RUNTIME_CLASS* decl_method_class = SPVM_API_get_class(env, decl_method->class_id);
      ...
      case SPVM_OPCODE_C_ID_IF_EXCEPTION_CATCH: {
        if (exception_flag) {
          ...
          SPVM_RUNTIME_CLASS* method_class = SPVM_API_get_class(env, method->class_id);
...
int32_t SPVM_API_has_callback_by_id(SPVM_ENV* env, int32_t object_basic_type_id, int32_t object_type_dimension, int32_t callback_basic_type_id, int32_t callback_type_dimension) {
  ...
  SPVM_RUNTIME_CLASS* class = SPVM_API_get_class(env, class_basic_type->class_id);
  SPVM_RUNTIME_CLASS* callback = SPVM_API_get_class(env, callback_basic_type->class_id);
...
int32_t SPVM_API_has_interface_by_id(SPVM_ENV* env, int32_t object_basic_type_id, int32_t object_type_dimension, int32_t interface_basic_type_id, int32_t interface_type_dimension) {
  ...
  SPVM_RUNTIME_CLASS* class = SPVM_API_get_class(env, class_basic_type->class_id);
  SPVM_RUNTIME_CLASS* interface = SPVM_API_get_class(env, interface_basic_type->class_id);
...
int32_t SPVM_API_get_class_class_var_ids_length(SPVM_ENV* env, int32_t class_id) {
