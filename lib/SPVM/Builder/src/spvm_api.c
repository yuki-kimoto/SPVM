...
SPVM_OBJECT* SPVM_API_concat_raw(SPVM_ENV* env, SPVM_OBJECT* string1, SPVM_OBJECT* string2) {
  ...
  string3->type_category = SPVM_TYPE_C_TYPE_CATEGORY_BASIC_OBJECT;
...
void SPVM_API_dec_ref_count(SPVM_ENV* env, SPVM_OBJECT* object) {
  ...
  if (object->ref_count == 1) {
    ...
    // Free class object
    else if ((object->type_category == SPVM_TYPE_C_TYPE_CATEGORY_BASIC_OBJECT || object->type_category == SPVM_TYPE_C_TYPE_CATEGORY_CLASS  || object->type_category == SPVM_TYPE_C_TYPE_CATEGORY_INTERFACE || object->type_category == SPVM_TYPE_C_TYPE_CATEGORY_CALLBACK) && !SPVM_API_is_string(env, object)) {
...
int32_t SPVM_API_get_type_is_mulnum_array(SPVM_ENV* env, int32_t type_id) {
  ...
  int32_t is_mulnum_array = type->category & SPVM_TYPE_C_TYPE_CATEGORY_MULNUM_ARRAY;
