...
int32_t SPVM_API_call_method_common(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_RUNTIME_METHOD* method, int32_t args_width, int32_t mortal, int32_t check_args_level, const char* func_name, const char* file, int32_t line) {
  ...
  if (__builtin_expect(stack[SPVM_API_C_STACK_INDEX_CALL_DEPTH].ival > max_call_depth, 0)) {
    error_id = SPVM_API_die_v2(env, stack, "Deep recursion occurs. The depth of a method call must be less than %d.", __func__, FILE_NAME, __LINE__, max_call_depth);
    goto END_OF_FUNC;
  }
  else if (__builtin_expect(method->is_not_permitted && !stack[SPVM_API_C_STACK_INDEX_ALL_METHOD_CALL_PERMITTED].ival, 0)) {
    SPVM_API_die_v2(env, stack, "The call to %s#%s method is not permmited.", __func__, FILE_NAME, __LINE__, current_basic_type->name, method->name);
          ...
          if (arg_is_object_type) {
            ...
            if (obj_arg) {
              ...
              if (!can_assign) {
                ...
                error_id = SPVM_API_die_v2(env, stack, "The %ith argument must be assigned to the type of %ith argument of %s#%s method.", __func__, FILE_NAME, __LINE__, arg_index_nth, arg_index_nth, current_basic_type->name, method->name);
                goto END_OF_FUNC;
              }
            }
          }
  ...
  if (method->is_native) {
    ...
    if (method_precompile_address) {
      ...
      error_id = SPVM_API_die_v2(env, stack, "The execution address of %s#%s precompile method must not be NULL. Loading the dynamic link library maybe failed.", __func__, FILE_NAME, __LINE__, method->current_basic_type->name, method->name);
      goto END_OF_FUNC;
    }
  }
  else {
...
int32_t SPVM_API_call_method_native(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_RUNTIME_METHOD* method, int32_t args_width) {
  ...
  if (__builtin_expect(!native_address, 0)) {
    error_id = SPVM_API_die_v2(env, stack, "The execution address of %s#%s native method must not be NULL. Loading the dynamic link library maybe failed.", __func__, FILE_NAME, __LINE__, method->current_basic_type->name, method->name);
    goto END_OF_FUNC;
  }
...
void SPVM_API_call_class_method_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* method_name, int32_t args_width, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (!basic_type) {
    *error_id = SPVM_API_die_v2(env, stack, "%s class is not found.", func_name, file, line, basic_type_name);
    return;
  }
  ...
  if (!method) {
    *error_id = SPVM_API_die_v2(env, stack, "%s#%s method is not found.", func_name, file, line, basic_type_name, method_name);
    return;
  }
  
  if (!method->is_class_method) {
    *error_id = SPVM_API_die_v2(env, stack, "%s#%s method must be a class method.", func_name, file, line, basic_type_name, method_name);
    return;
  }
  ...
  *error_id = SPVM_API_call_method(env, stack, method, args_width, func_name, file, line);
  ...
  if (*error_id) {
    ...
    SPVM_API_die_v2(env, stack, "%s", func_name, file, line, message);
  }
}
...
void SPVM_API_call_instance_method_static_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* method_name, int32_t args_width, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (method->is_class_method) {
    *error_id = SPVM_API_die_v2(env, stack, "%s#%s method must be an instance method.", func_name, file, line, basic_type_name, method_name);
    return;
  }
  ...
  if (!object) {
    *error_id = SPVM_API_die_v2(env, stack, "The invocant must be defined.", func_name, file, line);
    return;
  };
  
  if (!SPVM_API_isa(env, stack, object, basic_type, 0)) {
    *error_id = SPVM_API_die_v2(env, stack, "The invocant must be assigned to %s class.", func_name, file, line, basic_type_name);
    return;
  };
...
int32_t SPVM_API_set_command_info_program_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* obj_program_name) {
  ...
  if (!obj_program_name) {
    return SPVM_API_die_v2(env, stack, "The obj_program_name must be defined.", __func__, FILE_NAME, __LINE__);
  }
  ...
  if (!(obj_program_name_basic_type->id == SPVM_NATIVE_C_BASIC_TYPE_ID_STRING && obj_program_name->type_dimension == 0)) {
    return SPVM_API_die_v2(env, stack, "The obj_program_name must be a string.", __func__, FILE_NAME, __LINE__);
  }
...
int32_t SPVM_API_set_command_info_argv(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* obj_argv) {
  ...
  if (!obj_argv) {
    return SPVM_API_die_v2(env, stack, "The obj_argv must be defined.", __func__, FILE_NAME, __LINE__);
  }
  ...
  if (!(obj_argv_basic_type->id == SPVM_NATIVE_C_BASIC_TYPE_ID_STRING && obj_argv->type_dimension == 1)) {
    return SPVM_API_die_v2(env, stack, "The obj_argv must be a string array.", __func__, FILE_NAME, __LINE__);
  }
...
void* SPVM_API_new_object_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  *error_id = 0;
  ...
  if (!object) {
    *error_id = SPVM_API_die_v2(env, stack, "The creation of the object of %s class failed.", func_name, file, line, basic_type_name);
    return NULL;
  }
...
SPVM_OBJECT* SPVM_API_new_object_array_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, int32_t length, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  *error_id = 0;
  ...
  if (!array) {
    *error_id = SPVM_API_die_v2(env, stack, "The creation of the array of %s class failed.", func_name, file, line, basic_type_name);
    return NULL;
  }
...
SPVM_OBJECT* SPVM_API_new_muldim_array_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, int32_t type_dimension, int32_t length, int32_t* error_id, const char* func_name, const char* file, int32_t line) {  *error_id = 0;
  ...
  if (!object) {
    *error_id = SPVM_API_die_v2(env, stack, "The creation of the multi-dimensional array of %s class with the dimension %d failed.", func_name, file, line, basic_type_name, type_dimension);
    return NULL;
  }
...
SPVM_OBJECT* SPVM_API_new_mulnum_array_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, int32_t length, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  *error_id = 0;
  ...
  if (!array) {
    *error_id = SPVM_API_die_v2(env, stack, "The creation of the multi-numeric array of %s class failed.", func_name, file, line, basic_type_name);
    return NULL;
  }
...
int8_t SPVM_API_get_class_var_byte_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (!class_var) {
    *error_id = SPVM_API_die_v2(env, stack, "$%s#%s class variable is not found.", func_name, file, line, basic_type_name, class_var_name + 1);
    return 0;
  };
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be byte type.", func_name, file, line);
    return 0;
  }
...
int16_t SPVM_API_get_class_var_short_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be short type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
int32_t SPVM_API_get_class_var_int_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be int type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
int64_t SPVM_API_get_class_var_long_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be long type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
float SPVM_API_get_class_var_float_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be float type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
double SPVM_API_get_class_var_double_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be double type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
SPVM_OBJECT* SPVM_API_get_class_var_object_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be an object type.", func_name, file, line);
    return 0;
  }
...
void SPVM_API_set_class_var_byte_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int8_t value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be byte or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_class_var_short_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int16_t value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be short or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_class_var_int_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int32_t value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be int or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_class_var_long_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, int64_t value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be long or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_class_var_float_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, float value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be float or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_class_var_double_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, const char* class_var_name, double value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the class variable must be double type.", func_name, file, line);
    return;
  }
}
...
int8_t SPVM_API_get_field_byte(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field) {
  ...
  int8_t value = *(int8_t*)(GET_DATA_ADDRESS(env, stack, object) + field->offset);
...
int16_t SPVM_API_get_field_short(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field) {
  ...
  int16_t value = *(int16_t*)(GET_DATA_ADDRESS(env, stack, object) + field->offset);
...
int32_t SPVM_API_get_field_int(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field) {
  ...
  int32_t value = *(int32_t*)(GET_DATA_ADDRESS(env, stack, object) + field->offset);
...
int64_t SPVM_API_get_field_long(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field) {
  ...
  int64_t value = *(int64_t*)(GET_DATA_ADDRESS(env, stack, object) + field->offset);
...
float SPVM_API_get_field_float(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field) {
  ...
  float value = *(float*)(GET_DATA_ADDRESS(env, stack, object) + field->offset);
...
double SPVM_API_get_field_double(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field) {
  ...
  double value = *(double*)(GET_DATA_ADDRESS(env, stack, object) + field->offset);
...
SPVM_OBJECT* SPVM_API_get_field_object(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field) {
  ...
  SPVM_OBJECT* value_maybe_weaken = *(SPVM_OBJECT**)(GET_DATA_ADDRESS(env, stack, object) + field->offset);
  SPVM_OBJECT* value = SPVM_API_drop_tag_pointers(env, stack, value_maybe_weaken);
...
SPVM_OBJECT** SPVM_API_get_field_object_ref(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field) {
  ...
  SPVM_OBJECT** ref = (SPVM_OBJECT**)(GET_DATA_ADDRESS(env, stack, object) + field->offset);
...
void SPVM_API_set_field_byte(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, SPVM_RUNTIME_FIELD* field, int8_t value) {
  ...
  *(int8_t*)(GET_DATA_ADDRESS(env, stack, object) + field->offset) = value;
...
int8_t SPVM_API_get_field_byte_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (object == NULL) {
    *error_id = SPVM_API_die_v2(env, stack, "The object must be defined.", func_name, file, line);
    return 0;
  };
  ...
  if (!object_is_class_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the invocant must be a class type.", func_name, file, line);
    return 0;
  };
  ...
  if (!field) {
    ...
    *error_id = SPVM_API_die_v2(env, stack, "%s#%s field is not found in the class or its super classes.", func_name, file, line, basic_type_name, field_name);
    return 0;
  };
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be byte type.", func_name, file, line);
    return 0;
  }
...
int16_t SPVM_API_get_field_short_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be short type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
int32_t SPVM_API_get_field_int_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be int type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
int64_t SPVM_API_get_field_long_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be long type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
float SPVM_API_get_field_float_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be float type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
double SPVM_API_get_field_double_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be double type or smaller numeric type.", func_name, file, line);
    return 0;
  }
...
SPVM_OBJECT* SPVM_API_get_field_object_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be an object type.", func_name, file, line);
    return 0;
  }
...
SPVM_OBJECT* SPVM_API_get_field_object_defined_and_has_pointer_by_name(SPVM_ENV* env, SPVM_VALUE* stack, void* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file_name, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (!obj_field) {
    *error_id = SPVM_API_die_v2(env, stack, "%s field must be defined.", func_name, file_name, line, field_name);
    return obj_field;
  }
  ...
  if (!field) {
    *error_id = SPVM_API_die_v2(env, stack, "The pointer of %s field must be defined.", func_name, file_name, line, field_name);
  }
...
const char* SPVM_API_get_field_string_chars_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  SPVM_RUNTIME_FIELD* field = SPVM_API_get_field(env, stack, object, field_name);
  if (!field) {
    *error_id = SPVM_API_die_v2(env, stack, "%s field is not found.", func_name, file, line, field_name);
    return NULL;
  };
...
void SPVM_API_set_field_byte_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int8_t value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be byte or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_field_short_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int16_t value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be short or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_field_int_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int32_t value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be int or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_field_long_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, int64_t value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be long or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_field_float_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, float value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be float or larger numeric type.", func_name, file, line);
    return;
  }
}
...
void SPVM_API_set_field_double_by_name(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, const char* field_name, double value, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  ...
  *error_id = 0;
  ...
  if (is_invalid_type) {
    *error_id = SPVM_API_die_v2(env, stack, "The type of the field must be double type.", func_name, file, line);
    return;
  }
}
        ...
        if (SPVM_API_is_mulnum_array(env, stack, object)) {
          ...
          for (int32_t field_index = 0; field_index < fields_length; field_index++) {
            ...
            switch (field_basic_type_id) {
              case SPVM_NATIVE_C_BASIC_TYPE_ID_BYTE: {
                int8_t* element = &((int8_t*)(GET_DATA_ADDRESS(env, stack, object)))[array_index * fields_length];
              ...
              case SPVM_NATIVE_C_BASIC_TYPE_ID_SHORT: {
                int16_t* element = &((int16_t*)(GET_DATA_ADDRESS(env, stack, object)))[array_index * fields_length];
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%d", element[field_index]);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_INT: {
                int32_t* element = &((int32_t*)(GET_DATA_ADDRESS(env, stack, object)))[array_index * fields_length];
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%d", element[field_index]);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_LONG: {
                int64_t* element = &((int64_t*)(GET_DATA_ADDRESS(env, stack, object)))[array_index * fields_length];
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%lld", (long long int)element[field_index]);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT: {
                float* element = &((float*)(GET_DATA_ADDRESS(env, stack, object)))[array_index * fields_length];
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%g", element[field_index]);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE: {
                double* element = &((double*)(GET_DATA_ADDRESS(env, stack, object)))[array_index * fields_length];
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%g", element[field_index]);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
          ...
          switch (object_basic_type->id) {
            case SPVM_NATIVE_C_BASIC_TYPE_ID_BYTE: {
              int8_t element = ((int8_t*)(GET_DATA_ADDRESS(env, stack, object)))[array_index];
              snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%d", element);
              SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
              break;
            }
            case SPVM_NATIVE_C_BASIC_TYPE_ID_SHORT: {
              int16_t element = ((int16_t*)(GET_DATA_ADDRESS(env, stack, object)))[array_index];
              snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%d", element);
              SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
              break;
            }
            case SPVM_NATIVE_C_BASIC_TYPE_ID_INT: {
              int32_t element = ((int32_t*)(GET_DATA_ADDRESS(env, stack, object)))[array_index];
              snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%d", element);
              SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
              break;
            }
            case SPVM_NATIVE_C_BASIC_TYPE_ID_LONG: {
              int64_t element = ((int64_t*)(GET_DATA_ADDRESS(env, stack, object)))[array_index];
              snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%lld", (long long int)element);
              SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
              break;
            }
            case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT: {
              float element = ((float*)(GET_DATA_ADDRESS(env, stack, object)))[array_index];
              snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%g", element);
              SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
              break;
            }
            case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE: {
              double element = ((double*)(GET_DATA_ADDRESS(env, stack, object)))[array_index];
              snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%g", element);
              SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
              break;
            }
          ...
          SPVM_OBJECT* element = (((SPVM_OBJECT**)(GET_DATA_ADDRESS(env, stack, object)))[array_index]);
      ...
      if (exists) {
        ...
        for (int32_t field_index = 0; field_index < fields_length; field_index++) {
          ...
          if (field_type_dimension == 0 && field_basic_type_id >= SPVM_NATIVE_C_BASIC_TYPE_ID_BYTE && field_basic_type_id <= SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE) {
            switch (field_basic_type_id) {
              case SPVM_NATIVE_C_BASIC_TYPE_ID_BYTE: {
                int8_t field_value = *(int8_t*)(GET_DATA_ADDRESS(env, stack, object) + field_offset);
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%d", field_value);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_SHORT: {
                int16_t field_value = *(int16_t*)(GET_DATA_ADDRESS(env, stack, object) + field_offset);
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%d", field_value);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_INT: {
                int32_t field_value = *(int32_t*)(GET_DATA_ADDRESS(env, stack, object) + field_offset);
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%d", field_value);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_LONG: {
                int64_t field_value = *(int64_t*)(GET_DATA_ADDRESS(env, stack, object) + field_offset);
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%lld", (long long int)field_value);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT: {
                float field_value = *(float*)(GET_DATA_ADDRESS(env, stack, object) + field_offset);
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%g", field_value);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
              case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE: {
                double field_value = *(double*)(GET_DATA_ADDRESS(env, stack, object) + field_offset);
                snprintf(tmp_buffer, SPVM_NATIVE_C_STACK_TMP_BUFFER_SIZE, "%g", field_value);
                SPVM_STRING_BUFFER_add(string_buffer, (const char*)tmp_buffer);
                break;
              }
            ...
            SPVM_OBJECT* field_value = *(SPVM_OBJECT**)(GET_DATA_ADDRESS(env, stack, object) + field_offset);
...
SPVM_OBJECT* SPVM_API_new_object_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_RUNTIME_BASIC_TYPE* basic_type) {
  ...
  size_t data_size = (size_t)basic_type->fields_size +(sizeof(uint8_t) * exists_byte_blocks_length);
  
  SPVM_OBJECT* object = SPVM_API_new_object_common(env, stack, data_size, basic_type, 0, fields_length, 0);
...
SPVM_OBJECT* SPVM_API_new_string_nolen_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, const char* bytes) {
  ...
  if (object) {
    if (bytes != NULL && length > 0) {
      memcpy((void*)(GET_DATA_ADDRESS(env, stack, object)), (char*)bytes, length);
    }
  }
...
SPVM_OBJECT* SPVM_API_new_string_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, const char* bytes, int32_t length) {
  ...
  size_t data_size = (size_t)sizeof(char) * (length + 1);
  
  SPVM_RUNTIME_BASIC_TYPE* basic_type = SPVM_API_get_basic_type_by_id(env, stack, SPVM_NATIVE_C_BASIC_TYPE_ID_STRING);
  
  SPVM_OBJECT* object = SPVM_API_new_object_common(env, stack, data_size, basic_type, 0, length, 0);
...
SPVM_OBJECT* SPVM_API_new_byte_array_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, int32_t length) {
  ...
  size_t data_size = (size_t)sizeof(int8_t) * (length + 1);
...
SPVM_OBJECT* SPVM_API_new_short_array_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, int32_t length) {
  ...
  size_t data_size = (size_t)sizeof(int16_t) * (length + 1);
...
SPVM_OBJECT* SPVM_API_new_int_array_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, int32_t length) {
  ...
  size_t data_size = (size_t)sizeof(int32_t) * (length + 1);
...
SPVM_OBJECT* SPVM_API_new_long_array_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, int32_t length) {
  ...
  size_t data_size = (size_t)sizeof(int64_t) * (length + 1);
...
SPVM_OBJECT* SPVM_API_new_float_array_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, int32_t length) {
  ...
  size_t data_size = (size_t)sizeof(float) * (length + 1);
...
SPVM_OBJECT* SPVM_API_new_double_array_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, int32_t length) {
  ...
  size_t data_size = (size_t)sizeof(double) * (length + 1);
...
SPVM_OBJECT* SPVM_API_new_mulnum_array_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_RUNTIME_BASIC_TYPE* basic_type, int32_t length) {
  ...
  size_t data_size = (size_t)unit_size * fields_length * (length + 1);
...
SPVM_OBJECT* SPVM_API_new_array_proto_no_mortal(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* array, int32_t length) {
  ...
  size_t data_size = (size_t)element_size * (length + 1);
  
  SPVM_RUNTIME_BASIC_TYPE* array_basic_type = SPVM_API_get_object_basic_type(env, stack, array);
  SPVM_OBJECT* new_array = SPVM_API_new_object_common(env, stack, data_size, array_basic_type, array->type_dimension, length, 0);
...
int32_t SPVM_API_set_length(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, int32_t length) {
  ...
  if (!object) {
    return SPVM_API_die_v2(env, stack, "set_length failed: the object must be defined.", __func__, FILE_NAME, __LINE__);
  }
  
  void* basic_type = object->basic_type;
  int32_t type_dimension = object->type_dimension;
  if (!SPVM_API_is_dynamic_data_type(env, stack, basic_type, type_dimension, 0)) {
    return SPVM_API_die_v2(env, stack, "set_length failed: the type of the object must be string type or an array type.", __func__, FILE_NAME, __LINE__);
  }
  
  int32_t flag = object->flag;
  if (flag & SPVM_OBJECT_C_FLAG_IS_FIXED_LENGTH) {
    return SPVM_API_die_v2(env, stack, "set_length failed: the object must not be a fixed length object.", __func__, FILE_NAME, __LINE__);
  }
  if (flag & SPVM_OBJECT_C_FLAG_IS_READ_ONLY) {
    return SPVM_API_die_v2(env, stack, "set_capacity failed: the object must not be a read-only object.", __func__, FILE_NAME, __LINE__);
  }
  
  if (!(length >= 0)) {
    return SPVM_API_die_v2(env, stack, "set_length failed: the length must be a non-negative number.", __func__, FILE_NAME, __LINE__);
  }
...
int32_t SPVM_API_set_capacity(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, int32_t capacity) {
  ...
  if (!object) {
    return SPVM_API_die_v2(env, stack, "set_capacity failed: the object must be defined.", __func__, FILE_NAME, __LINE__);
  }
  ...
  if (!SPVM_API_is_dynamic_data_type(env, stack, basic_type, type_dimension, 0)) {
    return SPVM_API_die_v2(env, stack, "set_capacity failed: the type of the object must be string type or an array type.", __func__, FILE_NAME, __LINE__);
  }
  
  int32_t flag = object->flag;
  if (flag & SPVM_OBJECT_C_FLAG_IS_FIXED_LENGTH) {
    return SPVM_API_die_v2(env, stack, "set_capacity failed: the object must not be a fixed length object.", __func__, FILE_NAME, __LINE__);
  }
  if (flag & SPVM_OBJECT_C_FLAG_IS_READ_ONLY) {
    return SPVM_API_die_v2(env, stack, "set_capacity failed: the object must not be a read-only object.", __func__, FILE_NAME, __LINE__);
  }
  ...
  if (capacity < object->length + 1) {
    return SPVM_API_die_v2(env, stack, "set_capacity failed: too small capacity.", __func__, FILE_NAME, __LINE__);
  }
  
  int32_t elem_size = SPVM_API_get_elem_size(env, stack, object);
  char* new_data = SPVM_API_new_memory_block(env, stack, elem_size * capacity);
  if (!new_data) {
    return SPVM_API_die_v2(env, stack, "set_capacity failed: cannot allocate memory.", __func__, FILE_NAME, __LINE__);
  }
  char* data = (char*)env->get_chars(env, stack, object);
...
int8_t* SPVM_API_get_elems_byte(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object) {
  ...
  return (int8_t*)(GET_DATA_ADDRESS(env, stack, object));
}
...
const char* SPVM_API_get_chars(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* string) {
  ...
  return (const char*)(GET_DATA_ADDRESS(env, stack, string));
}
...
int16_t* SPVM_API_get_elems_short(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object) {
  ...
  return (int16_t*)(GET_DATA_ADDRESS(env, stack, object));
}
...
int32_t* SPVM_API_get_elems_int(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object) {
  ...
  return (int32_t*)(GET_DATA_ADDRESS(env, stack, object));
}
...
int64_t* SPVM_API_get_elems_long(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object) {
  ...
  return (int64_t*)(GET_DATA_ADDRESS(env, stack, object));
}
...
float* SPVM_API_get_elems_float(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object) {
  ...
  return (float*)(GET_DATA_ADDRESS(env, stack, object));
}
...
double* SPVM_API_get_elems_double(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object) {
  ...
  return (double*)(GET_DATA_ADDRESS(env, stack, object));
}
...
SPVM_OBJECT* SPVM_API_get_elem_object(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* array, int32_t index) {
  ...
  SPVM_OBJECT* object_maybe_weaken = ((SPVM_OBJECT**)(GET_DATA_ADDRESS(env, stack, array)))[index];
...
int32_t SPVM_API_get_basic_type_id_by_name(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name, int32_t* error_id, const char* func_name, const char* file, int32_t line) {
  *error_id = 0;
  ...
  if (basic_type_id < 0) {
    *error_id = SPVM_API_die_v2(env, stack, "The %s basic type is not found.", func_name, file, line, basic_type_name);
  };
  return basic_type_id;
}
...
SPVM_OBJECT* SPVM_API_new_object_common(SPVM_ENV* env, SPVM_VALUE* stack, size_t data_size, SPVM_RUNTIME_BASIC_TYPE* basic_type, int32_t type_dimension, int32_t length, int32_t flag) {
  ...
  // Class
    ...
    object = SPVM_API_new_memory_block(env, stack, sizeof(SPVM_OBJECT) + data_size);
    if (object) {
    ...
    if (!do_dec_ref_count_only) {
      ...
      if (SPVM_API_is_object_array(env, stack, released_object)) {
        ...
        for (int32_t index = 0; index < length; index++) {
          SPVM_OBJECT** ref = &(((SPVM_OBJECT**)(GET_DATA_ADDRESS(env, stack, released_object)))[index]);
          SPVM_API_assign_object(env, stack, ref, NULL);
        }
      }
        ...
        if (released_object_basic_type_category == SPVM_NATIVE_C_BASIC_TYPE_CATEGORY_CLASS) {
          ...
          for (int32_t field_index = 0; field_index < released_object_fields_length; field_index++) {
            ...
            if (field_type_is_released_object) {
              SPVM_OBJECT** ref = (SPVM_OBJECT**)(GET_DATA_ADDRESS(env, stack, released_object) + field->offset);
              SPVM_API_assign_object(env, stack, ref, NULL);
            }
          }
        }
...
int32_t SPVM_API_check_bootstrap_method(SPVM_ENV* env, SPVM_VALUE* stack, const char* basic_type_name) {
  ...
  if (method) {
    ...
    if (is_class_method) {
      ...
      if (!(args_length == 0)) {
        error_id = SPVM_API_die_v2(env, stack, "The length of the arguments of %s#main method must be 0.", __func__, FILE_NAME, __LINE__, basic_type_name);
      }
      else {
        ...
        if (!(strcmp(return_basic_type_name, "void") == 0)) {
          error_id = SPVM_API_die_v2(env, stack, "The return type of %s#main method must be the void type.", __func__, FILE_NAME, __LINE__, basic_type_name);
        }
      }
    }
    else {
      error_id = SPVM_API_die_v2(env, stack, "%s#main method must be a class method.", __func__, FILE_NAME, __LINE__, basic_type_name);
    }
  }
  else {
    error_id = SPVM_API_die_v2(env, stack, "%s#main method must be defined.", __func__, FILE_NAME, __LINE__, basic_type_name);
  }
...
int32_t SPVM_API_get_bool_object_value(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* bool_object) {
  ...
  int32_t value = *(int8_t*)(GET_DATA_ADDRESS(env, stack, bool_object));
...
int32_t SPVM_API_get_byte_object_value(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* byte_object) {
  ...
  int32_t value = *(int8_t*)(GET_DATA_ADDRESS(env, stack, byte_object));
...
int32_t SPVM_API_get_short_object_value(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* short_object) {
  ...
  int32_t value = *(int16_t*)(GET_DATA_ADDRESS(env, stack, short_object));
...
int32_t SPVM_API_get_int_object_value(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* int_object) {
  ...
  int32_t value = *(int32_t*)(GET_DATA_ADDRESS(env, stack, int_object));
...
int64_t SPVM_API_get_long_object_value(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* long_object) {
  ...
  int64_t value = *(int64_t*)(GET_DATA_ADDRESS(env, stack, long_object));
...
float SPVM_API_get_float_object_value(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* float_object) {
  ...
  float value = *(float*)(GET_DATA_ADDRESS(env, stack, float_object));
...
int8_t SPVM_API_numeric_object_to_byte(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, int32_t* error_id) {
  ...
  *error_id = 0;
  ...
  if (!is_numeric_object_type) {
    *error_id = SPVM_API_die_v2(env, stack, "Type conversion failed. The type of the object must be a numeric object type.", __func__, FILE_NAME, __LINE__);
    return 0;
  }
...
int16_t SPVM_API_numeric_object_to_short(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, int32_t* error_id) {
  ...
  *error_id = 0;
  ...
  switch (object->basic_type->id) {
    ...
    case SPVM_NATIVE_C_BASIC_TYPE_ID_SHORT_CLASS : {
      int16_t** fields = (int16_t**)object->data;
      out = (int16_t)*(int16_t*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_INT_CLASS : {
      int32_t** fields = (int32_t**)object->data;
      out = (int16_t)*(int32_t*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_LONG_CLASS : {
      int64_t** fields = (int64_t**)object->data;
      out = (int16_t)*(int64_t*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT_CLASS : {
      float** fields = (float**)object->data;
      out = (int16_t)*(float*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE_CLASS : {
      double** fields = (double**)object->data;
      out = (int16_t)*(double*)&fields[0];
      break;
    }
    default : {
      assert(0);
...
int32_t SPVM_API_numeric_object_to_int(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, int32_t* error_id) {
  ...
  *error_id = 0;
  ...
  switch (object->basic_type->id) {
    ...
    case SPVM_NATIVE_C_BASIC_TYPE_ID_INT_CLASS : {
      int32_t** fields = (int32_t**)object->data;
      out = (int32_t)*(int32_t*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_LONG_CLASS : {
      int64_t** fields = (int64_t**)object->data;
      out = (int32_t)*(int64_t*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT_CLASS : {
      float** fields = (float**)object->data;
      out = (int32_t)*(float*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE_CLASS : {
      double** fields = (double**)object->data;
      out = (int32_t)*(double*)&fields[0];
      break;
    }
    default : {
      assert(0);
...
int64_t SPVM_API_numeric_object_to_long(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, int32_t* error_id) {
  ...
  *error_id = 0;
  ...
  switch (object->basic_type->id) {
    ...
    case SPVM_NATIVE_C_BASIC_TYPE_ID_LONG_CLASS : {
      int64_t** fields = (int64_t**)object->data;
      out = (int64_t)*(int64_t*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT_CLASS : {
      float** fields = (float**)object->data;
      out = (int64_t)*(float*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE_CLASS : {
      double** fields = (double**)object->data;
      out = (int64_t)*(double*)&fields[0];
      break;
    }
    default : {
      assert(0);
...
float SPVM_API_numeric_object_to_float(SPVM_ENV* env, SPVM_VALUE* stack, SPVM_OBJECT* object, int32_t* error_id) {
  ...
  *error_id = 0;
  ...
  switch (object->basic_type->id) {
    ...
    case SPVM_NATIVE_C_BASIC_TYPE_ID_FLOAT_CLASS : {
      float** fields = (float**)object->data;
      out = (float)*(float*)&fields[0];
      break;
    }
    case SPVM_NATIVE_C_BASIC_TYPE_ID_DOUBLE_CLASS : {
      double** fields = (double**)object->data;
      out = (float)*(double*)&fields[0];
      break;
    }
    default : {
      assert(0);
...
/* File scope helper for portability */
static int32_t SPVM_API_strnlen(const char *s, int32_t maxlen) {
  if (!s) return 0;
  int32_t len = 0;
