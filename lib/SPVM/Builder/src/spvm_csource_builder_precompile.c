...
void SPVM_CSOURCE_BUILDER_PRECOMPILE_add_var_value(SPVM_ENV* env, SPVM_STRING_BUFFER* string_buffer, int32_t ctype_id, int32_t index, int32_t field_offset) {
...
void SPVM_CSOURCE_BUILDER_PRECOMPILE_add_var_field_offset(SPVM_ENV* env, SPVM_STRING_BUFFER* string_buffer, int32_t ctype_id, int32_t index, int32_t field_offset) {
  if (ctype_id == SPVM_CSOURCE_BUILDER_PRECOMPILE_C_CTYPE_ID_ADDRESS) {
    SPVM_STRING_BUFFER_add(string_buffer, "address_vars[");
    SPVM_STRING_BUFFER_add_int(string_buffer, index + field_offset);
    SPVM_STRING_BUFFER_add(string_buffer, "]");
  }
  else {
    SPVM_STRING_BUFFER_add(string_buffer, "numeric_vars");
...
void SPVM_CSOURCE_BUILDER_PRECOMPILE_add_operand_value(SPVM_ENV* env, SPVM_STRING_BUFFER* string_buffer, int32_t ctype_id, int32_t var_index, int32_t field_offset) {
  SPVM_CSOURCE_BUILDER_PRECOMPILE_add_var_value(env, string_buffer, ctype_id, var_index, field_offset);
}
...
void SPVM_CSOURCE_BUILDER_PRECOMPILE_add_value_t_deref(SPVM_ENV* env, SPVM_STRING_BUFFER* string_buffer, int32_t element_ctype_id, int32_t out_var_id, int32_t ref_var_id, int32_t field_length) {
  ...
  for (int32_t field_offset = 0; field_offset < field_length; field_offset++) {
    SPVM_STRING_BUFFER_add(string_buffer,  "    ");
    SPVM_CSOURCE_BUILDER_PRECOMPILE_add_var_value(env, string_buffer, element_ctype_id, out_var_id, field_offset);
    SPVM_STRING_BUFFER_add(string_buffer,  " = ");
    SPVM_STRING_BUFFER_add(string_buffer, "*(");
    SPVM_STRING_BUFFER_add(string_buffer, (char*)SPVM_CSOURCE_BUILDER_PRECOMPILE_get_ctype_name(env, element_ctype_id));
    SPVM_STRING_BUFFER_add(string_buffer, "*)&value_ref[");
    ...
    for (int32_t my_index = 0; my_index < sub->my_ids_length; my_index++) {
      ...
      // Value type
        ...
        for (int32_t field_offset = 0; field_offset < runtime_my_package->fields->length; field_offset++) {
          SPVM_STRING_BUFFER_add(string_buffer, "0");
          if (field_offset != runtime_my_package->fields->length - 1) {
            SPVM_STRING_BUFFER_add(string_buffer, ", ");
          }
        }
        SPVM_STRING_BUFFER_add(string_buffer, "};\n");
