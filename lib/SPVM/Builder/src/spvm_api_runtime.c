...
SPVM_API_RUNTIME* SPVM_API_RUNTIME_new_api() {
  ...
  void* env_runtime_init[]  = {
    ...
    SPVM_API_RUNTIME_build_precompile_module_source_v2,
    SPVM_API_RUNTIME_build_precompile_method_source_v2,
  };
...
void SPVM_API_RUNTIME_build_precompile_module_source_v2(SPVM_RUNTIME* runtime, SPVM_STRING_BUFFER* string_buffer, SPVM_RUNTIME_BASIC_TYPE* module_basic_type) {
  SPVM_PRECOMPILE* precompile = SPVM_PRECOMPILE_new(precompile);
  SPVM_PRECOMPILE_set_runtime(precompile, runtime);
  SPVM_PRECOMPILE_build_module_source(precompile, string_buffer, module_basic_type->name);
  SPVM_PRECOMPILE_free(precompile);
}
...
void SPVM_API_RUNTIME_build_precompile_method_source_v2(SPVM_RUNTIME* runtime, SPVM_STRING_BUFFER* string_buffer, SPVM_RUNTIME_METHOD* method) {
  SPVM_PRECOMPILE* precompile = SPVM_PRECOMPILE_new(precompile);
  SPVM_PRECOMPILE_set_runtime(precompile, runtime);
  SPVM_PRECOMPILE_build_method_source(precompile, string_buffer, method->current_basic_type->name, method->name);
  SPVM_PRECOMPILE_free(precompile);
}
