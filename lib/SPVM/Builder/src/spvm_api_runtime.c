...
int32_t SPVM_API_RUNTIME_get_basic_type_anon_basic_types_base_address_id(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* basic_type) {
  ...
  int32_t anon_basic_types_base_address_id = basic_type->anon_basic_types_base_address_id;
  
  return anon_basic_types_base_address_id;
}
...
int32_t SPVM_API_RUNTIME_get_basic_type_fields_base_address_id(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* basic_type) {
  ...
  int32_t fields_base_address_id = basic_type->fields_base_address_id;
  
  return fields_base_address_id;
}
...
int32_t SPVM_API_RUNTIME_get_basic_type_methods_base_address_id(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* basic_type) {
  ...
  int32_t methods_base_address_id = basic_type->methods_base_address_id;
  
  return methods_base_address_id;
}
...
int32_t SPVM_API_RUNTIME_get_basic_type_class_vars_base_address_id(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* basic_type) {
  ...
  int32_t class_vars_base_address_id = basic_type->class_vars_base_address_id;
  
  return class_vars_base_address_id;
}
...
SPVM_RUNTIME_CLASS_VAR* SPVM_API_RUNTIME_get_class_var(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* basic_type, int32_t class_var_index) {
  ...
  SPVM_RUNTIME_CLASS_VAR* class_var = &runtime->class_vars[basic_type->class_vars_base_address_id + class_var_index];
...
SPVM_RUNTIME_CLASS_VAR* SPVM_API_RUNTIME_get_class_var_by_name(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* basic_type, const char* class_var_name) {
  ...
  if (basic_type->class_vars_length > 0) {
    for (int32_t class_var_address_id = basic_type->class_vars_base_address_id; class_var_address_id <  basic_type->class_vars_base_address_id + basic_type->class_vars_length; class_var_address_id++) {
...
SPVM_RUNTIME_FIELD* SPVM_API_RUNTIME_get_field(SPVM_RUNTIME* runtime, SPVM_RUNTIME_BASIC_TYPE* basic_type, int32_t field_index) {
  ...
  SPVM_RUNTIME_FIELD* field = &runtime->fields[basic_type->fields_base_address_id + field_index];
...
int32_t SPVM_API_RUNTIME_get_method_address_id_by_name(SPVM_RUNTIME* runtime, const char* basic_type_name, const char* method_name) {
  ...
  if (basic_type) {
    SPVM_RUNTIME_METHOD* method = SPVM_API_RUNTIME_get_method_by_name(runtime, basic_type, method_name);
...
int32_t SPVM_API_RUNTIME_get_field_address_id_by_index(SPVM_RUNTIME* runtime, int32_t basic_type_id, int32_t field_index) {
  ...
  if (basic_type) {
    if (field_index >= 0 && field_index < basic_type->fields_length) {
      field_address_id = basic_type->fields_base_address_id + field_index;
    }
  }
...
int32_t SPVM_API_RUNTIME_get_method_opcodes_base_address_id(SPVM_RUNTIME* runtime, SPVM_RUNTIME_METHOD* method) {
  ...
  int32_t opcodes_base_address_id = method->opcodes_base_address_id;
  
  return opcodes_base_address_id;
}
...
int32_t SPVM_API_RUNTIME_get_method_args_base_address_id(SPVM_RUNTIME* runtime, SPVM_RUNTIME_METHOD* method) {
  ...
  int32_t args_base_address_id = method->args_base_address_id;
...
int32_t SPVM_API_RUNTIME_has_interface_by_id(SPVM_RUNTIME* runtime, int32_t basic_type_id, int32_t interface_basic_type_id) {
  ...
  SPVM_RUNTIME_METHOD* method_interface = SPVM_API_RUNTIME_get_method_by_address_id(runtime, interface_basic_type->required_method_address_id);
...
int32_t SPVM_API_RUNTIME_is_super_by_id(SPVM_RUNTIME* runtime, int32_t super_basic_type_id, int32_t child_basic_type_id) {
  ...
  SPVM_RUNTIME_BASIC_TYPE* super_basic_type = SPVM_API_RUNTIME_get_basic_type_by_id(runtime, super_basic_type_id);
  SPVM_RUNTIME_BASIC_TYPE* child_basic_type = SPVM_API_RUNTIME_get_basic_type_by_id(runtime, child_basic_type_id);
...
int32_t SPVM_API_RUNTIME_is_object_type(SPVM_RUNTIME* runtime, int32_t basic_type_id, int32_t type_dimension, int32_t flag) {
  ...
  if (type_dimension == 0) {
    int32_t basic_type_category = SPVM_API_RUNTIME_get_basic_type_category(runtime, SPVM_API_RUNTIME_get_basic_type_by_id(runtime, basic_type_id));
...
int32_t SPVM_API_RUNTIME_can_assign(SPVM_RUNTIME* runtime, int32_t dist_basic_type_id, int32_t dist_type_dimension, int32_t dist_type_flag, int32_t src_basic_type_id, int32_t src_type_dimension, int32_t src_type_flag) {
  ...
  int32_t dist_basic_type_category = SPVM_API_RUNTIME_get_basic_type_category(runtime, SPVM_API_RUNTIME_get_basic_type_by_id(runtime, dist_basic_type_id));
  int32_t src_basic_type_category = SPVM_API_RUNTIME_get_basic_type_category(runtime, SPVM_API_RUNTIME_get_basic_type_by_id(runtime, src_basic_type_id));
