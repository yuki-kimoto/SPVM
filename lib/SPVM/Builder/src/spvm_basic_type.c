...
SPVM_BASIC_TYPE* SPVM_BASIC_TYPE_new(SPVM_COMPILER* compiler) {
  ...
  basic_type->init_statements = SPVM_LIST_new_list_permanent(compiler->current_each_compile_allocator, 0);
