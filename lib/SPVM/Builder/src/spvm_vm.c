  ...
  while (1) {
    ...
    switch (opcode_id) {
      ...
      case SPVM_OPCODE_C_ID_GET_FIELD_BYTE: {
        ...
        SPVM_RUNTIME_FIELD* field = SPVM_API_RUNTIME_get_field(env->runtime, field_current_basic_type, field_index);
        int32_t field_offset = SPVM_API_RUNTIME_get_field_offset(env->runtime, field);
      ...
      case SPVM_OPCODE_C_ID_GET_CLASS_VAR_BYTE: {
        ...
        SPVM_RUNTIME_CLASS_VAR* class_var = SPVM_API_RUNTIME_get_class_var(env->runtime, class_var_current_basic_type, class_var_index);
      ...
      case SPVM_OPCODE_C_ID_CALL_CLASS_METHOD: {
        ...
        SPVM_RUNTIME_METHOD* method = SPVM_API_RUNTIME_get_method(env->runtime, invocant_decl_basic_type, decl_method_index);
