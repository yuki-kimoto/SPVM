  ...
  while (1) {
    ...
    switch (opcode_id) {
      ...
      case SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_BYTE: {
        void* object = object_vars[opcode->operand1];
        SPVM_IMPLEMENT_TYPE_CONVERSION_NUMERIC_OBJECT_TO_BYTE(env, stack, &byte_vars[opcode->operand0], object, &error_id);
        break;
      }
      case SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_SHORT: {
        void* object = object_vars[opcode->operand1];
        SPVM_IMPLEMENT_TYPE_CONVERSION_NUMERIC_OBJECT_TO_SHORT(env, stack, &short_vars[opcode->operand0], object, &error_id);
        break;
      }
      case SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_INT: {
        void* object = object_vars[opcode->operand1];
        SPVM_IMPLEMENT_TYPE_CONVERSION_NUMERIC_OBJECT_TO_INT(env, stack, &int_vars[opcode->operand0], object, &error_id);
        break;
      }
      case SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_LONG: {
        void* object = object_vars[opcode->operand1];
        SPVM_IMPLEMENT_TYPE_CONVERSION_NUMERIC_OBJECT_TO_LONG(env, stack, &long_vars[opcode->operand0], object, &error_id);
        break;
      }
      case SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_FLOAT: {
        void* object = object_vars[opcode->operand1];
        SPVM_IMPLEMENT_TYPE_CONVERSION_NUMERIC_OBJECT_TO_FLOAT(env, stack, &float_vars[opcode->operand0], object, &error_id);
        break;
      }
      case SPVM_OPCODE_C_ID_TYPE_CONVERSION_NUMERIC_OBJECT_TO_DOUBLE: {
        void* object = object_vars[opcode->operand1];
        SPVM_IMPLEMENT_TYPE_CONVERSION_NUMERIC_OBJECT_TO_DOUBLE(env, stack, &double_vars[opcode->operand0], object, &error_id);
        break;
      }
