  ...
  while (1) {
    ...
    switch (opcode_id) {
      ...
      case SPVM_OPCODE_C_ID_NEW_STRING: {
        ...
        SPVM_IMPLEMENT_NEW_STRING(env, stack, &object_vars[opcode->operand0], constant_string_value, constant_string_length, &error_id, object_ref_count_offset);
        break;
      }
      ...
      case SPVM_OPCODE_C_ID_GET_FIELD_BYTE: {
        ...
        SPVM_RUNTIME_FIELD* field = SPVM_API_RUNTIME_get_field_by_index(env->runtime, field_current_basic_type, field_index);
      ...
      case SPVM_OPCODE_C_ID_GET_CLASS_VAR_BYTE: {
        ...
        SPVM_RUNTIME_CLASS_VAR* class_var = SPVM_API_RUNTIME_get_class_var_by_index(env->runtime, class_var_current_basic_type, class_var_index);
      ...
      case SPVM_OPCODE_C_ID_CAN: {
        ...
        SPVM_RUNTIME_METHOD* method = SPVM_API_RUNTIME_get_method_by_index(runtime, invocant_decl_basic_type, decl_method_index);
      ...
      case SPVM_OPCODE_C_ID_CALL_CLASS_METHOD: {
        ...
        SPVM_RUNTIME_METHOD* method = SPVM_API_RUNTIME_get_method_by_index(env->runtime, invocant_decl_basic_type, decl_method_index);
