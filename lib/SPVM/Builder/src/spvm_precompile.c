...
void SPVM_PRECOMPILE_build_method_source(SPVM_PRECOMPILE* precompile, SPVM_STRING_BUFFER* string_buffer, const char* current_class_name, const char* current_method_name) {
  ...
  SPVM_STRING_BUFFER_add(string_buffer, "  int32_t error_code_v2 = 1;\n");
  ...
  while (opcode_index < opcodes_length) {
    ...
    switch (opcode_id) {
      ...
      case SPVM_OPCODE_C_ID_SET_ERROR_CODE_V2: {
        SPVM_STRING_BUFFER_add(string_buffer, "  SPVM_IMPLEMENT_SET_ERROR_CODE_V2(env, stack, ");
        SPVM_PRECOMPILE_add_operand_address(precompile, string_buffer, SPVM_PRECOMPILE_C_CTYPE_ID_INT, opcode->operand0);
        SPVM_STRING_BUFFER_add(string_buffer, ", &error_code_v2, ");
        SPVM_PRECOMPILE_add_operand(precompile, string_buffer, SPVM_PRECOMPILE_C_CTYPE_ID_INT, opcode->operand1);
        SPVM_STRING_BUFFER_add(string_buffer, ", &error);");
        break;
      }
      ...
      case SPVM_OPCODE_C_ID_CLEAR_EVAL_ERROR_V2: {
        SPVM_STRING_BUFFER_add(string_buffer, "  SPVM_IMPLEMENT_CLEAR_EVAL_ERROR(eval_error_v2);\n");
        break;
      }
      ...
      case SPVM_OPCODE_C_ID_CALL_INSTANCE_METHOD: {
        ...
        SPVM_STRING_BUFFER_add(string_buffer, "  SPVM_IMPLEMENT_CALL_INSTANCE_METHOD(env, stack, object, class_name, method_name, args_stack_length, &error, tmp_buffer, sizeof(tmp_buffer));\n");
