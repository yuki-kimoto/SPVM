...
void SPVM_CSOURCE_BUILDER_EXE_build_exe_csource(SPVM_ENV* env, SPVM_STRING_BUFFER* string_buffer, SPVM_PORTABLE* portable, const char* package_name) {
  ...
  // Create runtime env
  SPVM_STRING_BUFFER_add(string_buffer, "  SPVM_ENV* env = SPVM_RUNTIME_API_build_runtime_env(portable);\n");
  ...
  SPVM_STRING_BUFFER_add(string_buffer, "  SPVM_RUNTIME_API_free_runtime(env);\n");
