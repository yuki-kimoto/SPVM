...
SPVM_OP* SPVM_OP_build_unary_op_var(SPVM_COMPILER* compiler, SPVM_OP* op_unary, SPVM_OP* op_operand) {
  ...
  const char* op_name = op_unary->name;
...
SPVM_OP* SPVM_OP_build_logical_and(SPVM_COMPILER* compiler, SPVM_OP* op_logical_and, SPVM_OP* op_left_operand, SPVM_OP* op_right_operand) {
  ...
  op_logical_and = SPVM_OP_build_binary_op(compiler, op_logical_and, op_left_operand, op_right_operand);
...
SPVM_OP* SPVM_OP_build_logical_not(SPVM_COMPILER* compiler, SPVM_OP* op_logical_not, SPVM_OP* op_operand) {
  ...
  op_logical_not = SPVM_OP_build_unary_op(compiler, op_logical_not, op_operand);
...
SPVM_OP* SPVM_OP_build_defined_or(SPVM_COMPILER* compiler, SPVM_OP* op_defined_or, SPVM_OP* op_left_operand, SPVM_OP* op_right_operand) {
  ...
  op_defined_or = SPVM_OP_build_binary_op(compiler, op_defined_or, op_left_operand, op_right_operand);
  
  return op_defined_or;
}
...
SPVM_OP* SPVM_OP_new_op_element_type(SPVM_COMPILER* compiler, const char* file, int32_t line) {
  ...
  op_type->uv.type->is_generic_element_type = 1;
...
SPVM_OP* SPVM_OP_new_op_element_array_type(SPVM_COMPILER* compiler, const char* file, int32_t line) {
  ...
  op_type->uv.type->is_generic_element_array_type = 1;
