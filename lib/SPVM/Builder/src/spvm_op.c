...
SPVM_OP* SPVM_OP_build_class(SPVM_COMPILER* compiler, SPVM_OP* op_class, SPVM_OP* op_name_class, SPVM_OP* op_block, SPVM_OP* op_list_attributes, SPVM_OP* op_extends) {
  ...
  if (!class->is_anon) {
    ...
    if (strcmp(class_name, compiler->cur_rel_file_class_name) != 0) {
      ...
      const char* not_found_class_class_name = SPVM_HASH_get(compiler->not_found_class_name_symtable, class_name, strlen(class_name));
...
SPVM_OP* SPVM_OP_build_call_method(SPVM_COMPILER* compiler, SPVM_OP* op_call_method, SPVM_OP* op_invocant, SPVM_OP* op_name_method, SPVM_OP* op_list_operands) {
  ...
  if (op_invocant->id == SPVM_OP_C_ID_NAME || op_invocant->id == SPVM_OP_C_ID_CURRENT_CLASS) {
    ...
    if (op_invocant->id == SPVM_OP_C_ID_CURRENT_CLASS) {
