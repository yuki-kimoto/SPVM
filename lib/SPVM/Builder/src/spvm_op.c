    ...
    while ((op_decl = SPVM_OP_sibling(compiler, op_decl))) {
      ...
      // Class var declarations
        ...
        if (class_var->has_getter) {
          ...
          SPVM_OP_build_method(compiler, op_method, op_name_method, op_return_type, op_args, op_list_descriptors, op_block, NULL, NULL, 0, 0, is_precompile);
      ...
      // Field declarations
        ...
        if (field->has_getter) {
          ...
          int32_t is_precompile = 0;
          SPVM_OP_build_method(compiler, op_method, op_name_method, op_return_type, op_args, NULL, op_block, NULL, NULL, 0, 0, is_precompile);
...
SPVM_OP* SPVM_OP_build_method(SPVM_COMPILER* compiler, SPVM_OP* op_method, SPVM_OP* op_name_method, SPVM_OP* op_return_type, SPVM_OP* op_args, SPVM_OP* op_descriptors, SPVM_OP* op_block, SPVM_OP* op_captures, SPVM_OP* op_dot3, int32_t is_init, int32_t is_anon, int32_t is_precompile) {
  ...
  if (is_precompile) {
    method->is_precompile = is_precompile;
  }
...
SPVM_OP* SPVM_OP_build_enumeration_value(SPVM_COMPILER* compiler, SPVM_OP* op_name, SPVM_OP* op_constant) {
  ...
  // Build method
  int32_t is_precompile = 0;
  op_method = SPVM_OP_build_method(compiler, op_method, op_name, op_return_type, NULL, op_list_descriptors, op_block, NULL, NULL, 0, 0, is_precompile);
