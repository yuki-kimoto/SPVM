...
SPVM_OP* SPVM_OP_build_logical_and(SPVM_COMPILER* compiler, SPVM_OP* op_logical_and, SPVM_OP* op_first, SPVM_OP* op_last) {
  ...
  */
  ...
  SPVM_OP* op_bool_true = SPVM_OP_new_op_bool(compiler, op_var_true, op_if1->file, op_if1->line);
  ...
  int32_t no_scope = 1;
  SPVM_OP_build_if_statement(compiler, op_if2, op_last, op_bool_true, op_do_nothing2, no_scope);
...
SPVM_OP* SPVM_OP_build_logical_or(SPVM_COMPILER* compiler, SPVM_OP* op_logical_or, SPVM_OP* op_first, SPVM_OP* op_last) {
  ...
  SPVM_OP* op_bool_true1 = SPVM_OP_new_op_bool(compiler, op_var_true1, op_if1->file, op_if1->line);
  ...
  SPVM_OP* op_bool_true2 = SPVM_OP_new_op_bool(compiler, op_var_true2, op_if1->file, op_if1->line);
