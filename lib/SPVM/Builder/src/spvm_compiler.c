...
SPVM_COMPILER* SPVM_COMPILER_new() {
  ...
  compiler->constant_strings_v2 = SPVM_LIST_new_list_permanent(compiler->allocator, 128);
  compiler->constant_string_symtable_v2 = SPVM_HASH_new_hash_permanent(compiler->allocator, 128);
  compiler->string_pool_v2 = SPVM_STRING_BUFFER_new(compiler->allocator, 8192, SPVM_ALLOCATOR_C_ALLOC_TYPE_PERMANENT);
