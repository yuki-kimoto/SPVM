...
SPVM_COMPILER* SPVM_COMPILER_new() {
  ...
  compiler->strings = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 128);
  compiler->string_symtable = SPVM_ALLOCATOR_new_hash_permanent(compiler->allocator, 128);
  compiler->string_buffer = SPVM_STRING_BUFFER_new(compiler->allocator, 8192, SPVM_ALLOCATOR_C_ALLOC_TYPE_PERMANENT, NULL);
 
  // Eternal information
  compiler->module_dirs = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
  compiler->types = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
  compiler->type_symtable = SPVM_ALLOCATOR_new_hash_permanent(compiler->allocator, 0);
  compiler->basic_types = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
  compiler->basic_type_symtable = SPVM_ALLOCATOR_new_hash_permanent(compiler->allocator, 0);
  compiler->methods = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
  compiler->fields = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
  compiler->classes = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
  compiler->class_symtable = SPVM_ALLOCATOR_new_hash_permanent(compiler->allocator, 0);
  compiler->class_vars = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
  compiler->opcode_array = SPVM_OPCODE_ARRAY_new(compiler);
  compiler->module_source_symtable = SPVM_ALLOCATOR_new_hash_permanent(compiler->allocator, 0);
  compiler->switch_infos = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
...
int32_t SPVM_COMPILER_compile_spvm(SPVM_COMPILER* compiler, const char* class_name) {
  ...
  compiler->error_messages = SPVM_ALLOCATOR_new_list_permanent(compiler->allocator, 0);
  ...
  for (int32_t i = 0; i < compiler->ops->length; i++) {
    ...
    switch(op_id) {
      case SPVM_OP_C_ID_BLOCK: {
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, op->uv.block);
        break;
      }
      case SPVM_OP_C_ID_DESCRIPTOR: {
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, op->uv.descriptor);
        break;
      }
      case SPVM_OP_C_ID_USE: {
        ...
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, use);
        break;
      }
      case SPVM_OP_C_ID_ALLOW: {
        SPVM_ALLOW* allow = op->uv.allow;
        allow->op_type = NULL;
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, allow);
        break;
      }
      case SPVM_OP_C_ID_IMPLEMENT: {
        SPVM_IMPLEMENT* implement = op->uv.implement;
        implement->op_type = NULL;
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, implement);
        break;
      }
      case SPVM_OP_C_ID_CLASS_VAR_ACCESS: {
        ...
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, class_var_access);
        break;
      }
      case SPVM_OP_C_ID_CONSTANT: {
        ...
        constant->type = NULL;
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, constant);
        break;
      }
      case SPVM_OP_C_ID_ARRAY_FIELD_ACCESS: {
        SPVM_ARRAY_FIELD_ACCESS* array_field_access = op->uv.array_field_access;
        array_field_access->field = NULL;
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, array_field_access);
        break;
      }
      case SPVM_OP_C_ID_FIELD_ACCESS: {
        ...
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, field_access);
        break;
      }
      case SPVM_OP_C_ID_CALL_METHOD: {
        ...
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, call_method);
        break;
      }
      case SPVM_OP_C_ID_VAR: {
        ...
        SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, var);
        break;
      }
      case SPVM_OP_C_ID_MY: {
        ...
        if (!my->is_eternal) {
          ...
          my->type = NULL;
          my->var = NULL;
          SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, my);
        }
        break;
      }
    }
    SPVM_ALLOCATOR_free_block_compile_tmp(compiler->allocator, op);
  }
...
SPVM_RUNTIME_INFO* SPVM_COMPILER_build_runtime_info(SPVM_COMPILER* compiler) {
  ...
  SPVM_RUNTIME_INFO* runtime_info = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_INFO));

  runtime_info->allocator = allocator;

  runtime_info->opcodes = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_OPCODE) * compiler->opcode_array->length);
  ...
  runtime_info->string_buffer = (const char*)SPVM_ALLOCATOR_new_block_permanent(allocator, compiler->string_buffer->length);
  ...
  runtime_info->strings = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_STRING) * compiler->strings->length);
  ...
  runtime_info->methods_of_class = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_METHODS_OF_CLASS) * runtime_methods_of_class_length);
  runtime_info->fields_of_class = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_FIELDS_OF_CLASS) * runtime_fields_of_class_length);
  runtime_info->class_vars_of_class = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_CLASS_VARS_OF_CLASS) * runtime_class_vars_of_class_length);
  
  // Init strings
  runtime_info->string_symtable = SPVM_ALLOCATOR_new_hash_permanent(allocator, 0);
  ...
  runtime_info->classes = SPVM_ALLOCATOR_new_list_permanent(allocator, 0);
  runtime_info->class_symtable = SPVM_ALLOCATOR_new_hash_permanent(allocator, 0);
  for (int32_t class_id = 0; class_id < compiler->classes->length; class_id++) {
    SPVM_CLASS* class = SPVM_LIST_fetch(compiler->classes, class_id);
    SPVM_RUNTIME_CLASS* runtime_class = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_CLASS));
    ...
    runtime_class->method_ids = SPVM_ALLOCATOR_new_list_permanent(allocator, class->methods->length);
    ...
    runtime_class->field_ids = SPVM_ALLOCATOR_new_list_permanent(allocator, class->fields->length);
    ...
    runtime_class->interface_class_ids = SPVM_ALLOCATOR_new_list_permanent(allocator, class->interface_classes->length);
  ...
  runtime_info->basic_types = SPVM_ALLOCATOR_new_list_permanent(allocator, 0);
  runtime_info->basic_type_symtable = SPVM_ALLOCATOR_new_hash_permanent(allocator, 0);
  for (int32_t basic_type_id = 0; basic_type_id < compiler->basic_types->length; basic_type_id++) {
    SPVM_BASIC_TYPE* basic_type = SPVM_LIST_fetch(compiler->basic_types, basic_type_id);
    SPVM_RUNTIME_BASIC_TYPE* runtime_basic_type = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_BASIC_TYPE));
  ...
  runtime_info->types = SPVM_ALLOCATOR_new_list_permanent(allocator, 0);
  runtime_info->type_symtable = SPVM_ALLOCATOR_new_hash_permanent(allocator, 0);
  for (int32_t type_id = 0; type_id < compiler->types->length; type_id++) {
    SPVM_TYPE* type = SPVM_LIST_fetch(compiler->types, type_id);
    SPVM_RUNTIME_TYPE* runtime_type = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_TYPE));
  ...
  runtime_info->class_vars = SPVM_ALLOCATOR_new_list_permanent(allocator, 0);
  for (int32_t class_var_id = 0; class_var_id < compiler->class_vars->length; class_var_id++) {
    ...
    SPVM_RUNTIME_CLASS_VAR* runtime_class_var = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_CLASS_VAR));
  ...
  runtime_info->methods = SPVM_ALLOCATOR_new_list_permanent(allocator, 0);
  for (int32_t method_id = 0; method_id < compiler->methods->length; method_id++) {
    ...
    SPVM_RUNTIME_METHOD* runtime_method = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_METHOD));
    ...
    runtime_method->arg_type_ids = SPVM_ALLOCATOR_new_list_permanent(allocator, method->args->length);
  ...
  runtime_info->fields = SPVM_ALLOCATOR_new_list_permanent(allocator, 0);
  for (int32_t field_id = 0; field_id < compiler->fields->length; field_id++) {
    SPVM_FIELD* field = SPVM_LIST_fetch(compiler->fields, field_id);
    SPVM_RUNTIME_FIELD* runtime_field = SPVM_ALLOCATOR_new_block_permanent(allocator, sizeof(SPVM_RUNTIME_FIELD));
...
void SPVM_COMPILER_error(SPVM_COMPILER* compiler, const char* message_template, ...) {
  ...
  char* message = SPVM_ALLOCATOR_new_block_permanent(compiler->allocator, message_length + 1);
...
const char* SPVM_COMPILER_create_method_signature(SPVM_COMPILER* compiler, SPVM_METHOD* method) {
  ...
  char* method_signature_tmp = SPVM_ALLOCATOR_new_block_permanent(compiler->allocator, length + 1);
...
const char* SPVM_COMPILER_create_field_signature(SPVM_COMPILER* compiler, SPVM_FIELD* field) {
  ...
  char* field_signature_tmp = SPVM_ALLOCATOR_new_block_permanent(compiler->allocator, length + 1);
...
const char* SPVM_COMPILER_create_class_var_signature(SPVM_COMPILER* compiler, SPVM_CLASS_VAR* class_var) {
  ...
  char* class_var_signature_tmp = SPVM_ALLOCATOR_new_block_permanent(compiler->allocator, length + 1);
