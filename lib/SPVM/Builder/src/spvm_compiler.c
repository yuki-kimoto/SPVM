...
SPVM_COMPILER* SPVM_COMPILER_new() {
  ...
  compiler->not_found_class_symtable = SPVM_HASH_new_hash_permanent(compiler->allocator, 0);
...
void SPVM_COMPILER_add_basic_types(SPVM_COMPILER* compiler) {
  ...
  SPVM_COMPILER_add_basic_type(compiler, SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_SYSTEM_CLASS);
  SPVM_COMPILER_add_basic_type(compiler, SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS);
  SPVM_COMPILER_add_basic_type(compiler, SPVM_NATIVE_C_BASIC_TYPE_ID_COMMAND_INFO_CLASS);
  SPVM_COMPILER_add_basic_type(compiler, SPVM_NATIVE_C_BASIC_TYPE_ID_ADDRESS_CLASS);
}
