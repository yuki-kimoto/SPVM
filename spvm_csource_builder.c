            ...
            switch (op_cur->code) {
              case SPVM_OP_C_CODE_SWITCH_CONDITION: {
                ...
                if (switch_info->code == SPVM_SWITCH_INFO_C_CODE_TABLE_SWITCH) {
                  // TODO SPVM_BYTECODE_C_CODE_TABLE_SWITCH);
                ...
                // lookupswitch
                  ...
                  // TODO SPVM_BYTECODE_C_CODE_LOOKUP_SWITCH);
              ...
              case SPVM_OP_C_CODE_BLOCK: {
                if (op_cur->flag & SPVM_OP_C_FLAG_BLOCK_IF_FALSE) {
                  ...
                  // TODO SPVM_BYTECODE_C_CODE_POP_CATCH_EXCEPTION);
              ...
              case SPVM_OP_C_CODE_CONDITION: {
                ...
                if (op_condition_target->code == SPVM_OP_C_CODE_UNDEF) {
                  // TODO SPVM_BYTECODE_C_CODE_IF_NON_NULL);
                }
                  ...
                  if (!type) {
                    // TODO SPVM_BYTECODE_C_CODE_IF_EQ_CMP_OBJECT);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_BYTE) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_BYTE);
                    
                    
                    
                    // TODO SPVM_BYTECODE_C_CODE_IF_EQ_ZERO);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_SHORT) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_SHORT);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_EQ_CMP);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_LONG) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_LONG);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_CMP_FLOAT_G);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_CMP_DOUBLE_G);
                  ...
                  if (!type) {
                    // TODO SPVM_BYTECODE_C_CODE_IF_NE_CMP_OBJECT);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_BYTE) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_BYTE);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_NE_ZERO);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_SHORT) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_SHORT);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_NE_CMP);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_LONG) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_LONG);
                  ...
                  if (type->code == SPVM_TYPE_C_CODE_BYTE) {
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_GT_ZERO);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_SHORT) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_SHORT);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_GT_CMP);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_LONG) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_LONG);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_CMP_FLOAT_L);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_CMP_DOUBLE_L);
                  ...
                  if (type->code == SPVM_TYPE_C_CODE_BYTE) {
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_GE_ZERO);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_SHORT) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_SHORT);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_GE_CMP);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_LONG) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_LONG);
                  ...
                  if (type->code == SPVM_TYPE_C_CODE_BYTE) {
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_LT_ZERO);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_SHORT) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_SHORT);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_LT_CMP);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_LONG) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_LONG);
                  ...
                  if (type->code == SPVM_TYPE_C_CODE_BYTE) {
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_LE_ZERO);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_SHORT) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_SHORT);
                    ...
                    // TODO SPVM_BYTECODE_C_CODE_IF_LE_CMP);
                  }
                  else if (type->code == SPVM_TYPE_C_CODE_LONG) {
                    // TODO SPVM_BYTECODE_C_CODE_CMP_LONG);
