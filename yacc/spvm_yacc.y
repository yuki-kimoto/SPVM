...
%right <opval> LOGICAL_NOT BIT_NOT '@' CREATE_REF DEREF PLUS MINUS CONVERT SCALAR STRING_LENGTH ISWEAK REFCNT TYPE_NAME COMPILE_TYPE_NAME DUMP NEW_STRING_LEN IS_READ_ONLY COPY SET_ERROR_CODE SET_ITEMS
...
operator
  ...
  | SET_ITEMS operator
    {
      $$ = SPVM_OP_build_set_items(compiler, $1, $2);
    }
  | ERROR
  | ITEMS
